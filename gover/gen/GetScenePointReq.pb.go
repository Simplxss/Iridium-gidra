...
type GetScenePointReq struct {
	...
	BelongUid   uint32 `protobuf:"varint,9,opt,name=belong_uid,json=belongUid,proto3" json:"belong_uid,omitempty"`
	SceneId     uint32 `protobuf:"varint,13,opt,name=scene_id,json=sceneId,proto3" json:"scene_id,omitempty"`
	GPMHJGJLAFH bool   `protobuf:"varint,11,opt,name=GPMHJGJLAFH,proto3" json:"GPMHJGJLAFH,omitempty"`
}
...
func (x *GetScenePointReq) GetGPMHJGJLAFH() bool {
	if x != nil {
...
var file_GetScenePointReq_proto_rawDesc = []byte{
	...
	0x65, 0x71, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x6e, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x53,
	0x63, 0x65, 0x6e, 0x65, 0x50, 0x6f, 0x69, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x12, 0x1d, 0x0a, 0x0a,
	0x62, 0x65, 0x6c, 0x6f, 0x6e, 0x67, 0x5f, 0x75, 0x69, 0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0d,
	...
	0x63, 0x65, 0x6e, 0x65, 0x49, 0x64, 0x12, 0x20, 0x0a, 0x0b, 0x47, 0x50, 0x4d, 0x48, 0x4a, 0x47,
	0x4a, 0x4c, 0x41, 0x46, 0x48, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x47, 0x50, 0x4d,
	0x48, 0x4a, 0x47, 0x4a, 0x4c, 0x41, 0x46, 0x48, 0x42, 0x06, 0x5a, 0x04, 0x2f, 0x67, 0x65, 0x6e,
...
var file_GetScenePointReq_proto_goTypes = []interface{}{
	(*GetScenePointReq)(nil), // 0: GetScenePointReq
}
