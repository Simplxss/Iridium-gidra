...
type WidgetDoBagReq_LocationInfo struct {
	LocationInfo *WidgetCreateLocationInfo `protobuf:"bytes,1329,opt,name=location_info,json=locationInfo,proto3,oneof"`
}

type WidgetDoBagReq_WidgetCreatorInfo struct {
	WidgetCreatorInfo *WidgetCreatorInfo `protobuf:"bytes,1593,opt,name=widget_creator_info,json=widgetCreatorInfo,proto3,oneof"`
}
...
var file_WidgetDoBagReq_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x66, 0x6f, 0x18, 0xb1, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x57, 0x69,
	...
	0x5f, 0x63, 0x72, 0x65, 0x61, 0x74, 0x6f, 0x72, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0xb9, 0x0c,
