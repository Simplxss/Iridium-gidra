...
type GetWorldMpInfoRsp struct {
	...
	IsInMpMode      bool   `protobuf:"varint,4,opt,name=is_in_mp_mode,json=isInMpMode,proto3" json:"is_in_mp_mode,omitempty"`
	QuitMpValidTime uint32 `protobuf:"varint,1,opt,name=quit_mp_valid_time,json=quitMpValidTime,proto3" json:"quit_mp_valid_time,omitempty"`
}
...
var file_GetWorldMpInfoRsp_proto_rawDesc = []byte{
	...
	0x6e, 0x5f, 0x6d, 0x70, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52,
	...
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0f, 0x71, 0x75, 0x69, 0x74, 0x4d, 0x70, 0x56,
