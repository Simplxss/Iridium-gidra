...
type AiThreatInfo struct {
	...
	AiThreatMap map[uint32]uint32 `protobuf:"bytes,4,rep,name=ai_threat_map,json=aiThreatMap,proto3" json:"ai_threat_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
var file_AiThreatInfo_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x41,
