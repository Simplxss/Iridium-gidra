...
type RoguelikeSelectAvatarAndEnterDungeonReq struct {
	...
	OnstageAvatarGuidList   []uint64 `protobuf:"varint,11,rep,packed,name=onstage_avatar_guid_list,json=onstageAvatarGuidList,proto3" json:"onstage_avatar_guid_list,omitempty"`
	BackstageAvatarGuidList []uint64 `protobuf:"varint,5,rep,packed,name=backstage_avatar_guid_list,json=backstageAvatarGuidList,proto3" json:"backstage_avatar_guid_list,omitempty"`
}
...
var file_RoguelikeSelectAvatarAndEnterDungeonReq_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x18, 0x0b, 0x20, 0x03, 0x28, 0x04, 0x52, 0x15, 0x6f, 0x6e, 0x73, 0x74, 0x61, 0x67,
