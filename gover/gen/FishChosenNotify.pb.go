...
type FishChosenNotify struct {
	...
	FishId uint32 `protobuf:"varint,10,opt,name=fish_id,json=fishId,proto3" json:"fish_id,omitempty"`
}
...
var file_FishChosenNotify_proto_rawDesc = []byte{
	...
	0x66, 0x69, 0x73, 0x68, 0x5f, 0x69, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x66,
...
var file_FishChosenNotify_proto_goTypes = []interface{}{
	(*FishChosenNotify)(nil), // 0: FishChosenNotify
}
