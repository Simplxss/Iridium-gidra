...
type PrivateChatNotify struct {
	...
	ChatInfo *ChatInfo `protobuf:"bytes,5,opt,name=chat_info,json=chatInfo,proto3" json:"chat_info,omitempty"`
}
...
var file_PrivateChatNotify_proto_rawDesc = []byte{
	...
	0x0a, 0x09, 0x63, 0x68, 0x61, 0x74, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x05, 0x20, 0x01, 0x28,
