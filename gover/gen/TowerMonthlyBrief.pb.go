...
type TowerMonthlyBrief struct {
	...
	DLPIFFMADHI     uint32 `protobuf:"varint,13,opt,name=DLPIFFMADHI,proto3" json:"DLPIFFMADHI,omitempty"`
	MEJOLHPJGJK     uint32 `protobuf:"varint,5,opt,name=MEJOLHPJGJK,proto3" json:"MEJOLHPJGJK,omitempty"`
	TowerScheduleId uint32 `protobuf:"varint,6,opt,name=tower_schedule_id,json=towerScheduleId,proto3" json:"tower_schedule_id,omitempty"`
	KCGJAFBPCLB     uint32 `protobuf:"varint,2,opt,name=KCGJAFBPCLB,proto3" json:"KCGJAFBPCLB,omitempty"`
}
...
func (x *TowerMonthlyBrief) GetDLPIFFMADHI() uint32 {
	if x != nil {
		return x.DLPIFFMADHI
	}
	return 0
}

func (x *TowerMonthlyBrief) GetMEJOLHPJGJK() uint32 {
	if x != nil {
		return x.MEJOLHPJGJK
	}
	return 0
}
...
func (x *TowerMonthlyBrief) GetKCGJAFBPCLB() uint32 {
	if x != nil {
		return x.KCGJAFBPCLB
	}
	return 0
}
...
var file_TowerMonthlyBrief_proto_rawDesc = []byte{
	...
	,
