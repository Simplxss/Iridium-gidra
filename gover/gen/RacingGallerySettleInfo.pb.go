...
type RacingGallerySettleInfo struct {
	...
	WinnerUid uint32      `protobuf:"varint,13,opt,name=winner_uid,json=winnerUid,proto3" json:"winner_uid,omitempty"`
	UseTime   uint32      `protobuf:"varint,1,opt,name=use_time,json=useTime,proto3" json:"use_time,omitempty"`
	Reason    KDHIAEFLGFM `protobuf:"varint,6,opt,name=reason,proto3,enum=KDHIAEFLGFM" json:"reason,omitempty"`
}
...
func (x *RacingGallerySettleInfo) GetReason() KDHIAEFLGFM {
	if x != nil {
		return x.Reason
	}
...
var file_RacingGallerySettleInfo_proto_rawDesc = []byte{
	...
	,
...
var file_RacingGallerySettleInfo_proto_depIdxs = []int32{
	1, // 0: RacingGallerySettleInfo.reason:type_name -> KDHIAEFLGFM
