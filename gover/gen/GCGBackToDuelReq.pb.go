...
type GCGBackToDuelReq struct {
	...
	IsBack bool `protobuf:"varint,7,opt,name=is_back,json=isBack,proto3" json:"is_back,omitempty"`
}
...
var file_GCGBackToDuelReq_proto_rawDesc = []byte{
	...
	0x69, 0x73, 0x5f, 0x62, 0x61, 0x63, 0x6b, 0x18, 0x07, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x69,
