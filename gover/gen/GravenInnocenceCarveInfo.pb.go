...
type GravenInnocenceCarveInfo struct {
	...
	HasEditConfigIdList []uint32                         `protobuf:"varint,13,rep,packed,name=has_edit_config_id_list,json=hasEditConfigIdList,proto3" json:"has_edit_config_id_list,omitempty"`
	StageInfoList       []*GravenInnocenceCarveStageInfo `protobuf:"bytes,12,rep,name=stage_info_list,json=stageInfoList,proto3" json:"stage_info_list,omitempty"`
}
...
var file_GravenInnocenceCarveInfo_proto_rawDesc = []byte{
	...
	0x69, 0x73, 0x74, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x13, 0x68, 0x61, 0x73, 0x45, 0x64,
	...
	0x74, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x47, 0x72, 0x61, 0x76, 0x65, 0x6e,
