...
type BuyResinRsp struct {
	...
	CurValue uint32 `protobuf:"varint,5,opt,name=cur_value,json=curValue,proto3" json:"cur_value,omitempty"`
}
...
var file_BuyResinRsp_proto_rawDesc = []byte{
	...
	0x63, 0x75, 0x72, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52,
