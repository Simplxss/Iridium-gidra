...
type AbilityActionSetCrashDamage struct {
	...
	HitPos *Vector `protobuf:"bytes,4,opt,name=hit_pos,json=hitPos,proto3" json:"hit_pos,omitempty"`
	Damage float32 `protobuf:"fixed32,8,opt,name=damage,proto3" json:"damage,omitempty"`
}
...
var file_AbilityActionSetCrashDamage_proto_rawDesc = []byte{
	...
	0x12, 0x20, 0x0a, 0x07, 0x68, 0x69, 0x74, 0x5f, 0x70, 0x6f, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x07, 0x2e, 0x56, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x52, 0x06, 0x68, 0x69, 0x74, 0x50,
	0x6f, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x64, 0x61, 0x6d, 0x61, 0x67, 0x65, 0x18, 0x08, 0x20, 0x01,
