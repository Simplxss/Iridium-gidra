...
type AbilityActionSetCrashDamage struct {
	...
	HitPos *Vector `protobuf:"bytes,9,opt,name=hit_pos,json=hitPos,proto3" json:"hit_pos,omitempty"`
}
...
var file_AbilityActionSetCrashDamage_proto_rawDesc = []byte{
	...
	0x12, 0x16, 0x0a, 0x06, 0x64, 0x61, 0x6d, 0x61, 0x67, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x02,
