...
type HomeStakePlayRecord struct {
	...
	EngagedPlayerInfoList []*HomeGroupPlayerInfo `protobuf:"bytes,1,rep,name=engaged_player_info_list,json=engagedPlayerInfoList,proto3" json:"engaged_player_info_list,omitempty"`
