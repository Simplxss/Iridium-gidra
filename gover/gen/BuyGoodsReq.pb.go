...
type BuyGoodsReq struct {
	...
	ShopType uint32     `protobuf:"varint,2,opt,name=shop_type,json=shopType,proto3" json:"shop_type,omitempty"`
	BuyCount uint32     `protobuf:"varint,14,opt,name=buy_count,json=buyCount,proto3" json:"buy_count,omitempty"`
	Goods    *ShopGoods `protobuf:"bytes,8,opt,name=goods,proto3" json:"goods,omitempty"`
}
...
var file_BuyGoodsReq_proto_rawDesc = []byte{
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x73, 0x68, 0x6f, 0x70, 0x54, 0x79, 0x70, 0x65,
	0x12, 0x1b, 0x0a, 0x09, 0x62, 0x75, 0x79, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x0e, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x08, 0x62, 0x75, 0x79, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x20, 0x0a,
	0x05, 0x67, 0x6f, 0x6f, 0x64, 0x73, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x53,
	0x68, 0x6f, 0x70, 0x47, 0x6f, 0x6f, 0x64, 0x73, 0x52, 0x05, 0x67, 0x6f, 0x6f, 0x64, 0x73, 0x42,
...
var file_BuyGoodsReq_proto_goTypes = []interface{}{
	(*BuyGoodsReq)(nil), // 0: BuyGoodsReq
	(*ShopGoods)(nil),   // 1: ShopGoods
}
var file_BuyGoodsReq_proto_depIdxs = []int32{
	1, // 0: BuyGoodsReq.goods:type_name -> ShopGoods
