...
type SceneTeamAvatar struct {
	...
	WeaponAbilityInfo   *AbilitySyncStateInfo `protobuf:"bytes,7,opt,name=weapon_ability_info,json=weaponAbilityInfo,proto3" json:"weapon_ability_info,omitempty"`
	AvatarGuid          uint64                `protobuf:"varint,14,opt,name=avatar_guid,json=avatarGuid,proto3" json:"avatar_guid,omitempty"`
	IsOnScene           bool                  `protobuf:"varint,9,opt,name=is_on_scene,json=isOnScene,proto3" json:"is_on_scene,omitempty"`
	ServerBuffList      []*ServerBuff         `protobuf:"bytes,1,rep,name=server_buff_list,json=serverBuffList,proto3" json:"server_buff_list,omitempty"`
	SceneEntityInfo     *SceneEntityInfo      `protobuf:"bytes,3,opt,name=scene_entity_info,json=sceneEntityInfo,proto3" json:"scene_entity_info,omitempty"`
	SceneAvatarInfo     *SceneAvatarInfo      `protobuf:"bytes,8,opt,name=scene_avatar_info,json=sceneAvatarInfo,proto3" json:"scene_avatar_info,omitempty"`
	...
	IsPlayerCurAvatar   bool                  `protobuf:"varint,1077,opt,name=is_player_cur_avatar,json=isPlayerCurAvatar,proto3" json:"is_player_cur_avatar,omitempty"`
	AvatarInfo          *AvatarInfo           `protobuf:"bytes,11,opt,name=avatar_info,json=avatarInfo,proto3" json:"avatar_info,omitempty"`
	WeaponGuid          uint64                `protobuf:"varint,10,opt,name=weapon_guid,json=weaponGuid,proto3" json:"weapon_guid,omitempty"`
...
var file_SceneTeamAvatar_proto_rawDesc = []byte{
	...
	,
	...
	0x6e, 0x74, 0x69, 0x74, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0e,
	0x77, 0x65, 0x61, 0x70, 0x6f, 0x6e, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x49, 0x64, 0x12, 0x45,
	0x0a, 0x13, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x5f, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79,
	0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x41, 0x62,
	...
	,
	...
	0x75, 0x69, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0a, 0x77, 0x65, 0x61, 0x70, 0x6f,
	0x6e, 0x47, 0x75, 0x69, 0x64, 0x12, 0x21, 0x0a, 0x0c, 0x69, 0x73, 0x5f, 0x72, 0x65, 0x63, 0x6f,
	0x6e, 0x6e, 0x65, 0x63, 0x74, 0x18, 0x06, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x69, 0x73, 0x52,
	0x65, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x65, 0x6e, 0x74, 0x69,
...
var file_SceneTeamAvatar_proto_goTypes = []interface{}{
	...
	(*SceneAvatarInfo)(nil),      // 4: SceneAvatarInfo
...
var file_SceneTeamAvatar_proto_depIdxs = []int32{
	...
	1, // 1: SceneTeamAvatar.weapon_ability_info:type_name -> AbilitySyncStateInfo
	2, // 2: SceneTeamAvatar.server_buff_list:type_name -> ServerBuff
	3, // 3: SceneTeamAvatar.scene_entity_info:type_name -> SceneEntityInfo
	4, // 4: SceneTeamAvatar.scene_avatar_info:type_name -> SceneAvatarInfo
	5, // 5: SceneTeamAvatar.ability_control_block:type_name -> AbilityControlBlock
	6, // 6: SceneTeamAvatar.avatar_info:type_name -> AvatarInfo
