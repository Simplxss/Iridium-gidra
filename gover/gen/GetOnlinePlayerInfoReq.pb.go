...
type GetOnlinePlayerInfoReq struct {
	...
	IsOnlineId bool `protobuf:"varint,9,opt,name=is_online_id,json=isOnlineId,proto3" json:"is_online_id,omitempty"`
...
type GetOnlinePlayerInfoReq_TargetUid struct {
	TargetUid uint32 `protobuf:"varint,11,opt,name=target_uid,json=targetUid,proto3,oneof"`
}

type GetOnlinePlayerInfoReq_OnlineId struct {
	OnlineId string `protobuf:"bytes,15,opt,name=online_id,json=onlineId,proto3,oneof"`
}

type GetOnlinePlayerInfoReq_PsnId struct {
	PsnId string `protobuf:"bytes,10,opt,name=psn_id,json=psnId,proto3,oneof"`
}
...
var file_GetOnlinePlayerInfoReq_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x0a, 0x69, 0x73, 0x4f, 0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x49, 0x64, 0x12, 0x1f, 0x0a, 0x0a, 0x74,
	0x61, 0x72, 0x67, 0x65, 0x74, 0x5f, 0x75, 0x69, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0d, 0x48,
	0x00, 0x52, 0x09, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x55, 0x69, 0x64, 0x12, 0x1d, 0x0a, 0x09,
	0x6f, 0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x09, 0x48,
	0x00, 0x52, 0x08, 0x6f, 0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x49, 0x64, 0x12, 0x17, 0x0a, 0x06, 0x70,
	0x73, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x05, 0x70,
...
var file_GetOnlinePlayerInfoReq_proto_goTypes = []interface{}{
	(*GetOnlinePlayerInfoReq)(nil), // 0: GetOnlinePlayerInfoReq
}
