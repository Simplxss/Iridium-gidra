...
type ReliquaryFilterStateNotify struct {
	...
	ReliquaryFilterStateMap map[uint32]uint32 `protobuf:"bytes,13,rep,name=reliquary_filter_state_map,json=reliquaryFilterStateMap,proto3" json:"reliquary_filter_state_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
var file_ReliquaryFilterStateNotify_proto_rawDesc = []byte{
	...
	0x0d, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x38, 0x2e, 0x52, 0x65, 0x6c, 0x69, 0x71, 0x75, 0x61, 0x72,
