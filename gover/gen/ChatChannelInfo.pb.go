...
type ChatChannelInfo struct {
	...
	IsShield  bool   `protobuf:"varint,7,opt,name=is_shield,json=isShield,proto3" json:"is_shield,omitempty"`
...
var file_ChatChannelInfo_proto_rawDesc = []byte{
	...
	0x5f, 0x73, 0x68, 0x69, 0x65, 0x6c, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x69,
