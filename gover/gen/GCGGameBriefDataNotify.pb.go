...
type GCGGameBriefDataNotify struct {
	...
	IsNewGame    bool              `protobuf:"varint,8,opt,name=is_new_game,json=isNewGame,proto3" json:"is_new_game,omitempty"`
}
...
var file_GCGGameBriefDataNotify_proto_rawDesc = []byte{
	...
	0x6e, 0x65, 0x77, 0x5f, 0x67, 0x61, 0x6d, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09,
