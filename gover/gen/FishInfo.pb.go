...
type FishInfo struct {
	...
	BKNIFIIKAOJ uint32 `protobuf:"varint,5,opt,name=BKNIFIIKAOJ,proto3" json:"BKNIFIIKAOJ,omitempty"`
	KMEKOBBJLDH uint32 `protobuf:"varint,2,opt,name=KMEKOBBJLDH,proto3" json:"KMEKOBBJLDH,omitempty"`
}
...
func (x *FishInfo) GetBKNIFIIKAOJ() uint32 {
	if x != nil {
		return x.BKNIFIIKAOJ
	}
	return 0
}

func (x *FishInfo) GetKMEKOBBJLDH() uint32 {
	if x != nil {
		return x.KMEKOBBJLDH
	}
	return 0
}
...
var file_FishInfo_proto_rawDesc = []byte{
	...
	0x42, 0x4b, 0x4e, 0x49, 0x46, 0x49, 0x49, 0x4b, 0x41, 0x4f, 0x4a, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x0d, 0x52, 0x0b, 0x42, 0x4b, 0x4e, 0x49, 0x46, 0x49, 0x49, 0x4b, 0x41, 0x4f, 0x4a, 0x12, 0x20,
	0x0a, 0x0b, 0x4b, 0x4d, 0x45, 0x4b, 0x4f, 0x42, 0x42, 0x4a, 0x4c, 0x44, 0x48, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x0b, 0x4b, 0x4d, 0x45, 0x4b, 0x4f, 0x42, 0x42, 0x4a, 0x4c, 0x44, 0x48,
