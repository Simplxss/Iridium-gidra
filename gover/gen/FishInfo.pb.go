...
type FishInfo struct {
	...
	KNHKIEOMMFC uint32 `protobuf:"varint,13,opt,name=KNHKIEOMMFC,proto3" json:"KNHKIEOMMFC,omitempty"`
	IKHMLANEEBO uint32 `protobuf:"varint,14,opt,name=IKHMLANEEBO,proto3" json:"IKHMLANEEBO,omitempty"`
}
...
func (x *FishInfo) GetKNHKIEOMMFC() uint32 {
	if x != nil {
		return x.KNHKIEOMMFC
	}
	return 0
}

func (x *FishInfo) GetIKHMLANEEBO() uint32 {
	if x != nil {
		return x.IKHMLANEEBO
	}
	return 0
}
...
var file_FishInfo_proto_rawDesc = []byte{
	...
	0x4b, 0x4e, 0x48, 0x4b, 0x49, 0x45, 0x4f, 0x4d, 0x4d, 0x46, 0x43, 0x18, 0x0d, 0x20, 0x01, 0x28,
	0x0d, 0x52, 0x0b, 0x4b, 0x4e, 0x48, 0x4b, 0x49, 0x45, 0x4f, 0x4d, 0x4d, 0x46, 0x43, 0x12, 0x20,
	0x0a, 0x0b, 0x49, 0x4b, 0x48, 0x4d, 0x4c, 0x41, 0x4e, 0x45, 0x45, 0x42, 0x4f, 0x18, 0x0e, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x0b, 0x49, 0x4b, 0x48, 0x4d, 0x4c, 0x41, 0x4e, 0x45, 0x45, 0x42, 0x4f,
