...
type RoguelikeEffectViewReq struct {
	...
	GMMCJDAIPBO []uint32 `protobuf:"varint,13,rep,packed,name=GMMCJDAIPBO,proto3" json:"GMMCJDAIPBO,omitempty"`
	FNABJPMKHPI []uint32 `protobuf:"varint,3,rep,packed,name=FNABJPMKHPI,proto3" json:"FNABJPMKHPI,omitempty"`
}
...
func (x *RoguelikeEffectViewReq) GetGMMCJDAIPBO() []uint32 {
	if x != nil {
		return x.GMMCJDAIPBO
	}
	return nil
}

func (x *RoguelikeEffectViewReq) GetFNABJPMKHPI() []uint32 {
	if x != nil {
		return x.FNABJPMKHPI
	}
	return nil
}
...
var file_RoguelikeEffectViewReq_proto_rawDesc = []byte{
	...
	0x74, 0x56, 0x69, 0x65, 0x77, 0x52, 0x65, 0x71, 0x12, 0x20, 0x0a, 0x0b, 0x47, 0x4d, 0x4d, 0x43,
	0x4a, 0x44, 0x41, 0x49, 0x50, 0x42, 0x4f, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x47,
	0x4d, 0x4d, 0x43, 0x4a, 0x44, 0x41, 0x49, 0x50, 0x42, 0x4f, 0x12, 0x20, 0x0a, 0x0b, 0x46, 0x4e,
	0x41, 0x42, 0x4a, 0x50, 0x4d, 0x4b, 0x48, 0x50, 0x49, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0d, 0x52,
	0x0b, 0x46, 0x4e, 0x41, 0x42, 0x4a, 0x50, 0x4d, 0x4b, 0x48, 0x50, 0x49, 0x42, 0x06, 0x5a, 0x04,
