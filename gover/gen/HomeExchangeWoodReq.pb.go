...
type HomeExchangeWoodReq struct {
	...
	MaterialCountMap map[uint32]uint32 `protobuf:"bytes,6,rep,name=material_count_map,json=materialCountMap,proto3" json:"material_count_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	WoodId           uint32            `protobuf:"varint,10,opt,name=wood_id,json=woodId,proto3" json:"wood_id,omitempty"`
}
...
var file_HomeExchangeWoodReq_proto_rawDesc = []byte{
	...
	0x52, 0x65, 0x71, 0x12, 0x58, 0x0a, 0x12, 0x6d, 0x61, 0x74, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x5f,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x2a, 0x2e, 0x48, 0x6f, 0x6d, 0x65, 0x45, 0x78, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x57, 0x6f,
	...
	0x07, 0x77, 0x6f, 0x6f, 0x64, 0x5f, 0x69, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06,
