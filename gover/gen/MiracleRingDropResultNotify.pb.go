...
type MiracleRingDropResultNotify struct {
	...
	CGEEAAHAOPL int32  `protobuf:"varint,8,opt,name=CGEEAAHAOPL,proto3" json:"CGEEAAHAOPL,omitempty"`
	BJHONLLCDPC uint32 `protobuf:"varint,1,opt,name=BJHONLLCDPC,proto3" json:"BJHONLLCDPC,omitempty"`
}
...
func (x *MiracleRingDropResultNotify) GetCGEEAAHAOPL() int32 {
	if x != nil {
		return x.CGEEAAHAOPL
	}
	return 0
}

func (x *MiracleRingDropResultNotify) GetBJHONLLCDPC() uint32 {
	if x != nil {
...
var file_MiracleRingDropResultNotify_proto_rawDesc = []byte{
	...
	0x66, 0x79, 0x12, 0x20, 0x0a, 0x0b, 0x43, 0x47, 0x45, 0x45, 0x41, 0x41, 0x48, 0x41, 0x4f, 0x50,
	0x4c, 0x18, 0x08, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0b, 0x43, 0x47, 0x45, 0x45, 0x41, 0x41, 0x48,
	0x41, 0x4f, 0x50, 0x4c, 0x12, 0x20, 0x0a, 0x0b, 0x42, 0x4a, 0x48, 0x4f, 0x4e, 0x4c, 0x4c, 0x43,
	0x44, 0x50, 0x43, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x42, 0x4a, 0x48, 0x4f, 0x4e,
	0x4c, 0x4c, 0x43, 0x44, 0x50, 0x43, 0x42, 0x06, 0x5a, 0x04, 0x2f, 0x67, 0x65, 0x6e, 0x62, 0x06,
