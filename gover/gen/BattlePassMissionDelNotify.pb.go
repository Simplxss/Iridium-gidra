...
type BattlePassMissionDelNotify struct {
	...
	DelMissionIdList []uint32 `protobuf:"varint,9,rep,packed,name=del_mission_id_list,json=delMissionIdList,proto3" json:"del_mission_id_list,omitempty"`
}
...
var file_BattlePassMissionDelNotify_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x10, 0x64,
