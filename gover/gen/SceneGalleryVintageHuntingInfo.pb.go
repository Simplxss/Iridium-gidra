...
type SceneGalleryVintageHuntingInfo_FirstStageInfo struct {
	FirstStageInfo *VintageHuntingFirstStageInfo `protobuf:"bytes,10,opt,name=first_stage_info,json=firstStageInfo,proto3,oneof"`
}

type SceneGalleryVintageHuntingInfo_SecondStageInfo struct {
	SecondStageInfo *VintageHuntingSecondStageInfo `protobuf:"bytes,3,opt,name=second_stage_info,json=secondStageInfo,proto3,oneof"`
}

type SceneGalleryVintageHuntingInfo_ThirdStageInfo struct {
	ThirdStageInfo *VintageHuntingThirdStageInfo `protobuf:"bytes,6,opt,name=third_stage_info,json=thirdStageInfo,proto3,oneof"`
}
...
var file_SceneGalleryVintageHuntingInfo_proto_rawDesc = []byte{
	...
	0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x56, 0x69,
	...
	0x6f, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x56, 0x69, 0x6e, 0x74, 0x61, 0x67,
	...
	0x69, 0x72, 0x64, 0x5f, 0x73, 0x74, 0x61, 0x67, 0x65, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x06,
