...
type VintageMarketTraderInfo struct {
	...
	TraderId          uint32       `protobuf:"varint,8,opt,name=trader_id,json=traderId,proto3" json:"trader_id,omitempty"`
	AvailableItemList []*ItemParam `protobuf:"bytes,12,rep,name=available_item_list,json=availableItemList,proto3" json:"available_item_list,omitempty"`
}
...
var file_VintageMarketTraderInfo_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x64, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08,
