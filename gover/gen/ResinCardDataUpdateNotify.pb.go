...
type ResinCardDataUpdateNotify struct {
	...
	TodayStartTime uint32           `protobuf:"varint,10,opt,name=today_start_time,json=todayStartTime,proto3" json:"today_start_time,omitempty"`
	CardDataList   []*ResinCardData `protobuf:"bytes,7,rep,name=card_data_list,json=cardDataList,proto3" json:"card_data_list,omitempty"`
}
...
var file_ResinCardDataUpdateNotify_proto_rawDesc = []byte{
	...
	0x72, 0x74, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0e, 0x74,
	...
	0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x52, 0x65, 0x73, 0x69, 0x6e, 0x43, 0x61, 0x72,
