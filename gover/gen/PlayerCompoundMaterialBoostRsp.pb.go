...
type PlayerCompoundMaterialBoostRsp struct {
	...
	CompoundQueueDataList []*CompoundQueueData        `protobuf:"bytes,2,rep,name=compoundQueueDataList,proto3" json:"compoundQueueDataList,omitempty"`
	TakeStatus            CompoundBoostTakeStatusType `protobuf:"varint,3,opt,name=take_status,json=takeStatus,proto3,enum=CompoundBoostTakeStatusType" json:"take_status,omitempty"`
	Retcode               int32                       `protobuf:"varint,14,opt,name=retcode,proto3" json:"retcode,omitempty"`
	TakeItemList          []*ItemParam                `protobuf:"bytes,13,rep,name=take_item_list,json=takeItemList,proto3" json:"take_item_list,omitempty"`
}
...
var file_PlayerCompoundMaterialBoostRsp_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x75, 0x6e, 0x64,
	...
	0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x75, 0x6e, 0x64,
	...
	0x52, 0x07, 0x72, 0x65, 0x74, 0x63, 0x6f, 0x64, 0x65, 0x12, 0x30, 0x0a, 0x0e, 0x74, 0x61, 0x6b,
	0x65, 0x5f, 0x69, 0x74, 0x65, 0x6d, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0d, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x0a, 0x2e, 0x49, 0x74, 0x65, 0x6d, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x52, 0x0c, 0x74,
	0x61, 0x6b, 0x65, 0x49, 0x74, 0x65, 0x6d, 0x4c, 0x69, 0x73, 0x74, 0x42, 0x06, 0x5a, 0x04, 0x2f,
