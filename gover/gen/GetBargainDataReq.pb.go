...
type GetBargainDataReq struct {
	...
	BargainId uint32 `protobuf:"varint,13,opt,name=bargain_id,json=bargainId,proto3" json:"bargain_id,omitempty"`
}
...
var file_GetBargainDataReq_proto_rawDesc = []byte{
	...
	0x0a, 0x0a, 0x62, 0x61, 0x72, 0x67, 0x61, 0x69, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x0d, 0x20, 0x01,
...
var file_GetBargainDataReq_proto_goTypes = []interface{}{
	(*GetBargainDataReq)(nil), // 0: GetBargainDataReq
}
