...
type GalleryFallScoreNotify struct {
	...
	UidBriefMap map[uint32]*FallPlayerBrief `protobuf:"bytes,4,rep,name=uid_brief_map,json=uidBriefMap,proto3" json:"uid_brief_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_GalleryFallScoreNotify_proto_rawDesc = []byte{
	...
	0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x47, 0x61, 0x6c, 0x6c, 0x65, 0x72, 0x79,
