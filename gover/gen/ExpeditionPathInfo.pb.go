...
type ExpeditionPathInfo struct {
	...
	BonusProbability float32         `protobuf:"fixed32,8,opt,name=bonus_probability,json=bonusProbability,proto3" json:"bonus_probability,omitempty"`
	DPOMPOMLCKP      uint32          `protobuf:"varint,11,opt,name=DPOMPOMLCKP,proto3" json:"DPOMPOMLCKP,omitempty"`
	IBKDBMDJGDI      uint32          `protobuf:"varint,3,opt,name=IBKDBMDJGDI,proto3" json:"IBKDBMDJGDI,omitempty"`
	StartTime        uint32          `protobuf:"varint,13,opt,name=start_time,json=startTime,proto3" json:"start_time,omitempty"`
	FLHKBCEIKLE      uint32          `protobuf:"varint,15,opt,name=FLHKBCEIKLE,proto3" json:"FLHKBCEIKLE,omitempty"`
	PathId           uint32          `protobuf:"varint,2,opt,name=path_id,json=pathId,proto3" json:"path_id,omitempty"`
	State            ExpeditionState `protobuf:"varint,6,opt,name=state,proto3,enum=ExpeditionState" json:"state,omitempty"`
	MFNGJOCIAPE      uint32          `protobuf:"varint,1,opt,name=MFNGJOCIAPE,proto3" json:"MFNGJOCIAPE,omitempty"`
}
...
func (x *ExpeditionPathInfo) GetDPOMPOMLCKP() uint32 {
	if x != nil {
		return x.DPOMPOMLCKP
	}
	return 0
}

func (x *ExpeditionPathInfo) GetIBKDBMDJGDI() uint32 {
	if x != nil {
		return x.IBKDBMDJGDI
	}
	return 0
}
...
func (x *ExpeditionPathInfo) GetFLHKBCEIKLE() uint32 {
	if x != nil {
		return x.FLHKBCEIKLE
	}
	return 0
}
...
func (x *ExpeditionPathInfo) GetMFNGJOCIAPE() uint32 {
	if x != nil {
		return x.MFNGJOCIAPE
	}
	return 0
}
...
var file_ExpeditionPathInfo_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xf2, 0x02, 0x0a, 0x12, 0x45, 0x78, 0x70, 0x65, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e,
	0x50, 0x61, 0x74, 0x68, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x21, 0x0a, 0x0c, 0x63, 0x68, 0x61, 0x6c,
	0x6c, 0x65, 0x6e, 0x67, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b,
	0x63, 0x68, 0x61, 0x6c, 0x6c, 0x65, 0x6e, 0x67, 0x65, 0x49, 0x64, 0x12, 0x24, 0x0a, 0x0e, 0x61,
	...
	,
...
var file_ExpeditionPathInfo_proto_goTypes = []interface{}{
	(*ExpeditionPathInfo)(nil), // 0: ExpeditionPathInfo
	(ExpeditionState)(0),       // 1: ExpeditionState
}
var file_ExpeditionPathInfo_proto_depIdxs = []int32{
	1, // 0: ExpeditionPathInfo.state:type_name -> ExpeditionState
