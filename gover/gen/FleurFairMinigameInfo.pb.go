...
type FleurFairMinigameInfo struct {
	...
	MinigameId uint32 `protobuf:"varint,10,opt,name=minigame_id,json=minigameId,proto3" json:"minigame_id,omitempty"`
...
type FleurFairMinigameInfo_BalloonInfo struct {
	BalloonInfo *FleurFairBalloonInfo `protobuf:"bytes,6,opt,name=balloon_info,json=balloonInfo,proto3,oneof"`
}

type FleurFairMinigameInfo_FallInfo struct {
	FallInfo *FleurFairFallInfo `protobuf:"bytes,4,opt,name=fall_info,json=fallInfo,proto3,oneof"`
}

type FleurFairMinigameInfo_MusicInfo struct {
	MusicInfo *FleurFairMusicGameInfo `protobuf:"bytes,7,opt,name=music_info,json=musicInfo,proto3,oneof"`
}
...
var file_FleurFairMinigameInfo_proto_rawDesc = []byte{
	...
	0x6e, 0x69, 0x67, 0x61, 0x6d, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0d, 0x52,
	...
	0x6f, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x46, 0x6c, 0x65, 0x75, 0x72, 0x46,
	...
	0x09, 0x66, 0x61, 0x6c, 0x6c, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b,
	...
	0x12, 0x38, 0x0a, 0x0a, 0x6d, 0x75, 0x73, 0x69, 0x63, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x07,
