...
type SceneForceLockNotify struct {
	...
	ForceIdList []uint32 `protobuf:"varint,12,rep,packed,name=force_id_list,json=forceIdList,proto3" json:"force_id_list,omitempty"`
}
...
var file_SceneForceLockNotify_proto_rawDesc = []byte{
	...
	0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x66, 0x6f, 0x72,
