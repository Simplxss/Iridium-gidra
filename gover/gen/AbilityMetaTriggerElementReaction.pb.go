...
type AbilityMetaTriggerElementReaction struct {
	...
	ADHLKLLFLPD     uint32 `protobuf:"varint,2,opt,name=ADHLKLLFLPD,proto3" json:"ADHLKLLFLPD,omitempty"`
	GJFGOBCICLP     uint32 `protobuf:"varint,14,opt,name=GJFGOBCICLP,proto3" json:"GJFGOBCICLP,omitempty"`
	HitIndex        int32  `protobuf:"varint,3,opt,name=hit_index,json=hitIndex,proto3" json:"hit_index,omitempty"`
	TriggerEntityId uint32 `protobuf:"varint,1,opt,name=trigger_entity_id,json=triggerEntityId,proto3" json:"trigger_entity_id,omitempty"`
	ECHFGCGHGEG     uint32 `protobuf:"varint,4,opt,name=ECHFGCGHGEG,proto3" json:"ECHFGCGHGEG,omitempty"`
}
...
func (x *AbilityMetaTriggerElementReaction) GetADHLKLLFLPD() uint32 {
	if x != nil {
		return x.ADHLKLLFLPD
	}
	return 0
}

func (x *AbilityMetaTriggerElementReaction) GetGJFGOBCICLP() uint32 {
	if x != nil {
		return x.GJFGOBCICLP
	}
	return 0
}
...
func (x *AbilityMetaTriggerElementReaction) GetECHFGCGHGEG() uint32 {
	if x != nil {
		return x.ECHFGCGHGEG
	}
	return 0
}
...
var file_AbilityMetaTriggerElementReaction_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd2, 0x01, 0x0a, 0x21, 0x41, 0x62,
	...
	,
