...
type CombatInvocationsNotify struct {
	...
	InvokeList []*CombatInvokeEntry `protobuf:"bytes,5,rep,name=invoke_list,json=invokeList,proto3" json:"invoke_list,omitempty"`
}
...
var file_CombatInvocationsNotify_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x43, 0x6f, 0x6d, 0x62, 0x61,
