...
type CoopPointUpdateNotify struct {
	...
	CoopPoint *CoopPoint `protobuf:"bytes,5,opt,name=coop_point,json=coopPoint,proto3" json:"coop_point,omitempty"`
}
...
var file_CoopPointUpdateNotify_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x69, 0x6e, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x43, 0x6f,
