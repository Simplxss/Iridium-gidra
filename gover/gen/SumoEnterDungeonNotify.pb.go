...
type SumoEnterDungeonNotify struct {
	...
	BDAFDFKPJAE     uint32             `protobuf:"varint,8,opt,name=BDAFDFKPJAE,proto3" json:"BDAFDFKPJAE,omitempty"`
	DungeonTeamList []*SumoDungeonTeam `protobuf:"bytes,13,rep,name=dungeon_team_list,json=dungeonTeamList,proto3" json:"dungeon_team_list,omitempty"`
	DHAAEJHLHNB     uint32             `protobuf:"varint,1,opt,name=DHAAEJHLHNB,proto3" json:"DHAAEJHLHNB,omitempty"`
	ActivityId      uint32             `protobuf:"varint,9,opt,name=activity_id,json=activityId,proto3" json:"activity_id,omitempty"`
	PHBHNGMAEKN     uint32             `protobuf:"varint,4,opt,name=PHBHNGMAEKN,proto3" json:"PHBHNGMAEKN,omitempty"`
}
...
func (x *SumoEnterDungeonNotify) GetBDAFDFKPJAE() uint32 {
	if x != nil {
		return x.BDAFDFKPJAE
	}
	return 0
}
...
func (x *SumoEnterDungeonNotify) GetDHAAEJHLHNB() uint32 {
	if x != nil {
		return x.DHAAEJHLHNB
	}
	return 0
}
...
func (x *SumoEnterDungeonNotify) GetPHBHNGMAEKN() uint32 {
	if x != nil {
		return x.PHBHNGMAEKN
	}
	return 0
}
...
var file_SumoEnterDungeonNotify_proto_rawDesc = []byte{
	...
	,
