...
type MultistagePlayInfo_MechanicusInfo struct {
	MechanicusInfo *InBattleMechanicusInfo `protobuf:"bytes,1751,opt,name=mechanicus_info,json=mechanicusInfo,proto3,oneof"`
}

type MultistagePlayInfo_FleurFairInfo struct {
	FleurFairInfo *InBattleFleurFairInfo `protobuf:"bytes,1630,opt,name=fleur_fair_info,json=fleurFairInfo,proto3,oneof"`
}

type MultistagePlayInfo_HideAndSeekInfo struct {
	HideAndSeekInfo *HideAndSeekStageInfo `protobuf:"bytes,216,opt,name=hide_and_seek_info,json=hideAndSeekInfo,proto3,oneof"`
}

type MultistagePlayInfo_ChessInfo struct {
	ChessInfo *InBattleChessInfo `protobuf:"bytes,849,opt,name=chess_info,json=chessInfo,proto3,oneof"`
}

type MultistagePlayInfo_IrodoriChessInfo struct {
	IrodoriChessInfo *InBattleIrodoriChessInfo `protobuf:"bytes,2011,opt,name=irodori_chess_info,json=irodoriChessInfo,proto3,oneof"`
}

type MultistagePlayInfo_CharAmusementInfo struct {
	CharAmusementInfo *CharAmusementInfo `protobuf:"bytes,1538,opt,name=char_amusement_info,json=charAmusementInfo,proto3,oneof"`
}

type MultistagePlayInfo_BrickBreakerInfo struct {
	BrickBreakerInfo *BrickBreakerStageInfo `protobuf:"bytes,903,opt,name=brick_breaker_info,json=brickBreakerInfo,proto3,oneof"`
}

type MultistagePlayInfo_CoinCollectInfo struct {
	CoinCollectInfo *CoinCollectStageInfo `protobuf:"bytes,1102,opt,name=coin_collect_info,json=coinCollectInfo,proto3,oneof"`
}

type MultistagePlayInfo_LanV3BoatInfo struct {
	LanV3BoatInfo *LanV3BoatStageInfo `protobuf:"bytes,1033,opt,name=lan_v3_boat_info,json=lanV3BoatInfo,proto3,oneof"`
}

type MultistagePlayInfo_FleurFairV2PacmanInfo struct {
	FleurFairV2PacmanInfo *FleurFairV2PacmanStageInfo `protobuf:"bytes,2006,opt,name=fleur_fair_v2_pacman_info,json=fleurFairV2PacmanInfo,proto3,oneof"`
}
...
var file_MultistagePlayInfo_proto_rawDesc = []byte{
	...
	,
	...
	,
