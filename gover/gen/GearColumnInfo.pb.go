...
type GearColumnInfo struct {
	...
	GearId      uint32 `protobuf:"varint,8,opt,name=gear_id,json=gearId,proto3" json:"gear_id,omitempty"`
	KPGMKFOLJLN uint32 `protobuf:"varint,7,opt,name=KPGMKFOLJLN,proto3" json:"KPGMKFOLJLN,omitempty"`
	BOMLCILIEMG bool   `protobuf:"varint,4,opt,name=BOMLCILIEMG,proto3" json:"BOMLCILIEMG,omitempty"`
	FECKOAAIJKK bool   `protobuf:"varint,15,opt,name=FECKOAAIJKK,proto3" json:"FECKOAAIJKK,omitempty"`
	DIAJIFOBCHL uint32 `protobuf:"varint,14,opt,name=DIAJIFOBCHL,proto3" json:"DIAJIFOBCHL,omitempty"`
}
...
func (x *GearColumnInfo) GetKPGMKFOLJLN() uint32 {
	if x != nil {
		return x.KPGMKFOLJLN
	}
	return 0
}

func (x *GearColumnInfo) GetBOMLCILIEMG() bool {
	if x != nil {
		return x.BOMLCILIEMG
	}
	return false
}

func (x *GearColumnInfo) GetFECKOAAIJKK() bool {
	if x != nil {
		return x.FECKOAAIJKK
	}
	return false
}

func (x *GearColumnInfo) GetDIAJIFOBCHL() uint32 {
	if x != nil {
		return x.DIAJIFOBCHL
	}
	return 0
}
...
var file_GearColumnInfo_proto_rawDesc = []byte{
	...
	,
