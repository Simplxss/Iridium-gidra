...
type IslandPartyDetailInfo struct {
	...
	StageDataList []*IslandPartyStageData `protobuf:"bytes,3,rep,name=stage_data_list,json=stageDataList,proto3" json:"stage_data_list,omitempty"`
}
...
var file_IslandPartyDetailInfo_proto_rawDesc = []byte{
	...
	0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x49, 0x73,
