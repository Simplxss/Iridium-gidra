...
type RefreshRogueDiaryCardReq struct {
	...
	RefreshCardList []uint32 `protobuf:"varint,2,rep,packed,name=refresh_card_list,json=refreshCardList,proto3" json:"refresh_card_list,omitempty"`
}
...
var file_RefreshRogueDiaryCardReq_proto_rawDesc = []byte{
	...
	0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0f, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68,
