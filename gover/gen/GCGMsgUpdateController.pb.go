...
type GCGMsgUpdateController struct {
	...
	AllowControllerMap []*Uint32Pair `protobuf:"bytes,1,rep,name=allow_controller_map,json=allowControllerMap,proto3" json:"allow_controller_map,omitempty"`
}
...
var file_GCGMsgUpdateController_proto_rawDesc = []byte{
	...
	0x61, 0x70, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0b, 0x2e, 0x55, 0x69, 0x6e, 0x74, 0x33,
