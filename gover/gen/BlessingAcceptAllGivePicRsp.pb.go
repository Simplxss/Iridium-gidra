...
type BlessingAcceptAllGivePicRsp struct {
	...
	AcceptPicNumMap map[uint32]uint32 `protobuf:"bytes,1,rep,name=accept_pic_num_map,json=acceptPicNumMap,proto3" json:"accept_pic_num_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
