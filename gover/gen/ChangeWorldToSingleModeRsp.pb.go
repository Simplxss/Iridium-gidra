...
type ChangeWorldToSingleModeRsp struct {
	...
	QuitMpValidTime uint32 `protobuf:"varint,5,opt,name=quit_mp_valid_time,json=quitMpValidTime,proto3" json:"quit_mp_valid_time,omitempty"`
}
...
var file_ChangeWorldToSingleModeRsp_proto_rawDesc = []byte{
	...
	0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0f, 0x71, 0x75, 0x69, 0x74, 0x4d, 0x70, 0x56, 0x61,
