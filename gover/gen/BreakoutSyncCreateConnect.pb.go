...
type BreakoutSyncCreateConnect struct {
	...
	UidInfoList []*BreakoutSyncConnectUidInfo `protobuf:"bytes,2,rep,name=uid_info_list,json=uidInfoList,proto3" json:"uid_info_list,omitempty"`
}
...
var file_BreakoutSyncCreateConnect_proto_rawDesc = []byte{
	...
	0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x42, 0x72, 0x65, 0x61, 0x6b, 0x6f,
