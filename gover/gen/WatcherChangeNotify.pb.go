...
type WatcherChangeNotify struct {
	...
	LJOHAPLDDIA []uint32 `protobuf:"varint,9,rep,packed,name=LJOHAPLDDIA,proto3" json:"LJOHAPLDDIA,omitempty"`
	NEHBGOHNHLJ []uint32 `protobuf:"varint,12,rep,packed,name=NEHBGOHNHLJ,proto3" json:"NEHBGOHNHLJ,omitempty"`
}
...
func (x *WatcherChangeNotify) GetLJOHAPLDDIA() []uint32 {
	if x != nil {
		return x.LJOHAPLDDIA
	}
	return nil
}

func (x *WatcherChangeNotify) GetNEHBGOHNHLJ() []uint32 {
	if x != nil {
		return x.NEHBGOHNHLJ
	}
	return nil
}
...
var file_WatcherChangeNotify_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x69, 0x66, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x59, 0x0a, 0x13, 0x57,
	0x61, 0x74, 0x63, 0x68, 0x65, 0x72, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x4e, 0x6f, 0x74, 0x69,
	0x66, 0x79, 0x12, 0x20, 0x0a, 0x0b, 0x4c, 0x4a, 0x4f, 0x48, 0x41, 0x50, 0x4c, 0x44, 0x44, 0x49,
	0x41, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x4c, 0x4a, 0x4f, 0x48, 0x41, 0x50, 0x4c,
	0x44, 0x44, 0x49, 0x41, 0x12, 0x20, 0x0a, 0x0b, 0x4e, 0x45, 0x48, 0x42, 0x47, 0x4f, 0x48, 0x4e,
	0x48, 0x4c, 0x4a, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x4e, 0x45, 0x48, 0x42, 0x47,
	0x4f, 0x48, 0x4e, 0x48, 0x4c, 0x4a, 0x42, 0x06, 0x5a, 0x04, 0x2f, 0x67, 0x65, 0x6e, 0x62, 0x06,
...
var file_WatcherChangeNotify_proto_goTypes = []interface{}{
	(*WatcherChangeNotify)(nil), // 0: WatcherChangeNotify
}
