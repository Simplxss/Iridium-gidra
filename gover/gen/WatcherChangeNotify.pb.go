...
type WatcherChangeNotify struct {
	...
	LDFBKBABEDG []uint32 `protobuf:"varint,13,rep,packed,name=LDFBKBABEDG,proto3" json:"LDFBKBABEDG,omitempty"`
	IFEGPHMIGMG []uint32 `protobuf:"varint,5,rep,packed,name=IFEGPHMIGMG,proto3" json:"IFEGPHMIGMG,omitempty"`
}
...
func (x *WatcherChangeNotify) GetLDFBKBABEDG() []uint32 {
	if x != nil {
		return x.LDFBKBABEDG
	}
	return nil
}

func (x *WatcherChangeNotify) GetIFEGPHMIGMG() []uint32 {
	if x != nil {
		return x.IFEGPHMIGMG
	}
	return nil
}
...
var file_WatcherChangeNotify_proto_rawDesc = []byte{
	...
	0x66, 0x79, 0x12, 0x20, 0x0a, 0x0b, 0x4c, 0x44, 0x46, 0x42, 0x4b, 0x42, 0x41, 0x42, 0x45, 0x44,
	0x47, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x4c, 0x44, 0x46, 0x42, 0x4b, 0x42, 0x41,
	0x42, 0x45, 0x44, 0x47, 0x12, 0x20, 0x0a, 0x0b, 0x49, 0x46, 0x45, 0x47, 0x50, 0x48, 0x4d, 0x49,
	0x47, 0x4d, 0x47, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x49, 0x46, 0x45, 0x47, 0x50,
	0x48, 0x4d, 0x49, 0x47, 0x4d, 0x47, 0x42, 0x06, 0x5a, 0x04, 0x2f, 0x67, 0x65, 0x6e, 0x62, 0x06,
