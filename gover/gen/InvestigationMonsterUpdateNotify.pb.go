...
type InvestigationMonsterUpdateNotify struct {
	...
	InvestigationMonster *InvestigationMonster `protobuf:"bytes,13,opt,name=investigation_monster,json=investigationMonster,proto3" json:"investigation_monster,omitempty"`
}
...
var file_InvestigationMonsterUpdateNotify_proto_rawDesc = []byte{
	...
	0x72, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x49, 0x6e, 0x76, 0x65, 0x73, 0x74,
