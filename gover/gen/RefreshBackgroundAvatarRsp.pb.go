...
type RefreshBackgroundAvatarRsp struct {
	...
	HpFullTimeMap map[uint64]uint32 `protobuf:"bytes,1,rep,name=hp_full_time_map,json=hpFullTimeMap,proto3" json:"hp_full_time_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
...
var file_RefreshBackgroundAvatarRsp_proto_rawDesc = []byte{
	...
	0x65, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x52, 0x65,
