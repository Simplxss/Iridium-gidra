...
type SceneGalleryHomeSeekFurnitureInfo struct {
	...
	MPKMCJKPIAI    uint32            `protobuf:"varint,2,opt,name=MPKMCJKPIAI,proto3" json:"MPKMCJKPIAI,omitempty"`
	PlayerScoreMap map[uint32]uint32 `protobuf:"bytes,4,rep,name=player_score_map,json=playerScoreMap,proto3" json:"player_score_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	JMKGIKHIGKF    uint32            `protobuf:"varint,15,opt,name=JMKGIKHIGKF,proto3" json:"JMKGIKHIGKF,omitempty"`
	FOMNOCFGOCP    uint32            `protobuf:"varint,6,opt,name=FOMNOCFGOCP,proto3" json:"FOMNOCFGOCP,omitempty"`
}
...
func (x *SceneGalleryHomeSeekFurnitureInfo) GetMPKMCJKPIAI() uint32 {
	if x != nil {
		return x.MPKMCJKPIAI
	}
	return 0
}
...
func (x *SceneGalleryHomeSeekFurnitureInfo) GetJMKGIKHIGKF() uint32 {
	if x != nil {
		return x.JMKGIKHIGKF
	}
	return 0
}

func (x *SceneGalleryHomeSeekFurnitureInfo) GetFOMNOCFGOCP() uint32 {
	if x != nil {
		return x.FOMNOCFGOCP
	}
	return 0
}
...
var file_SceneGalleryHomeSeekFurnitureInfo_proto_rawDesc = []byte{
	...
	0x20, 0x0a, 0x0b, 0x4d, 0x50, 0x4b, 0x4d, 0x43, 0x4a, 0x4b, 0x50, 0x49, 0x41, 0x49, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x4d, 0x50, 0x4b, 0x4d, 0x43, 0x4a, 0x4b, 0x50, 0x49, 0x41,
	0x49, 0x12, 0x60, 0x0a, 0x10, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x5f, 0x73, 0x63, 0x6f, 0x72,
	0x65, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x36, 0x2e, 0x53, 0x63,
	0x65, 0x6e, 0x65, 0x47, 0x61, 0x6c, 0x6c, 0x65, 0x72, 0x79, 0x48, 0x6f, 0x6d, 0x65, 0x53, 0x65,
	...
	0x4d, 0x61, 0x70, 0x12, 0x20, 0x0a, 0x0b, 0x4a, 0x4d, 0x4b, 0x47, 0x49, 0x4b, 0x48, 0x49, 0x47,
	0x4b, 0x46, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x4a, 0x4d, 0x4b, 0x47, 0x49, 0x4b,
	0x48, 0x49, 0x47, 0x4b, 0x46, 0x12, 0x20, 0x0a, 0x0b, 0x46, 0x4f, 0x4d, 0x4e, 0x4f, 0x43, 0x46,
	0x47, 0x4f, 0x43, 0x50, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x46, 0x4f, 0x4d, 0x4e,
	0x4f, 0x43, 0x46, 0x47, 0x4f, 0x43, 0x50, 0x1a, 0x41, 0x0a, 0x13, 0x50, 0x6c, 0x61, 0x79, 0x65,
