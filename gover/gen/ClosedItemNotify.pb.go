...
type ClosedItemNotify struct {
	...
	ItemIdList []uint32 `protobuf:"varint,2,rep,packed,name=item_id_list,json=itemIdList,proto3" json:"item_id_list,omitempty"`
}
...
var file_ClosedItemNotify_proto_rawDesc = []byte{
	...
	0x69, 0x74, 0x65, 0x6d, 0x5f, 0x69, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x03,
...
var file_ClosedItemNotify_proto_goTypes = []interface{}{
	(*ClosedItemNotify)(nil), // 0: ClosedItemNotify
}
