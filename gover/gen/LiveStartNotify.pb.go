...
type LiveStartNotify struct {
	...
	LiveId uint32 `protobuf:"varint,4,opt,name=live_id,json=liveId,proto3" json:"live_id,omitempty"`
}
...
var file_LiveStartNotify_proto_rawDesc = []byte{
	...
	0x76, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x6c, 0x69, 0x76,
...
var file_LiveStartNotify_proto_goTypes = []interface{}{
	(*LiveStartNotify)(nil), // 0: LiveStartNotify
}
