...
type ItemCdGroupTimeNotify struct {
	...
	ItemCdMap map[uint32]uint64 `protobuf:"bytes,6,rep,name=item_cd_map,json=itemCdMap,proto3" json:"item_cd_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
var file_ItemCdGroupTimeNotify_proto_rawDesc = []byte{
	...
	0x63, 0x64, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x49,
