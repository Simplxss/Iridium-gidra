...
type UpdatePlayerShowAvatarListRsp struct {
	...
	ShowAvatarIdList []uint32 `protobuf:"varint,3,rep,packed,name=show_avatar_id_list,json=showAvatarIdList,proto3" json:"show_avatar_id_list,omitempty"`
	IsShowAvatar     bool     `protobuf:"varint,13,opt,name=is_show_avatar,json=isShowAvatar,proto3" json:"is_show_avatar,omitempty"`
...
var file_UpdatePlayerShowAvatarListRsp_proto_rawDesc = []byte{
	...
	0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x5f, 0x69, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x03,
	...
	0x77, 0x5f, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0c,
