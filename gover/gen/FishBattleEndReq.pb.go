...
type FishBattleEndReq struct {
	...
	MaxBonusTime  uint32           `protobuf:"varint,12,opt,name=max_bonus_time,json=maxBonusTime,proto3" json:"max_bonus_time,omitempty"`
	BattleResult  FishBattleResult `protobuf:"varint,9,opt,name=battle_result,json=battleResult,proto3,enum=FishBattleResult" json:"battle_result,omitempty"`
	IsAlwaysBonus bool             `protobuf:"varint,10,opt,name=is_always_bonus,json=isAlwaysBonus,proto3" json:"is_always_bonus,omitempty"`
}
...
var file_FishBattleEndReq_proto_rawDesc = []byte{
	...
	0x75, 0x73, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0c, 0x6d,
	0x61, 0x78, 0x42, 0x6f, 0x6e, 0x75, 0x73, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x36, 0x0a, 0x0d, 0x62,
	0x61, 0x74, 0x74, 0x6c, 0x65, 0x5f, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x09, 0x20, 0x01,
	...
	0x5f, 0x62, 0x6f, 0x6e, 0x75, 0x73, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0d, 0x69, 0x73,
...
var file_FishBattleEndReq_proto_goTypes = []interface{}{
	(*FishBattleEndReq)(nil), // 0: FishBattleEndReq
	(FishBattleResult)(0),    // 1: FishBattleResult
}
var file_FishBattleEndReq_proto_depIdxs = []int32{
	1, // 0: FishBattleEndReq.battle_result:type_name -> FishBattleResult
