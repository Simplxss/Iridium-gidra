...
type FishBattleEndReq struct {
	...
	BattleResult  FishBattleResult `protobuf:"varint,2,opt,name=battle_result,json=battleResult,proto3,enum=FishBattleResult" json:"battle_result,omitempty"`
	IsAlwaysBonus bool             `protobuf:"varint,3,opt,name=is_always_bonus,json=isAlwaysBonus,proto3" json:"is_always_bonus,omitempty"`
	MaxBonusTime  uint32           `protobuf:"varint,1,opt,name=max_bonus_time,json=maxBonusTime,proto3" json:"max_bonus_time,omitempty"`
}
...
var file_FishBattleEndReq_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x11, 0x2e, 0x46,
	...
	0x75, 0x73, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0c, 0x6d,
