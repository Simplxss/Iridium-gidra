...
type BrickBreakerActivityStageInfo struct {
	...
	HEGNICKAFFB bool   `protobuf:"varint,10,opt,name=HEGNICKAFFB,proto3" json:"HEGNICKAFFB,omitempty"`
	GLJHIOPBPNM bool   `protobuf:"varint,13,opt,name=GLJHIOPBPNM,proto3" json:"GLJHIOPBPNM,omitempty"`
}
...
func (x *BrickBreakerActivityStageInfo) GetHEGNICKAFFB() bool {
	if x != nil {
		return x.HEGNICKAFFB
	}
	return false
}

func (x *BrickBreakerActivityStageInfo) GetGLJHIOPBPNM() bool {
	if x != nil {
		return x.GLJHIOPBPNM
	}
	return false
}
...
var file_BrickBreakerActivityStageInfo_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x7e, 0x0a, 0x1d, 0x42, 0x72, 0x69, 0x63, 0x6b, 0x42, 0x72,
	0x65, 0x61, 0x6b, 0x65, 0x72, 0x41, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x53, 0x74, 0x61,
	...
	0x64, 0x12, 0x20, 0x0a, 0x0b, 0x48, 0x45, 0x47, 0x4e, 0x49, 0x43, 0x4b, 0x41, 0x46, 0x46, 0x42,
	0x18, 0x0a, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x48, 0x45, 0x47, 0x4e, 0x49, 0x43, 0x4b, 0x41,
	0x46, 0x46, 0x42, 0x12, 0x20, 0x0a, 0x0b, 0x47, 0x4c, 0x4a, 0x48, 0x49, 0x4f, 0x50, 0x42, 0x50,
	0x4e, 0x4d, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x47, 0x4c, 0x4a, 0x48, 0x49, 0x4f,
	0x50, 0x42, 0x50, 0x4e, 0x4d, 0x42, 0x06, 0x5a, 0x04, 0x2f, 0x67, 0x65, 0x6e, 0x62, 0x06, 0x70,
