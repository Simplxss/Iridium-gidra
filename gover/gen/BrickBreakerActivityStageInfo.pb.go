...
type BrickBreakerActivityStageInfo struct {
	...
	HIAOPLJIBNL bool   `protobuf:"varint,15,opt,name=HIAOPLJIBNL,proto3" json:"HIAOPLJIBNL,omitempty"`
	MHDFOPDMOBC bool   `protobuf:"varint,6,opt,name=MHDFOPDMOBC,proto3" json:"MHDFOPDMOBC,omitempty"`
...
func (x *BrickBreakerActivityStageInfo) GetHIAOPLJIBNL() bool {
	if x != nil {
		return x.HIAOPLJIBNL
	}
	return false
}

func (x *BrickBreakerActivityStageInfo) GetMHDFOPDMOBC() bool {
	if x != nil {
		return x.MHDFOPDMOBC
	}
	return false
}
...
var file_BrickBreakerActivityStageInfo_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x20, 0x0a, 0x0b, 0x48, 0x49, 0x41, 0x4f, 0x50, 0x4c,
	0x4a, 0x49, 0x42, 0x4e, 0x4c, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x48, 0x49, 0x41,
	0x4f, 0x50, 0x4c, 0x4a, 0x49, 0x42, 0x4e, 0x4c, 0x12, 0x20, 0x0a, 0x0b, 0x4d, 0x48, 0x44, 0x46,
	0x4f, 0x50, 0x44, 0x4d, 0x4f, 0x42, 0x43, 0x18, 0x06, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x4d,
	0x48, 0x44, 0x46, 0x4f, 0x50, 0x44, 0x4d, 0x4f, 0x42, 0x43, 0x12, 0x19, 0x0a, 0x08, 0x73, 0x74,
