...
type ChessPickCardRsp struct {
	...
	CardIndex uint32 `protobuf:"varint,15,opt,name=card_index,json=cardIndex,proto3" json:"card_index,omitempty"`
...
var file_ChessPickCardRsp_proto_rawDesc = []byte{
	...
	0x63, 0x61, 0x72, 0x64, 0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0d,
	0x52, 0x09, 0x63, 0x61, 0x72, 0x64, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x18, 0x0a, 0x07, 0x72,
...
var file_ChessPickCardRsp_proto_goTypes = []interface{}{
	(*ChessPickCardRsp)(nil), // 0: ChessPickCardRsp
}
