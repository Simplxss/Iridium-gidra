...
type MpPlayPrepareNotify struct {
	...
	PrepareEndTime uint32 `protobuf:"varint,3,opt,name=prepare_end_time,json=prepareEndTime,proto3" json:"prepare_end_time,omitempty"`
}
...
var file_MpPlayPrepareNotify_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0e, 0x70, 0x72, 0x65, 0x70,
