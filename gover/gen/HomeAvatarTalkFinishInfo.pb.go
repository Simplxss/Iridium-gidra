...
type HomeAvatarTalkFinishInfo struct {
	...
	FinishTalkIdList []uint32 `protobuf:"varint,1,rep,packed,name=finish_talk_id_list,json=finishTalkIdList,proto3" json:"finish_talk_id_list,omitempty"`
...
var file_HomeAvatarTalkFinishInfo_proto_rawDesc = []byte{
	...
	0x69, 0x73, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x10, 0x66, 0x69, 0x6e, 0x69, 0x73,
...
var file_HomeAvatarTalkFinishInfo_proto_goTypes = []interface{}{
	(*HomeAvatarTalkFinishInfo)(nil), // 0: HomeAvatarTalkFinishInfo
}
