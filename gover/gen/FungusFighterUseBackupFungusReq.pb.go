...
type FungusFighterUseBackupFungusReq struct {
	...
	BackupFungusIdList []uint32 `protobuf:"varint,12,rep,packed,name=backup_fungus_id_list,json=backupFungusIdList,proto3" json:"backup_fungus_id_list,omitempty"`
}
...
var file_FungusFighterUseBackupFungusReq_proto_rawDesc = []byte{
	...
	0x69, 0x73, 0x74, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x12, 0x62, 0x61, 0x63, 0x6b, 0x75,
