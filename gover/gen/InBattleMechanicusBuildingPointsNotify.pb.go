...
type InBattleMechanicusBuildingPointsNotify struct {
	...
	PlayerBuildingPointsMap map[uint32]uint32 `protobuf:"bytes,1,rep,name=player_building_points_map,json=playerBuildingPointsMap,proto3" json:"player_building_points_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
var file_InBattleMechanicusBuildingPointsNotify_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x74, 0x73, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x44,
