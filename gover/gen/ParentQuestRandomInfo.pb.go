...
type ParentQuestRandomInfo struct {
	...
	FactorList []uint32 `protobuf:"varint,12,rep,packed,name=factor_list,json=factorList,proto3" json:"factor_list,omitempty"`
	TemplateId uint32   `protobuf:"varint,1,opt,name=template_id,json=templateId,proto3" json:"template_id,omitempty"`
	EntranceId uint32   `protobuf:"varint,13,opt,name=entrance_id,json=entranceId,proto3" json:"entrance_id,omitempty"`
}
...
var file_ParentQuestRandomInfo_proto_rawDesc = []byte{
	...
	0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0a, 0x66, 0x61, 0x63,
	...
	0x61, 0x6e, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x65,
