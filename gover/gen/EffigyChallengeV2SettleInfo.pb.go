...
type EffigyChallengeV2SettleInfo struct {
	...
	GGGMOHCJPGF             uint32 `protobuf:"varint,3,opt,name=GGGMOHCJPGF,proto3" json:"GGGMOHCJPGF,omitempty"`
	HKKEHABACHB             bool   `protobuf:"varint,5,opt,name=HKKEHABACHB,proto3" json:"HKKEHABACHB,omitempty"`
	...
	BEPLBNMJMHC             uint32 `protobuf:"varint,9,opt,name=BEPLBNMJMHC,proto3" json:"BEPLBNMJMHC,omitempty"`
	GELMKIJIEDG             bool   `protobuf:"varint,11,opt,name=GELMKIJIEDG,proto3" json:"GELMKIJIEDG,omitempty"`
	GPNIFILAEFP             uint32 `protobuf:"varint,10,opt,name=GPNIFILAEFP,proto3" json:"GPNIFILAEFP,omitempty"`
}
...
func (x *EffigyChallengeV2SettleInfo) GetGGGMOHCJPGF() uint32 {
	if x != nil {
		return x.GGGMOHCJPGF
	}
	return 0
}

func (x *EffigyChallengeV2SettleInfo) GetHKKEHABACHB() bool {
	if x != nil {
		return x.HKKEHABACHB
	}
	return false
}
...
func (x *EffigyChallengeV2SettleInfo) GetBEPLBNMJMHC() uint32 {
	if x != nil {
		return x.BEPLBNMJMHC
	}
	return 0
}

func (x *EffigyChallengeV2SettleInfo) GetGELMKIJIEDG() bool {
	if x != nil {
		return x.GELMKIJIEDG
	}
	return false
}

func (x *EffigyChallengeV2SettleInfo) GetGPNIFILAEFP() uint32 {
	if x != nil {
		return x.GPNIFILAEFP
	}
	return 0
}
...
var file_EffigyChallengeV2SettleInfo_proto_rawDesc = []byte{
	...
	,
