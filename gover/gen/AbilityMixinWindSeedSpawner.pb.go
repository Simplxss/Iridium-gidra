...
type AbilityMixinWindSeedSpawner_AddSignal_ struct {
	AddSignal *AbilityMixinWindSeedSpawner_AddSignal `protobuf:"bytes,13,opt,name=add_signal,json=addSignal,proto3,oneof"`
}

type AbilityMixinWindSeedSpawner_RefreshSeed_ struct {
	RefreshSeed *AbilityMixinWindSeedSpawner_RefreshSeed `protobuf:"bytes,11,opt,name=refresh_seed,json=refreshSeed,proto3,oneof"`
}

type AbilityMixinWindSeedSpawner_CatchSeed_ struct {
	CatchSeed *AbilityMixinWindSeedSpawner_CatchSeed `protobuf:"bytes,4,opt,name=catch_seed,json=catchSeed,proto3,oneof"`
}
...
type AbilityMixinWindSeedSpawner_RefreshSeed struct {
	...
	PosList []*Vector `protobuf:"bytes,1,rep,name=pos_list,json=posList,proto3" json:"pos_list,omitempty"`
}
...
var file_AbilityMixinWindSeedSpawner_proto_rawDesc = []byte{
	...
	0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x41, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x4d,
	...
	0x66, 0x72, 0x65, 0x73, 0x68, 0x5f, 0x73, 0x65, 0x65, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b,
	...
	0x63, 0x68, 0x5f, 0x73, 0x65, 0x65, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x26, 0x2e,
	...
	0x0a, 0x08, 0x70, 0x6f, 0x73, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b,
