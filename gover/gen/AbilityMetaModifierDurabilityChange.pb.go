...
type AbilityMetaModifierDurabilityChange struct {
	...
	FOLHDMMHCIG float32 `protobuf:"fixed32,6,opt,name=FOLHDMMHCIG,proto3" json:"FOLHDMMHCIG,omitempty"`
	FHDBNIPEBBO float32 `protobuf:"fixed32,9,opt,name=FHDBNIPEBBO,proto3" json:"FHDBNIPEBBO,omitempty"`
}
...
func (x *AbilityMetaModifierDurabilityChange) GetFOLHDMMHCIG() float32 {
	if x != nil {
		return x.FOLHDMMHCIG
	}
	return 0
}

func (x *AbilityMetaModifierDurabilityChange) GetFHDBNIPEBBO() float32 {
	if x != nil {
		return x.FHDBNIPEBBO
	}
	return 0
}
...
var file_AbilityMetaModifierDurabilityChange_proto_rawDesc = []byte{
	...
	0x68, 0x61, 0x6e, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x69, 0x0a, 0x23, 0x41,
	...
	0x67, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x46, 0x4f, 0x4c, 0x48, 0x44, 0x4d, 0x4d, 0x48, 0x43, 0x49,
	0x47, 0x18, 0x06, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0b, 0x46, 0x4f, 0x4c, 0x48, 0x44, 0x4d, 0x4d,
	0x48, 0x43, 0x49, 0x47, 0x12, 0x20, 0x0a, 0x0b, 0x46, 0x48, 0x44, 0x42, 0x4e, 0x49, 0x50, 0x45,
	0x42, 0x42, 0x4f, 0x18, 0x09, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0b, 0x46, 0x48, 0x44, 0x42, 0x4e,
	0x49, 0x50, 0x45, 0x42, 0x42, 0x4f, 0x42, 0x06, 0x5a, 0x04, 0x2f, 0x67, 0x65, 0x6e, 0x62, 0x06,
