...
type GCGLimitsInfo struct {
	...
	ALDCMICHPPK uint32 `protobuf:"varint,11,opt,name=ALDCMICHPPK,proto3" json:"ALDCMICHPPK,omitempty"`
	IHELMLLKKJB uint32 `protobuf:"varint,7,opt,name=IHELMLLKKJB,proto3" json:"IHELMLLKKJB,omitempty"`
}
...
func (x *GCGLimitsInfo) GetALDCMICHPPK() uint32 {
	if x != nil {
		return x.ALDCMICHPPK
	}
	return 0
}

func (x *GCGLimitsInfo) GetIHELMLLKKJB() uint32 {
	if x != nil {
		return x.IHELMLLKKJB
	}
	return 0
}
...
var file_GCGLimitsInfo_proto_rawDesc = []byte{
	...
	0x74, 0x73, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x20, 0x0a, 0x0b, 0x41, 0x4c, 0x44, 0x43, 0x4d, 0x49,
	0x43, 0x48, 0x50, 0x50, 0x4b, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x41, 0x4c, 0x44,
	0x43, 0x4d, 0x49, 0x43, 0x48, 0x50, 0x50, 0x4b, 0x12, 0x20, 0x0a, 0x0b, 0x49, 0x48, 0x45, 0x4c,
	0x4d, 0x4c, 0x4c, 0x4b, 0x4b, 0x4a, 0x42, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x49,
	0x48, 0x45, 0x4c, 0x4d, 0x4c, 0x4c, 0x4b, 0x4b, 0x4a, 0x42, 0x42, 0x06, 0x5a, 0x04, 0x2f, 0x67,
