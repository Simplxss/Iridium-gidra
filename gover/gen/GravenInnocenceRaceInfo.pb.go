...
type GravenInnocenceRaceInfo struct {
	...
	LevelInfoList []*GravenInnocenceRaceLevelInfo `protobuf:"bytes,13,rep,name=level_info_list,json=levelInfoList,proto3" json:"level_info_list,omitempty"`
}
...
var file_GravenInnocenceRaceInfo_proto_rawDesc = []byte{
	...
	0x74, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x47, 0x72, 0x61, 0x76, 0x65, 0x6e,
