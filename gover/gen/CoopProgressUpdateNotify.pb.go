...
type CoopProgressUpdateNotify struct {
	...
	CurCoopPoint   uint32 `protobuf:"varint,8,opt,name=cur_coop_point,json=curCoopPoint,proto3" json:"cur_coop_point,omitempty"`
	IsHaveProgress bool   `protobuf:"varint,9,opt,name=is_have_progress,json=isHaveProgress,proto3" json:"is_have_progress,omitempty"`
}
...
var file_CoopProgressUpdateNotify_proto_rawDesc = []byte{
	...
	0x63, 0x75, 0x72, 0x5f, 0x63, 0x6f, 0x6f, 0x70, 0x5f, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x18, 0x08,
	...
	0x6f, 0x67, 0x72, 0x65, 0x73, 0x73, 0x18, 0x09, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0e, 0x69, 0x73,
...
var file_CoopProgressUpdateNotify_proto_goTypes = []interface{}{
	(*CoopProgressUpdateNotify)(nil), // 0: CoopProgressUpdateNotify
}
