...
type GCGOperationReboot struct {
	...
	DiceIndexList    []uint32 `protobuf:"varint,5,rep,packed,name=dice_index_list,json=diceIndexList,proto3" json:"dice_index_list,omitempty"`
...
var file_GCGOperationReboot_proto_rawDesc = []byte{
	...
	0x69, 0x73, 0x74, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0d, 0x64, 0x69, 0x63, 0x65, 0x49,
