...
type HideAndSeekPlayerReadyNotify struct {
	...
	UidList []uint32 `protobuf:"varint,13,rep,packed,name=uid_list,json=uidList,proto3" json:"uid_list,omitempty"`
}
...
var file_HideAndSeekPlayerReadyNotify_proto_rawDesc = []byte{
	...
	0x18, 0x0d, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x07, 0x75, 0x69, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x42,
