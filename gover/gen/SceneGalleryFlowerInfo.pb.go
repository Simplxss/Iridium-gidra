...
type SceneGalleryFlowerInfo struct {
	...
	CurScore    uint32 `protobuf:"varint,8,opt,name=cur_score,json=curScore,proto3" json:"cur_score,omitempty"`
	EndTime     uint32 `protobuf:"varint,4,opt,name=end_time,json=endTime,proto3" json:"end_time,omitempty"`
	TargetScore uint32 `protobuf:"varint,1,opt,name=target_score,json=targetScore,proto3" json:"target_score,omitempty"`
}
...
var file_SceneGalleryFlowerInfo_proto_rawDesc = []byte{
	...
	0x73, 0x63, 0x6f, 0x72, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x63, 0x75, 0x72,
	0x53, 0x63, 0x6f, 0x72, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x65, 0x6e, 0x64, 0x5f, 0x74, 0x69, 0x6d,
	0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65,
	0x12, 0x21, 0x0a, 0x0c, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x5f, 0x73, 0x63, 0x6f, 0x72, 0x65,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x53, 0x63,
...
var file_SceneGalleryFlowerInfo_proto_goTypes = []interface{}{
	(*SceneGalleryFlowerInfo)(nil), // 0: SceneGalleryFlowerInfo
}
