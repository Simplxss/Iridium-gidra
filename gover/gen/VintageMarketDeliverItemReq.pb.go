...
type VintageMarketDeliverItemReq struct {
	...
	DeliverItemList []*ItemParam `protobuf:"bytes,5,rep,name=deliver_item_list,json=deliverItemList,proto3" json:"deliver_item_list,omitempty"`
	TraderId        uint32       `protobuf:"varint,11,opt,name=trader_id,json=traderId,proto3" json:"trader_id,omitempty"`
}
...
var file_VintageMarketDeliverItemReq_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x64, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08,
