...
type AbilityMixinElementShield struct {
	...
	IsShieldBroken bool    `protobuf:"varint,5,opt,name=is_shield_broken,json=isShieldBroken,proto3" json:"is_shield_broken,omitempty"`
	FIEFKGHCBBO    float32 `protobuf:"fixed32,4,opt,name=FIEFKGHCBBO,proto3" json:"FIEFKGHCBBO,omitempty"`
	AFHOPKKJCJF    float32 `protobuf:"fixed32,9,opt,name=AFHOPKKJCJF,proto3" json:"AFHOPKKJCJF,omitempty"`
	GCAEMIGCBAK    uint32  `protobuf:"varint,7,opt,name=GCAEMIGCBAK,proto3" json:"GCAEMIGCBAK,omitempty"`
	FFMBPIKIJAP    float32 `protobuf:"fixed32,3,opt,name=FFMBPIKIJAP,proto3" json:"FFMBPIKIJAP,omitempty"`
	PlayerNum      uint32  `protobuf:"varint,6,opt,name=player_num,json=playerNum,proto3" json:"player_num,omitempty"`
}
...
func (x *AbilityMixinElementShield) GetFIEFKGHCBBO() float32 {
	if x != nil {
		return x.FIEFKGHCBBO
	}
	return 0
}

func (x *AbilityMixinElementShield) GetAFHOPKKJCJF() float32 {
	if x != nil {
		return x.AFHOPKKJCJF
	}
	return 0
}

func (x *AbilityMixinElementShield) GetGCAEMIGCBAK() uint32 {
	if x != nil {
		return x.GCAEMIGCBAK
	}
	return 0
}

func (x *AbilityMixinElementShield) GetFFMBPIKIJAP() float32 {
	if x != nil {
		return x.FFMBPIKIJAP
	}
	return 0
}
...
var file_AbilityMixinElementShield_proto_rawDesc = []byte{
	...
	,
...
var file_AbilityMixinElementShield_proto_goTypes = []interface{}{
	(*AbilityMixinElementShield)(nil), // 0: AbilityMixinElementShield
}
