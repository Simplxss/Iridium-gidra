...
type HomeCustomFurnitureInfoNotify struct {
	...
	DeleteCustomFurnitureList []uint32                   `protobuf:"varint,8,rep,packed,name=delete_custom_furniture_list,json=deleteCustomFurnitureList,proto3" json:"delete_custom_furniture_list,omitempty"`
	CustomFurnitureInfoList   []*HomeCustomFurnitureInfo `protobuf:"bytes,12,rep,name=custom_furniture_info_list,json=customFurnitureInfoList,proto3" json:"custom_furniture_info_list,omitempty"`
	UsedSubFurnitureCountMap  map[uint32]uint32          `protobuf:"bytes,10,rep,name=used_sub_furniture_count_map,json=usedSubFurnitureCountMap,proto3" json:"used_sub_furniture_count_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
var file_HomeCustomFurnitureInfoNotify_proto_rawDesc = []byte{
	...
	0x65, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x08, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x19, 0x64, 0x65,
	...
	0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x48, 0x6f,
	...
	0x74, 0x75, 0x72, 0x65, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x0a,
