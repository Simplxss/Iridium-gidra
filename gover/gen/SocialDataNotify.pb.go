...
type SocialDataNotify struct {
	...
	IsHaveFirstShare bool `protobuf:"varint,10,opt,name=is_have_first_share,json=isHaveFirstShare,proto3" json:"is_have_first_share,omitempty"`
}
...
var file_SocialDataNotify_proto_rawDesc = []byte{
	...
	0x61, 0x72, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x08, 0x52, 0x10, 0x69, 0x73, 0x48, 0x61, 0x76,
...
var file_SocialDataNotify_proto_goTypes = []interface{}{
	(*SocialDataNotify)(nil), // 0: SocialDataNotify
}
