...
type IrodoriChessPlayerInfoNotify struct {
	...
	PlayerInfo *IrodoriChessPlayerInfo `protobuf:"bytes,13,opt,name=player_info,json=playerInfo,proto3" json:"player_info,omitempty"`
}
...
var file_IrodoriChessPlayerInfoNotify_proto_rawDesc = []byte{
	...
	0x6f, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x49, 0x72, 0x6f, 0x64, 0x6f, 0x72,
