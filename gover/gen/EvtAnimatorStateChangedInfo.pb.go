...
type EvtAnimatorStateChangedInfo struct {
	...
	RefId                 uint32  `protobuf:"varint,9,opt,name=ref_id,json=refId,proto3" json:"ref_id,omitempty"`
	AFHAMAHFDFH           uint32  `protobuf:"varint,4,opt,name=AFHAMAHFDFH,proto3" json:"AFHAMAHFDFH,omitempty"`
	ONHINBKJJDG           bool    `protobuf:"varint,1,opt,name=ONHINBKJJDG,proto3" json:"ONHINBKJJDG,omitempty"`
	RefPos                *Vector `protobuf:"bytes,14,opt,name=ref_pos,json=refPos,proto3" json:"ref_pos,omitempty"`
	AEJFHAEJMAH           bool    `protobuf:"varint,10,opt,name=AEJFHAEJMAH,proto3" json:"AEJFHAEJMAH,omitempty"`
	NormalizedTimeCompact uint32  `protobuf:"varint,12,opt,name=normalized_time_compact,json=normalizedTimeCompact,proto3" json:"normalized_time_compact,omitempty"`
	Pos                   *Vector `protobuf:"bytes,15,opt,name=pos,proto3" json:"pos,omitempty"`
	FadeDuration          float32 `protobuf:"fixed32,7,opt,name=fade_duration,json=fadeDuration,proto3" json:"fade_duration,omitempty"`
	FaceAngleCompact      int32   `protobuf:"varint,8,opt,name=face_angle_compact,json=faceAngleCompact,proto3" json:"face_angle_compact,omitempty"`
	EntityId              uint32  `protobuf:"varint,6,opt,name=entity_id,json=entityId,proto3" json:"entity_id,omitempty"`
	BBHJKALOLNJ           uint32  `protobuf:"varint,2,opt,name=BBHJKALOLNJ,proto3" json:"BBHJKALOLNJ,omitempty"`
}
...
func (x *EvtAnimatorStateChangedInfo) GetRefId() uint32 {
	if x != nil {
		return x.RefId
	}
	return 0
...
func (x *EvtAnimatorStateChangedInfo) GetAFHAMAHFDFH() uint32 {
	if x != nil {
		return x.AFHAMAHFDFH
	}
	return 0
}

func (x *EvtAnimatorStateChangedInfo) GetONHINBKJJDG() bool {
	if x != nil {
		return x.ONHINBKJJDG
	}
	return false
}

func (x *EvtAnimatorStateChangedInfo) GetRefPos() *Vector {
	if x != nil {
		return x.RefPos
	}
	return nil
...
func (x *EvtAnimatorStateChangedInfo) GetAEJFHAEJMAH() bool {
	if x != nil {
		return x.AEJFHAEJMAH
	}
	return false
}
...
func (x *EvtAnimatorStateChangedInfo) GetBBHJKALOLNJ() uint32 {
	if x != nil {
		return x.BBHJKALOLNJ
	}
	return 0
}
...
var file_EvtAnimatorStateChangedInfo_proto_rawDesc = []byte{
	...
	,
...
var file_EvtAnimatorStateChangedInfo_proto_depIdxs = []int32{
	1, // 0: EvtAnimatorStateChangedInfo.ref_pos:type_name -> Vector
	1, // 1: EvtAnimatorStateChangedInfo.pos:type_name -> Vector
