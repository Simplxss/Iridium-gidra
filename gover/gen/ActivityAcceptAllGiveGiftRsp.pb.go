...
type ActivityAcceptAllGiveGiftRsp struct {
	...
	AcceptGiftResultInfoList []*ActivityAcceptGiftResultInfo `protobuf:"bytes,4,rep,name=accept_gift_result_info_list,json=acceptGiftResultInfoList,proto3" json:"accept_gift_result_info_list,omitempty"`
