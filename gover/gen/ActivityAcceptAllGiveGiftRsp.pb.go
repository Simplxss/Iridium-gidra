...
type ActivityAcceptAllGiveGiftRsp struct {
	...
	AcceptGiftResultInfoList []*ActivityAcceptGiftResultInfo `protobuf:"bytes,2,rep,name=accept_gift_result_info_list,json=acceptGiftResultInfoList,proto3" json:"accept_gift_result_info_list,omitempty"`
