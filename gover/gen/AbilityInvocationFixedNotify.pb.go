...
type AbilityInvocationFixedNotify struct {
	...
	DLABNBJEFGF *AbilityInvokeEntry `protobuf:"bytes,13,opt,name=DLABNBJEFGF,proto3" json:"DLABNBJEFGF,omitempty"`
	PIBKJHBGEHJ *AbilityInvokeEntry `protobuf:"bytes,2,opt,name=PIBKJHBGEHJ,proto3" json:"PIBKJHBGEHJ,omitempty"`
	EINJCADCDFP *AbilityInvokeEntry `protobuf:"bytes,12,opt,name=EINJCADCDFP,proto3" json:"EINJCADCDFP,omitempty"`
	DDLBMHEONMO *AbilityInvokeEntry `protobuf:"bytes,11,opt,name=DDLBMHEONMO,proto3" json:"DDLBMHEONMO,omitempty"`
	KHNKKDJIDIF *AbilityInvokeEntry `protobuf:"bytes,15,opt,name=KHNKKDJIDIF,proto3" json:"KHNKKDJIDIF,omitempty"`
	LGLHDKBGJDB *AbilityInvokeEntry `protobuf:"bytes,3,opt,name=LGLHDKBGJDB,proto3" json:"LGLHDKBGJDB,omitempty"`
}
...
func (x *AbilityInvocationFixedNotify) GetDLABNBJEFGF() *AbilityInvokeEntry {
	if x != nil {
		return x.DLABNBJEFGF
	}
	return nil
}

func (x *AbilityInvocationFixedNotify) GetPIBKJHBGEHJ() *AbilityInvokeEntry {
	if x != nil {
		return x.PIBKJHBGEHJ
	}
	return nil
}

func (x *AbilityInvocationFixedNotify) GetEINJCADCDFP() *AbilityInvokeEntry {
	if x != nil {
		return x.EINJCADCDFP
	}
	return nil
}

func (x *AbilityInvocationFixedNotify) GetDDLBMHEONMO() *AbilityInvokeEntry {
	if x != nil {
		return x.DDLBMHEONMO
	}
	return nil
}

func (x *AbilityInvocationFixedNotify) GetKHNKKDJIDIF() *AbilityInvokeEntry {
	if x != nil {
		return x.KHNKKDJIDIF
	}
	return nil
}

func (x *AbilityInvocationFixedNotify) GetLGLHDKBGJDB() *AbilityInvokeEntry {
	if x != nil {
		return x.LGLHDKBGJDB
	}
	return nil
}
...
var file_AbilityInvocationFixedNotify_proto_rawDesc = []byte{
	...
	,
...
var file_AbilityInvocationFixedNotify_proto_depIdxs = []int32{
	1, // 0: AbilityInvocationFixedNotify.DLABNBJEFGF:type_name -> AbilityInvokeEntry
	1, // 1: AbilityInvocationFixedNotify.PIBKJHBGEHJ:type_name -> AbilityInvokeEntry
	1, // 2: AbilityInvocationFixedNotify.EINJCADCDFP:type_name -> AbilityInvokeEntry
	1, // 3: AbilityInvocationFixedNotify.DDLBMHEONMO:type_name -> AbilityInvokeEntry
	1, // 4: AbilityInvocationFixedNotify.KHNKKDJIDIF:type_name -> AbilityInvokeEntry
	1, // 5: AbilityInvocationFixedNotify.LGLHDKBGJDB:type_name -> AbilityInvokeEntry
