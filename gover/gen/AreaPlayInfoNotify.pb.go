...
type AreaPlayInfoNotify struct {
	...
	DetailPlayType uint32       `protobuf:"varint,15,opt,name=detail_play_type,json=detailPlayType,proto3" json:"detail_play_type,omitempty"`
	AreaPlayType   AreaPlayType `protobuf:"varint,10,opt,name=area_play_type,json=areaPlayType,proto3,enum=AreaPlayType" json:"area_play_type,omitempty"`
}
...
var file_AreaPlayInfoNotify_proto_rawDesc = []byte{
	...
	0x6c, 0x61, 0x79, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0e,
	...
	0x18, 0x0a, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0d, 0x2e, 0x41, 0x72, 0x65, 0x61, 0x50, 0x6c, 0x61,
