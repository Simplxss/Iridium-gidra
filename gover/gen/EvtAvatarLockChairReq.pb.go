...
type EvtAvatarLockChairReq struct {
	...
	ChairId   uint64  `protobuf:"varint,9,opt,name=chair_id,json=chairId,proto3" json:"chair_id,omitempty"`
...
func (x *EvtAvatarLockChairReq) GetDirection() int32 {
	if x != nil {
		return x.Direction
	}
	return 0
...
var file_EvtAvatarLockChairReq_proto_rawDesc = []byte{
	...
	0x65, 0x63, 0x74, 0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x75, 0x0a, 0x15, 0x45,
	...
	0x69, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x04, 0x52, 0x07, 0x63, 0x68, 0x61,
	0x69, 0x72, 0x49, 0x64, 0x12, 0x1c, 0x0a, 0x09, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x69,
...
var file_EvtAvatarLockChairReq_proto_goTypes = []interface{}{
	(*EvtAvatarLockChairReq)(nil), // 0: EvtAvatarLockChairReq
	(*Vector)(nil),                // 1: Vector
}
var file_EvtAvatarLockChairReq_proto_depIdxs = []int32{
	1, // 0: EvtAvatarLockChairReq.position:type_name -> Vector
