...
type FleurFairMusicGameInfo struct {
	...
	MusicRecordMap map[uint32]*FleurFairMusicRecord `protobuf:"bytes,7,rep,name=music_record_map,json=musicRecordMap,proto3" json:"music_record_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_FleurFairMusicGameInfo_proto_rawDesc = []byte{
	...
	0x65, 0x63, 0x6f, 0x72, 0x64, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32,
