...
type ReserveRogueDiaryAvatarReq struct {
	...
	ReserveAvatarList []*RogueDiaryAvatar `protobuf:"bytes,12,rep,name=reserve_avatar_list,json=reserveAvatarList,proto3" json:"reserve_avatar_list,omitempty"`
}
...
var file_ReserveRogueDiaryAvatarReq_proto_rawDesc = []byte{
	...
	0x0c, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x52, 0x6f, 0x67, 0x75, 0x65, 0x44, 0x69, 0x61,
