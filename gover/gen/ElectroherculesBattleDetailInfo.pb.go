...
type ElectroherculesBattleDetailInfo struct {
	...
	FPADEODKEMH   bool                              `protobuf:"varint,6,opt,name=FPADEODKEMH,proto3" json:"FPADEODKEMH,omitempty"`
	StageInfoList []*ElectroherculesBattleStageInfo `protobuf:"bytes,11,rep,name=stage_info_list,json=stageInfoList,proto3" json:"stage_info_list,omitempty"`
}
...
func (x *ElectroherculesBattleDetailInfo) GetFPADEODKEMH() bool {
	if x != nil {
		return x.FPADEODKEMH
	}
	return false
}
...
var file_ElectroherculesBattleDetailInfo_proto_rawDesc = []byte{
	...
	0x73, 0x42, 0x61, 0x74, 0x74, 0x6c, 0x65, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x49, 0x6e, 0x66,
	0x6f, 0x12, 0x20, 0x0a, 0x0b, 0x46, 0x50, 0x41, 0x44, 0x45, 0x4f, 0x44, 0x4b, 0x45, 0x4d, 0x48,
	0x18, 0x06, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x46, 0x50, 0x41, 0x44, 0x45, 0x4f, 0x44, 0x4b,
	0x45, 0x4d, 0x48, 0x12, 0x47, 0x0a, 0x0f, 0x73, 0x74, 0x61, 0x67, 0x65, 0x5f, 0x69, 0x6e, 0x66,
	0x6f, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0b, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x45,
