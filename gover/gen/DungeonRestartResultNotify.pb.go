...
type DungeonRestartResultNotify struct {
	...
	IsAddAccpet bool `protobuf:"varint,13,opt,name=is_add_accpet,json=isAddAccpet,proto3" json:"is_add_accpet,omitempty"`
}
...
var file_DungeonRestartResultNotify_proto_rawDesc = []byte{
	...
	0x74, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x69, 0x73, 0x41, 0x64, 0x64, 0x41, 0x63,
