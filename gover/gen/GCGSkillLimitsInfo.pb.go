...
type GCGSkillLimitsInfo struct {
	...
	LimitsList []*GCGLimitsInfo `protobuf:"bytes,13,rep,name=limits_list,json=limitsList,proto3" json:"limits_list,omitempty"`
}
...
var file_GCGSkillLimitsInfo_proto_rawDesc = []byte{
	...
	0x0d, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x47, 0x43, 0x47, 0x4c, 0x69, 0x6d, 0x69, 0x74,
