...
type PotionResetChallengeRsp struct {
	...
	StageData *PotionStageData `protobuf:"bytes,10,opt,name=stage_data,json=stageData,proto3" json:"stage_data,omitempty"`
}
...
var file_PotionResetChallengeRsp_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x67, 0x65, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32,
