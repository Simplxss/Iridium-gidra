...
type GCGOperation_OpRedraw struct {
	OpRedraw *GCGOperationRedraw `protobuf:"bytes,6,opt,name=op_redraw,json=opRedraw,proto3,oneof"`
}

type GCGOperation_OpSelectOnStage struct {
	OpSelectOnStage *GCGOperationOnStageSelect `protobuf:"bytes,12,opt,name=op_select_on_stage,json=opSelectOnStage,proto3,oneof"`
}

type GCGOperation_OpReroll struct {
	OpReroll *GCGOperationReroll `protobuf:"bytes,14,opt,name=op_reroll,json=opReroll,proto3,oneof"`
}
...
type GCGOperation_OpPass struct {
	OpPass *GCGOperationPass `protobuf:"bytes,2,opt,name=op_pass,json=opPass,proto3,oneof"`
}

type GCGOperation_OpPlayCard struct {
	OpPlayCard *GCGOperationPlayCard `protobuf:"bytes,8,opt,name=op_play_card,json=opPlayCard,proto3,oneof"`
}

type GCGOperation_OpReboot struct {
	OpReboot *GCGOperationReboot `protobuf:"bytes,15,opt,name=op_reboot,json=opReboot,proto3,oneof"`
}

type GCGOperation_OpSurrender struct {
	OpSurrender *GCGOperationSurrender `protobuf:"bytes,9,opt,name=op_surrender,json=opSurrender,proto3,oneof"`
}
...
var file_GCGOperation_proto_rawDesc = []byte{
	...
	0x32, 0x0a, 0x09, 0x6f, 0x70, 0x5f, 0x72, 0x65, 0x64, 0x72, 0x61, 0x77, 0x18, 0x06, 0x20, 0x01,
	...
	0x5f, 0x6f, 0x6e, 0x5f, 0x73, 0x74, 0x61, 0x67, 0x65, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x0a, 0x09, 0x6f, 0x70, 0x5f, 0x72, 0x65, 0x72, 0x6f, 0x6c, 0x6c, 0x18, 0x0e, 0x20, 0x01, 0x28,
	...
	0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x47, 0x43, 0x47, 0x4f, 0x70, 0x65, 0x72, 0x61,
	...
	0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x47, 0x43, 0x47, 0x4f, 0x70, 0x65,
	...
	0x63, 0x61, 0x72, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x47, 0x43, 0x47,
	0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x6c, 0x61, 0x79, 0x43, 0x61, 0x72,
	0x64, 0x48, 0x00, 0x52, 0x0a, 0x6f, 0x70, 0x50, 0x6c, 0x61, 0x79, 0x43, 0x61, 0x72, 0x64, 0x12,
	0x32, 0x0a, 0x09, 0x6f, 0x70, 0x5f, 0x72, 0x65, 0x62, 0x6f, 0x6f, 0x74, 0x18, 0x0f, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x13, 0x2e, 0x47, 0x43, 0x47, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f,
	...
	0x64, 0x65, 0x72, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x47, 0x43, 0x47, 0x4f,
