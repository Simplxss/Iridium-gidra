...
type GetUgcBriefInfoReq struct {
	...
	UgcType UgcType `protobuf:"varint,11,opt,name=ugc_type,json=ugcType,proto3,enum=UgcType" json:"ugc_type,omitempty"`
}
...
var file_GetUgcBriefInfoReq_proto_rawDesc = []byte{
	...
	0x63, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x08, 0x2e, 0x55,
