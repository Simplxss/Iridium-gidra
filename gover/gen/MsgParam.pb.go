...
type MsgParam_IntParam struct {
	IntParam uint32 `protobuf:"varint,2,opt,name=int_param,json=intParam,proto3,oneof"`
}

type MsgParam_FltParam struct {
	FltParam float32 `protobuf:"fixed32,3,opt,name=flt_param,json=fltParam,proto3,oneof"`
}

type MsgParam_StrParam struct {
	StrParam string `protobuf:"bytes,12,opt,name=str_param,json=strParam,proto3,oneof"`
}
...
var file_MsgParam_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x74, 0x5f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x48,
	0x00, 0x52, 0x08, 0x69, 0x6e, 0x74, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x12, 0x1d, 0x0a, 0x09, 0x66,
	0x6c, 0x74, 0x5f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x18, 0x03, 0x20, 0x01, 0x28, 0x02, 0x48, 0x00,
	0x52, 0x08, 0x66, 0x6c, 0x74, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x12, 0x1d, 0x0a, 0x09, 0x73, 0x74,
	0x72, 0x5f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52,
