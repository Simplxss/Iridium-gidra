...
type PlayerRechargeDataNotify struct {
	...
	CardProductRemainDays uint32              `protobuf:"varint,4,opt,name=card_product_remain_days,json=cardProductRemainDays,proto3" json:"card_product_remain_days,omitempty"`
	ProductPriceTierList  []*ProductPriceTier `protobuf:"bytes,5,rep,name=product_price_tier_list,json=productPriceTierList,proto3" json:"product_price_tier_list,omitempty"`
}
...
var file_PlayerRechargeDataNotify_proto_rawDesc = []byte{
	...
	0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x15, 0x63, 0x61, 0x72, 0x64, 0x50, 0x72, 0x6f,
	...
	0x74, 0x69, 0x65, 0x72, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32,
...
var file_PlayerRechargeDataNotify_proto_goTypes = []interface{}{
	(*PlayerRechargeDataNotify)(nil), // 0: PlayerRechargeDataNotify
	(*ProductPriceTier)(nil),         // 1: ProductPriceTier
}
var file_PlayerRechargeDataNotify_proto_depIdxs = []int32{
	1, // 0: PlayerRechargeDataNotify.product_price_tier_list:type_name -> ProductPriceTier
