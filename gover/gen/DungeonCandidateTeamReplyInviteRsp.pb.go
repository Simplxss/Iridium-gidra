...
type DungeonCandidateTeamReplyInviteRsp struct {
	...
	IsTransPoint bool   `protobuf:"varint,7,opt,name=is_trans_point,json=isTransPoint,proto3" json:"is_trans_point,omitempty"`
...
func (x *DungeonCandidateTeamReplyInviteRsp) GetDungeonId() uint32 {
	if x != nil {
		return x.DungeonId
	}
	return 0
...
var file_DungeonCandidateTeamReplyInviteRsp_proto_rawDesc = []byte{
	...
	0x65, 0x52, 0x73, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x83, 0x01, 0x0a, 0x22, 0x44,
	...
	0x70, 0x12, 0x24, 0x0a, 0x0e, 0x69, 0x73, 0x5f, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x5f, 0x70, 0x6f,
	0x69, 0x6e, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0c, 0x69, 0x73, 0x54, 0x72, 0x61,
...
var file_DungeonCandidateTeamReplyInviteRsp_proto_goTypes = []interface{}{
	(*DungeonCandidateTeamReplyInviteRsp)(nil), // 0: DungeonCandidateTeamReplyInviteRsp
}
