...
type HomeSeekFurnitureAllRecord struct {
	...
	RecordList []*HomeSeekFurnitureOneRecord `protobuf:"bytes,4,rep,name=record_list,json=recordList,proto3" json:"record_list,omitempty"`
}
...
var file_HomeSeekFurnitureAllRecord_proto_rawDesc = []byte{
	...
	0x74, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x48, 0x6f, 0x6d, 0x65, 0x53, 0x65,
