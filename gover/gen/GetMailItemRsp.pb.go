...
type GetMailItemRsp struct {
	...
	MailIdList []uint32      `protobuf:"varint,4,rep,packed,name=mail_id_list,json=mailIdList,proto3" json:"mail_id_list,omitempty"`
}
...
var file_GetMailItemRsp_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x64, 0x65, 0x12, 0x28, 0x0a, 0x09, 0x69, 0x74, 0x65, 0x6d, 0x5f, 0x6c, 0x69, 0x73,
	0x74, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0b, 0x2e, 0x45, 0x71, 0x75, 0x69, 0x70, 0x50,
	0x61, 0x72, 0x61, 0x6d, 0x52, 0x08, 0x69, 0x74, 0x65, 0x6d, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x20,
	0x0a, 0x0c, 0x6d, 0x61, 0x69, 0x6c, 0x5f, 0x69, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x04,
...
var file_GetMailItemRsp_proto_goTypes = []interface{}{
	(*GetMailItemRsp)(nil), // 0: GetMailItemRsp
	(*EquipParam)(nil),     // 1: EquipParam
}
var file_GetMailItemRsp_proto_depIdxs = []int32{
	1, // 0: GetMailItemRsp.item_list:type_name -> EquipParam
