...
type SignatureAuditConfigNotify struct {
	...
	SubmitLimit uint32 `protobuf:"varint,9,opt,name=submit_limit,json=submitLimit,proto3" json:"submit_limit,omitempty"`
}
...
var file_SignatureAuditConfigNotify_proto_rawDesc = []byte{
	...
	0x6d, 0x69, 0x74, 0x5f, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0d, 0x52,
