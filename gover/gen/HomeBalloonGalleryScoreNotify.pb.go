...
type HomeBalloonGalleryScoreNotify struct {
	...
	AddScore        uint32 `protobuf:"varint,3,opt,name=add_score,json=addScore,proto3" json:"add_score,omitempty"`
}
...
var file_HomeBalloonGalleryScoreNotify_proto_rawDesc = []byte{
	...
	0x1b, 0x0a, 0x09, 0x61, 0x64, 0x64, 0x5f, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x18, 0x03, 0x20, 0x01,
