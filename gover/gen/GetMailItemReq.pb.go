...
type GetMailItemReq struct {
	...
	MailIdList []uint32 `protobuf:"varint,14,rep,packed,name=mail_id_list,json=mailIdList,proto3" json:"mail_id_list,omitempty"`
}
...
var file_GetMailItemReq_proto_goTypes = []interface{}{
	(*GetMailItemReq)(nil), // 0: GetMailItemReq
}
