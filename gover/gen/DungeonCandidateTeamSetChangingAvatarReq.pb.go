...
type DungeonCandidateTeamSetChangingAvatarReq struct {
	...
	IsChangingAvatar bool `protobuf:"varint,1,opt,name=is_changing_avatar,json=isChangingAvatar,proto3" json:"is_changing_avatar,omitempty"`
}
...
var file_DungeonCandidateTeamSetChangingAvatarReq_proto_rawDesc = []byte{
	...
	0x61, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x10, 0x69, 0x73, 0x43, 0x68, 0x61, 0x6e,
