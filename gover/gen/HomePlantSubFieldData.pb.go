...
type HomePlantSubFieldData struct {
	...
	CAKDDMKAIMD  HomePlantFieldStatus `protobuf:"varint,7,opt,name=CAKDDMKAIMD,proto3,enum=HomePlantFieldStatus" json:"CAKDDMKAIMD,omitempty"`
	JHFNDBIHLNB  uint32               `protobuf:"varint,8,opt,name=JHFNDBIHLNB,proto3" json:"JHFNDBIHLNB,omitempty"`
	EndTime      uint32               `protobuf:"fixed32,14,opt,name=end_time,json=endTime,proto3" json:"end_time,omitempty"`
	KHFGOPCOAGM  uint32               `protobuf:"varint,3,opt,name=KHFGOPCOAGM,proto3" json:"KHFGOPCOAGM,omitempty"`
}
...
func (x *HomePlantSubFieldData) GetCAKDDMKAIMD() HomePlantFieldStatus {
	if x != nil {
		return x.CAKDDMKAIMD
	}
	return HomePlantFieldStatus_HOME_FIELD_STATUE_NONE
}

func (x *HomePlantSubFieldData) GetJHFNDBIHLNB() uint32 {
	if x != nil {
		return x.JHFNDBIHLNB
	}
	return 0
}
...
func (x *HomePlantSubFieldData) GetKHFGOPCOAGM() uint32 {
	if x != nil {
		return x.KHFGOPCOAGM
	}
	return 0
}
...
var file_HomePlantSubFieldData_proto_rawDesc = []byte{
	...
	,
...
var file_HomePlantSubFieldData_proto_depIdxs = []int32{
	1, // 0: HomePlantSubFieldData.CAKDDMKAIMD:type_name -> HomePlantFieldStatus
