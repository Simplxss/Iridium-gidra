...
type WorldDataNotify struct {
	...
	WorldPropMap map[uint32]*PropValue `protobuf:"bytes,12,rep,name=world_prop_map,json=worldPropMap,proto3" json:"world_prop_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_WorldDataNotify_proto_rawDesc = []byte{
	...
	0x77, 0x6f, 0x72, 0x6c, 0x64, 0x5f, 0x70, 0x72, 0x6f, 0x70, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x0c,
