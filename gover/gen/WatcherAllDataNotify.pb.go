...
type WatcherAllDataNotify struct {
	...
	WatcherList []uint32 `protobuf:"varint,15,rep,packed,name=watcher_list,json=watcherList,proto3" json:"watcher_list,omitempty"`
}
...
var file_WatcherAllDataNotify_proto_rawDesc = []byte{
	...
	0x6c, 0x69, 0x73, 0x74, 0x18, 0x0f, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x77, 0x61, 0x74, 0x63,
...
var file_WatcherAllDataNotify_proto_goTypes = []interface{}{
	(*WatcherAllDataNotify)(nil), // 0: WatcherAllDataNotify
}
