...
type VintageMarketDeliverItemRsp struct {
	...
	TraderId uint32 `protobuf:"varint,2,opt,name=trader_id,json=traderId,proto3" json:"trader_id,omitempty"`
}
...
var file_VintageMarketDeliverItemRsp_proto_rawDesc = []byte{
	...
	0x74, 0x72, 0x61, 0x64, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52,
