...
type RogueDiaryStageInfo struct {
	...
	BestRecord *RogueDiaryDungeonRecord `protobuf:"bytes,7,opt,name=best_record,json=bestRecord,proto3" json:"best_record,omitempty"`
	IsHaveTry  bool                     `protobuf:"varint,13,opt,name=is_have_try,json=isHaveTry,proto3" json:"is_have_try,omitempty"`
}
...
var file_RogueDiaryStageInfo_proto_rawDesc = []byte{
	...
	0x0b, 0x62, 0x65, 0x73, 0x74, 0x5f, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x18, 0x07, 0x20, 0x01,
	...
	0x61, 0x76, 0x65, 0x5f, 0x74, 0x72, 0x79, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09, 0x69,
