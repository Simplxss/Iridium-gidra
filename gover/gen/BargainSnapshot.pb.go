...
type BargainSnapshot struct {
	...
	PJHMEHGELGC uint32 `protobuf:"varint,13,opt,name=PJHMEHGELGC,proto3" json:"PJHMEHGELGC,omitempty"`
	CurMood     int32  `protobuf:"varint,14,opt,name=cur_mood,json=curMood,proto3" json:"cur_mood,omitempty"`
	HADMOPEJFIC uint32 `protobuf:"varint,12,opt,name=HADMOPEJFIC,proto3" json:"HADMOPEJFIC,omitempty"`
	BargainId   uint32 `protobuf:"varint,10,opt,name=bargain_id,json=bargainId,proto3" json:"bargain_id,omitempty"`
}
...
func (x *BargainSnapshot) GetPJHMEHGELGC() uint32 {
	if x != nil {
		return x.PJHMEHGELGC
	}
	return 0
}
...
func (x *BargainSnapshot) GetHADMOPEJFIC() uint32 {
	if x != nil {
		return x.HADMOPEJFIC
	}
	return 0
}
...
var file_BargainSnapshot_proto_rawDesc = []byte{
	...
	,
...
var file_BargainSnapshot_proto_goTypes = []interface{}{
	(*BargainSnapshot)(nil), // 0: BargainSnapshot
}
