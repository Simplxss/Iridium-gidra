...
type ProductPriceTier struct {
	...
	PriceTier string `protobuf:"bytes,4,opt,name=price_tier,json=priceTier,proto3" json:"price_tier,omitempty"`
}
...
var file_ProductPriceTier_proto_rawDesc = []byte{
	...
	0x72, 0x69, 0x63, 0x65, 0x5f, 0x74, 0x69, 0x65, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52,
