...
type CustomDungeonSocial struct {
	...
	DKDJDMMPICM uint32 `protobuf:"varint,13,opt,name=DKDJDMMPICM,proto3" json:"DKDJDMMPICM,omitempty"`
	OPCLKCLOEJG uint32 `protobuf:"varint,4,opt,name=OPCLKCLOEJG,proto3" json:"OPCLKCLOEJG,omitempty"`
	AGFMPAJMBMF uint32 `protobuf:"varint,2,opt,name=AGFMPAJMBMF,proto3" json:"AGFMPAJMBMF,omitempty"`
	GLBMLFCKMHP uint32 `protobuf:"varint,7,opt,name=GLBMLFCKMHP,proto3" json:"GLBMLFCKMHP,omitempty"`
}
...
func (x *CustomDungeonSocial) GetDKDJDMMPICM() uint32 {
	if x != nil {
		return x.DKDJDMMPICM
	}
	return 0
}

func (x *CustomDungeonSocial) GetOPCLKCLOEJG() uint32 {
	if x != nil {
		return x.OPCLKCLOEJG
	}
	return 0
}

func (x *CustomDungeonSocial) GetAGFMPAJMBMF() uint32 {
	if x != nil {
		return x.AGFMPAJMBMF
	}
	return 0
}

func (x *CustomDungeonSocial) GetGLBMLFCKMHP() uint32 {
	if x != nil {
		return x.GLBMLFCKMHP
	}
	return 0
}
...
var file_CustomDungeonSocial_proto_rawDesc = []byte{
	...
	,
