...
type PersonalLineNewUnlockNotify struct {
	...
	PersonalLineIdList []uint32 `protobuf:"varint,15,rep,packed,name=personal_line_id_list,json=personalLineIdList,proto3" json:"personal_line_id_list,omitempty"`
}
...
var file_PersonalLineNewUnlockNotify_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x65, 0x5f, 0x69, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0f, 0x20, 0x03, 0x28,
...
var file_PersonalLineNewUnlockNotify_proto_goTypes = []interface{}{
	(*PersonalLineNewUnlockNotify)(nil), // 0: PersonalLineNewUnlockNotify
}
