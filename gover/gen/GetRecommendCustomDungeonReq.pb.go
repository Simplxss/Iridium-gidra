...
type GetRecommendCustomDungeonReq struct {
	...
	IsRefresh bool `protobuf:"varint,15,opt,name=is_refresh,json=isRefresh,proto3" json:"is_refresh,omitempty"`
}
...
var file_GetRecommendCustomDungeonReq_proto_rawDesc = []byte{
	...
	0x73, 0x68, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09, 0x69, 0x73, 0x52, 0x65, 0x66, 0x72,
