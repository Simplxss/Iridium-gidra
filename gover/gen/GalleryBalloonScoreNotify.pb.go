...
type GalleryBalloonScoreNotify struct {
	...
	UidScoreMap map[uint32]uint32 `protobuf:"bytes,10,rep,name=uid_score_map,json=uidScoreMap,proto3" json:"uid_score_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
...
var file_GalleryBalloonScoreNotify_proto_rawDesc = []byte{
	...
	0x18, 0x0a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x47, 0x61, 0x6c, 0x6c, 0x65, 0x72, 0x79,
