...
type BreakoutSyncFinishGame struct {
	...
	IsStopGallery  bool   `protobuf:"varint,10,opt,name=is_stop_gallery,json=isStopGallery,proto3" json:"is_stop_gallery,omitempty"`
	ServerGameTime uint64 `protobuf:"varint,6,opt,name=server_game_time,json=serverGameTime,proto3" json:"server_game_time,omitempty"`
...
var file_BreakoutSyncFinishGame_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x6f, 0x70, 0x5f, 0x67, 0x61, 0x6c, 0x6c, 0x65, 0x72, 0x79, 0x18, 0x0a, 0x20, 0x01,
	...
	0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0e, 0x73, 0x65, 0x72,
