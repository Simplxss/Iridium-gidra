...
type AvatarFetterDataNotify struct {
	...
	FetterInfoMap map[uint64]*AvatarFetterInfo `protobuf:"bytes,8,rep,name=fetter_info_map,json=fetterInfoMap,proto3" json:"fetter_info_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_AvatarFetterDataNotify_proto_rawDesc = []byte{
	...
	0x5f, 0x6d, 0x61, 0x70, 0x18, 0x08, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x41, 0x76, 0x61,
