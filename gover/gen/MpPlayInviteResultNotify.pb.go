...
type MpPlayInviteResultNotify struct {
	...
	AllArgee bool   `protobuf:"varint,4,opt,name=all_argee,json=allArgee,proto3" json:"all_argee,omitempty"`
}
...
var file_MpPlayInviteResultNotify_proto_rawDesc = []byte{
	...
	0x6c, 0x5f, 0x61, 0x72, 0x67, 0x65, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x61,
