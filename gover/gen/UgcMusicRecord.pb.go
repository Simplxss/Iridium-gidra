...
type UgcMusicRecord struct {
	...
	MusicTrackList []*UgcMusicTrack `protobuf:"bytes,3,rep,name=music_track_list,json=musicTrackList,proto3" json:"music_track_list,omitempty"`
	MusicId        uint32           `protobuf:"varint,14,opt,name=music_id,json=musicId,proto3" json:"music_id,omitempty"`
}
...
var file_UgcMusicRecord_proto_rawDesc = []byte{
	...
	0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x55, 0x67, 0x63, 0x4d, 0x75, 0x73,
	...
	0x5f, 0x69, 0x64, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x6d, 0x75, 0x73, 0x69, 0x63,
