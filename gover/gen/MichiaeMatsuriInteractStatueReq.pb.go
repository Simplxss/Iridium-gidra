...
type MichiaeMatsuriInteractStatueReq struct {
	...
	StatueEntityId uint32 `protobuf:"varint,12,opt,name=statue_entity_id,json=statueEntityId,proto3" json:"statue_entity_id,omitempty"`
}
...
var file_MichiaeMatsuriInteractStatueReq_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x75, 0x65, 0x5f, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x0c,
