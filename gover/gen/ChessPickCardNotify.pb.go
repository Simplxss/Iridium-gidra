...
type ChessPickCardNotify struct {
	...
	CurseCardId    uint32               `protobuf:"varint,10,opt,name=curse_card_id,json=curseCardId,proto3" json:"curse_card_id,omitempty"`
	NormalCardInfo *ChessNormalCardInfo `protobuf:"bytes,15,opt,name=normal_card_info,json=normalCardInfo,proto3" json:"normal_card_info,omitempty"`
}
...
var file_ChessPickCardNotify_proto_rawDesc = []byte{
	...
	0x0d, 0x63, 0x75, 0x72, 0x73, 0x65, 0x5f, 0x63, 0x61, 0x72, 0x64, 0x5f, 0x69, 0x64, 0x18, 0x0a,
	...
	0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x43, 0x68,
...
var file_ChessPickCardNotify_proto_goTypes = []interface{}{
	(*ChessPickCardNotify)(nil), // 0: ChessPickCardNotify
	(*ChessNormalCardInfo)(nil), // 1: ChessNormalCardInfo
}
var file_ChessPickCardNotify_proto_depIdxs = []int32{
	1, // 0: ChessPickCardNotify.normal_card_info:type_name -> ChessNormalCardInfo
