...
type SetSceneWeatherAreaReq struct {
	...
	WeatherValueMap map[uint32]string `protobuf:"bytes,3,rep,name=weather_value_map,json=weatherValueMap,proto3" json:"weather_value_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	WeatherGadgetId uint32            `protobuf:"varint,5,opt,name=weather_gadget_id,json=weatherGadgetId,proto3" json:"weather_gadget_id,omitempty"`
}
...
var file_SetSceneWeatherAreaReq_proto_rawDesc = []byte{
	...
	0x74, 0x68, 0x65, 0x72, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x03,
	...
	0x61, 0x64, 0x67, 0x65, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0f,
...
var file_SetSceneWeatherAreaReq_proto_goTypes = []interface{}{
	(*SetSceneWeatherAreaReq)(nil), // 0: SetSceneWeatherAreaReq
	nil,                            // 1: SetSceneWeatherAreaReq.WeatherValueMapEntry
}
var file_SetSceneWeatherAreaReq_proto_depIdxs = []int32{
	1, // 0: SetSceneWeatherAreaReq.weather_value_map:type_name -> SetSceneWeatherAreaReq.WeatherValueMapEntry
