...
type GachaActivityUpdateElemNotify struct {
	...
	ElemType uint32 `protobuf:"varint,13,opt,name=elem_type,json=elemType,proto3" json:"elem_type,omitempty"`
}
...
var file_GachaActivityUpdateElemNotify_proto_rawDesc = []byte{
	...
	0x79, 0x70, 0x65, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x65, 0x6c, 0x65, 0x6d, 0x54,
