...
type FishPoolDataNotify struct {
	...
	TodayFishNum uint32 `protobuf:"varint,1,opt,name=today_fish_num,json=todayFishNum,proto3" json:"today_fish_num,omitempty"`
}
...
var file_FishPoolDataNotify_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0c, 0x74, 0x6f, 0x64, 0x61, 0x79, 0x46, 0x69, 0x73, 0x68,
...
var file_FishPoolDataNotify_proto_goTypes = []interface{}{
	(*FishPoolDataNotify)(nil), // 0: FishPoolDataNotify
}
