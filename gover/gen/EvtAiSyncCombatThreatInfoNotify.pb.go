...
type EvtAiSyncCombatThreatInfoNotify struct {
	...
	CombatThreatInfoMap map[uint32]*AiThreatInfo `protobuf:"bytes,15,rep,name=combat_threat_info_map,json=combatThreatInfoMap,proto3" json:"combat_threat_info_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_EvtAiSyncCombatThreatInfoNotify_proto_rawDesc = []byte{
	...
	0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x0f, 0x20, 0x03, 0x28, 0x0b, 0x32,
