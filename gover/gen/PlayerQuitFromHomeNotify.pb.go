...
type PlayerQuitFromHomeNotify struct {
	...
	Reason PlayerQuitFromHomeNotify_QuitReason `protobuf:"varint,13,opt,name=reason,proto3,enum=PlayerQuitFromHomeNotify_QuitReason" json:"reason,omitempty"`
}
...
var file_PlayerQuitFromHomeNotify_proto_rawDesc = []byte{
	...
	0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x24, 0x2e,
