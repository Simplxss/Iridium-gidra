...
type ChangeMailStarNotify struct {
	...
	IsStar     bool     `protobuf:"varint,13,opt,name=is_star,json=isStar,proto3" json:"is_star,omitempty"`
	MailIdList []uint32 `protobuf:"varint,15,rep,packed,name=mail_id_list,json=mailIdList,proto3" json:"mail_id_list,omitempty"`
}
...
var file_ChangeMailStarNotify_proto_rawDesc = []byte{
	...
	0x0d, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x69, 0x73, 0x53, 0x74, 0x61, 0x72, 0x12, 0x20, 0x0a,
	0x0c, 0x6d, 0x61, 0x69, 0x6c, 0x5f, 0x69, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0f, 0x20,
...
var file_ChangeMailStarNotify_proto_goTypes = []interface{}{
	(*ChangeMailStarNotify)(nil), // 0: ChangeMailStarNotify
}
