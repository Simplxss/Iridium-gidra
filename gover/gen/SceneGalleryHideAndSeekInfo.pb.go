...
type SceneGalleryHideAndSeekInfo struct {
	...
	PDGGAJOINHB []uint32 `protobuf:"varint,9,rep,packed,name=PDGGAJOINHB,proto3" json:"PDGGAJOINHB,omitempty"`
	LPHCMGCELBB []uint32 `protobuf:"varint,3,rep,packed,name=LPHCMGCELBB,proto3" json:"LPHCMGCELBB,omitempty"`
}
...
func (x *SceneGalleryHideAndSeekInfo) GetPDGGAJOINHB() []uint32 {
	if x != nil {
		return x.PDGGAJOINHB
	}
	return nil
}

func (x *SceneGalleryHideAndSeekInfo) GetLPHCMGCELBB() []uint32 {
	if x != nil {
		return x.LPHCMGCELBB
	}
	return nil
}
...
var file_SceneGalleryHideAndSeekInfo_proto_rawDesc = []byte{
	...
	0x66, 0x6f, 0x12, 0x20, 0x0a, 0x0b, 0x50, 0x44, 0x47, 0x47, 0x41, 0x4a, 0x4f, 0x49, 0x4e, 0x48,
	0x42, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x50, 0x44, 0x47, 0x47, 0x41, 0x4a, 0x4f,
	0x49, 0x4e, 0x48, 0x42, 0x12, 0x20, 0x0a, 0x0b, 0x4c, 0x50, 0x48, 0x43, 0x4d, 0x47, 0x43, 0x45,
	0x4c, 0x42, 0x42, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x4c, 0x50, 0x48, 0x43, 0x4d,
	0x47, 0x43, 0x45, 0x4c, 0x42, 0x42, 0x42, 0x06, 0x5a, 0x04, 0x2f, 0x67, 0x65, 0x6e, 0x62, 0x06,
