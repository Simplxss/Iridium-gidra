...
type IrodoriFlowerData struct {
	...
	FinishedThemeList []uint32     `protobuf:"varint,3,rep,packed,name=finished_theme_list,json=finishedThemeList,proto3" json:"finished_theme_list,omitempty"`
	UsedFlowerList    []*ItemParam `protobuf:"bytes,2,rep,name=used_flower_list,json=usedFlowerList,proto3" json:"used_flower_list,omitempty"`
}
...
var file_IrodoriFlowerData_proto_rawDesc = []byte{
	...
	0x65, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x11, 0x66, 0x69,
