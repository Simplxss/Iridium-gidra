...
type GetShopmallDataRsp struct {
	...
	ShopTypeList []uint32 `protobuf:"varint,3,rep,packed,name=shop_type_list,json=shopTypeList,proto3" json:"shop_type_list,omitempty"`
}
...
var file_GetShopmallDataRsp_proto_rawDesc = []byte{
	...
	0x6f, 0x70, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x03,
...
var file_GetShopmallDataRsp_proto_goTypes = []interface{}{
	(*GetShopmallDataRsp)(nil), // 0: GetShopmallDataRsp
}
