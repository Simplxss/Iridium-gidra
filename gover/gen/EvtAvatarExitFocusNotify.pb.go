...
type EvtAvatarExitFocusNotify struct {
	...
	FinishForward *Vector     `protobuf:"bytes,7,opt,name=finish_forward,json=finishForward,proto3" json:"finish_forward,omitempty"`
}
...
var file_EvtAvatarExitFocusNotify_proto_rawDesc = []byte{
	...
	0x66, 0x69, 0x6e, 0x69, 0x73, 0x68, 0x5f, 0x66, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x18, 0x07,
