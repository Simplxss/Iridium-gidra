...
type GCGSkillPreviewTokenInfo struct {
	...
	KFBIKHHBKEE uint32 `protobuf:"varint,3,opt,name=KFBIKHHBKEE,proto3" json:"KFBIKHHBKEE,omitempty"`
	BACKHFIPFPG uint32 `protobuf:"varint,8,opt,name=BACKHFIPFPG,proto3" json:"BACKHFIPFPG,omitempty"`
...
func (x *GCGSkillPreviewTokenInfo) GetKFBIKHHBKEE() uint32 {
	if x != nil {
		return x.KFBIKHHBKEE
	}
	return 0
}

func (x *GCGSkillPreviewTokenInfo) GetBACKHFIPFPG() uint32 {
	if x != nil {
		return x.BACKHFIPFPG
	}
	return 0
}

func (x *GCGSkillPreviewTokenInfo) GetBKGKHIEOMFB() uint32 {
	if x != nil {
...
var file_GCGSkillPreviewTokenInfo_proto_rawDesc = []byte{
	...
	0x0b, 0x4b, 0x46, 0x42, 0x49, 0x4b, 0x48, 0x48, 0x42, 0x4b, 0x45, 0x45, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x0b, 0x4b, 0x46, 0x42, 0x49, 0x4b, 0x48, 0x48, 0x42, 0x4b, 0x45, 0x45, 0x12,
	0x20, 0x0a, 0x0b, 0x42, 0x41, 0x43, 0x4b, 0x48, 0x46, 0x49, 0x50, 0x46, 0x50, 0x47, 0x18, 0x08,
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x42, 0x41, 0x43, 0x4b, 0x48, 0x46, 0x49, 0x50, 0x46, 0x50,
	0x47, 0x12, 0x20, 0x0a, 0x0b, 0x42, 0x4b, 0x47, 0x4b, 0x48, 0x49, 0x45, 0x4f, 0x4d, 0x46, 0x42,
	0x18, 0x0c, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x42, 0x4b, 0x47, 0x4b, 0x48, 0x49, 0x45, 0x4f,
	0x4d, 0x46, 0x42, 0x42, 0x06, 0x5a, 0x04, 0x2f, 0x67, 0x65, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
