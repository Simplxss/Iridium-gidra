...
type CoopReward struct {
	...
	State CoopReward_State `protobuf:"varint,10,opt,name=state,proto3,enum=CoopReward_State" json:"state,omitempty"`
}
...
var file_CoopReward_proto_rawDesc = []byte{
	...
	0x64, 0x12, 0x27, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0e,
