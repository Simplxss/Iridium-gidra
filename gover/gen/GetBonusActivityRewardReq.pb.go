...
type GetBonusActivityRewardReq struct {
	...
	BonusActivityId uint32 `protobuf:"varint,13,opt,name=bonus_activity_id,json=bonusActivityId,proto3" json:"bonus_activity_id,omitempty"`
}
...
var file_GetBonusActivityRewardReq_proto_rawDesc = []byte{
	...
	0x5f, 0x69, 0x64, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0f, 0x62, 0x6f, 0x6e, 0x75, 0x73,
...
var file_GetBonusActivityRewardReq_proto_goTypes = []interface{}{
	(*GetBonusActivityRewardReq)(nil), // 0: GetBonusActivityRewardReq
}
