...
type PlayerDeathZoneNotify struct {
	...
	CurDeathZoneId uint32 `protobuf:"varint,5,opt,name=cur_death_zone_id,json=curDeathZoneId,proto3" json:"cur_death_zone_id,omitempty"`
}
...
var file_PlayerDeathZoneNotify_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x68, 0x5f, 0x7a, 0x6f, 0x6e, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28,
