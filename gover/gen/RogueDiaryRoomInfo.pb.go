...
type RogueDiaryRoomInfo struct {
	...
	IsBoss      bool          `protobuf:"varint,9,opt,name=is_boss,json=isBoss,proto3" json:"is_boss,omitempty"`
	ConfigId    uint32        `protobuf:"varint,15,opt,name=config_id,json=configId,proto3" json:"config_id,omitempty"`
	MonsterList []*Uint32Pair `protobuf:"bytes,3,rep,name=monster_list,json=monsterList,proto3" json:"monster_list,omitempty"`
}
...
var file_RogueDiaryRoomInfo_proto_rawDesc = []byte{
	...
	0x66, 0x6f, 0x12, 0x17, 0x0a, 0x07, 0x69, 0x73, 0x5f, 0x62, 0x6f, 0x73, 0x73, 0x18, 0x09, 0x20,
	...
	0x74, 0x65, 0x72, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0b,
