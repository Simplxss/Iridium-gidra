...
type CoopCgUpdateNotify struct {
	...
	CgList []uint32 `protobuf:"varint,4,rep,packed,name=cg_list,json=cgList,proto3" json:"cg_list,omitempty"`
}
...
var file_CoopCgUpdateNotify_proto_rawDesc = []byte{
	...
	0x12, 0x17, 0x0a, 0x07, 0x63, 0x67, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x04, 0x20, 0x03, 0x28,
