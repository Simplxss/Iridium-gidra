...
type TriggerRoguelikeRuneRsp struct {
	...
	RuneId         uint32 `protobuf:"varint,2,opt,name=rune_id,json=runeId,proto3" json:"rune_id,omitempty"`
	Retcode        int32  `protobuf:"varint,5,opt,name=retcode,proto3" json:"retcode,omitempty"`
	AvailableCount uint32 `protobuf:"varint,10,opt,name=available_count,json=availableCount,proto3" json:"available_count,omitempty"`
}
...
var file_TriggerRoguelikeRuneRsp_proto_rawDesc = []byte{
	...
	0x69, 0x6b, 0x65, 0x52, 0x75, 0x6e, 0x65, 0x52, 0x73, 0x70, 0x12, 0x17, 0x0a, 0x07, 0x72, 0x75,
	0x6e, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x72, 0x75, 0x6e,
	0x65, 0x49, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x72, 0x65, 0x74, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x05,
	...
	0x18, 0x0a, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0e, 0x61, 0x76, 0x61, 0x69, 0x6c, 0x61, 0x62, 0x6c,
...
var file_TriggerRoguelikeRuneRsp_proto_goTypes = []interface{}{
	(*TriggerRoguelikeRuneRsp)(nil), // 0: TriggerRoguelikeRuneRsp
}
