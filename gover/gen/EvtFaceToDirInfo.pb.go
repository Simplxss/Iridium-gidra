...
type EvtFaceToDirInfo struct {
	...
	FaceDir  *Vector `protobuf:"bytes,9,opt,name=face_dir,json=faceDir,proto3" json:"face_dir,omitempty"`
}
...
var file_EvtFaceToDirInfo_proto_rawDesc = []byte{
	...
	0x64, 0x69, 0x72, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x07, 0x2e, 0x56, 0x65, 0x63, 0x74,
