...
type SeaLampContributeItemRsp struct {
	...
	AddProgress uint32 `protobuf:"varint,8,opt,name=add_progress,json=addProgress,proto3" json:"add_progress,omitempty"`
	PBLDLEJHKIC uint32 `protobuf:"varint,12,opt,name=PBLDLEJHKIC,proto3" json:"PBLDLEJHKIC,omitempty"`
	Retcode     int32  `protobuf:"varint,7,opt,name=retcode,proto3" json:"retcode,omitempty"`
	LMKMIKOGFMG uint32 `protobuf:"varint,14,opt,name=LMKMIKOGFMG,proto3" json:"LMKMIKOGFMG,omitempty"`
}
...
func (x *SeaLampContributeItemRsp) GetPBLDLEJHKIC() uint32 {
	if x != nil {
		return x.PBLDLEJHKIC
	}
	return 0
}
...
func (x *SeaLampContributeItemRsp) GetLMKMIKOGFMG() uint32 {
	if x != nil {
		return x.LMKMIKOGFMG
	}
	return 0
}
...
var file_SeaLampContributeItemRsp_proto_rawDesc = []byte{
	...
	0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x73, 0x70, 0x12, 0x21, 0x0a,
	0x0c, 0x61, 0x64, 0x64, 0x5f, 0x70, 0x72, 0x6f, 0x67, 0x72, 0x65, 0x73, 0x73, 0x18, 0x08, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x0b, 0x61, 0x64, 0x64, 0x50, 0x72, 0x6f, 0x67, 0x72, 0x65, 0x73, 0x73,
	0x12, 0x20, 0x0a, 0x0b, 0x50, 0x42, 0x4c, 0x44, 0x4c, 0x45, 0x4a, 0x48, 0x4b, 0x49, 0x43, 0x18,
	0x0c, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x50, 0x42, 0x4c, 0x44, 0x4c, 0x45, 0x4a, 0x48, 0x4b,
	...
	0x4c, 0x4d, 0x4b, 0x4d, 0x49, 0x4b, 0x4f, 0x47, 0x46, 0x4d, 0x47, 0x18, 0x0e, 0x20, 0x01, 0x28,
	0x0d, 0x52, 0x0b, 0x4c, 0x4d, 0x4b, 0x4d, 0x49, 0x4b, 0x4f, 0x47, 0x46, 0x4d, 0x47, 0x42, 0x06,
