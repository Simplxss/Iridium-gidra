...
type SeaLampContributeItemRsp struct {
	...
	BIMKNDECJAI uint32 `protobuf:"varint,6,opt,name=BIMKNDECJAI,proto3" json:"BIMKNDECJAI,omitempty"`
	AHINNHBBILH uint32 `protobuf:"varint,12,opt,name=AHINNHBBILH,proto3" json:"AHINNHBBILH,omitempty"`
	AddProgress uint32 `protobuf:"varint,10,opt,name=add_progress,json=addProgress,proto3" json:"add_progress,omitempty"`
}
...
func (x *SeaLampContributeItemRsp) GetBIMKNDECJAI() uint32 {
	if x != nil {
		return x.BIMKNDECJAI
	}
	return 0
}

func (x *SeaLampContributeItemRsp) GetAHINNHBBILH() uint32 {
	if x != nil {
		return x.AHINNHBBILH
	}
	return 0
}
...
var file_SeaLampContributeItemRsp_proto_rawDesc = []byte{
	...
	0x22, 0x9b, 0x01, 0x0a, 0x18, 0x53, 0x65, 0x61, 0x4c, 0x61, 0x6d, 0x70, 0x43, 0x6f, 0x6e, 0x74,
	...
	0x72, 0x65, 0x74, 0x63, 0x6f, 0x64, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x42, 0x49, 0x4d, 0x4b, 0x4e,
	0x44, 0x45, 0x43, 0x4a, 0x41, 0x49, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x42, 0x49,
	0x4d, 0x4b, 0x4e, 0x44, 0x45, 0x43, 0x4a, 0x41, 0x49, 0x12, 0x20, 0x0a, 0x0b, 0x41, 0x48, 0x49,
	0x4e, 0x4e, 0x48, 0x42, 0x42, 0x49, 0x4c, 0x48, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b,
	0x41, 0x48, 0x49, 0x4e, 0x4e, 0x48, 0x42, 0x42, 0x49, 0x4c, 0x48, 0x12, 0x21, 0x0a, 0x0c, 0x61,
	0x64, 0x64, 0x5f, 0x70, 0x72, 0x6f, 0x67, 0x72, 0x65, 0x73, 0x73, 0x18, 0x0a, 0x20, 0x01, 0x28,
	0x0d, 0x52, 0x0b, 0x61, 0x64, 0x64, 0x50, 0x72, 0x6f, 0x67, 0x72, 0x65, 0x73, 0x73, 0x42, 0x06,
...
var file_SeaLampContributeItemRsp_proto_goTypes = []interface{}{
	(*SeaLampContributeItemRsp)(nil), // 0: SeaLampContributeItemRsp
}
