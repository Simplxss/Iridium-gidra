...
type BlessingRecvFriendPicNotify struct {
	...
	PicId uint32 `protobuf:"varint,8,opt,name=pic_id,json=picId,proto3" json:"pic_id,omitempty"`
}
...
var file_BlessingRecvFriendPicNotify_proto_rawDesc = []byte{
	...
	0x66, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x69, 0x64, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x03, 0x75, 0x69, 0x64, 0x12, 0x15, 0x0a, 0x06, 0x70, 0x69, 0x63, 0x5f, 0x69, 0x64, 0x18, 0x08,
...
var file_BlessingRecvFriendPicNotify_proto_goTypes = []interface{}{
	(*BlessingRecvFriendPicNotify)(nil), // 0: BlessingRecvFriendPicNotify
}
