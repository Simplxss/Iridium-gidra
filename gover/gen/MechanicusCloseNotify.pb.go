...
type MechanicusCloseNotify struct {
	...
	MechanicusId uint32 `protobuf:"varint,11,opt,name=mechanicus_id,json=mechanicusId,proto3" json:"mechanicus_id,omitempty"`
}
...
var file_MechanicusCloseNotify_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x75, 0x73, 0x5f, 0x69, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0c, 0x6d,
...
var file_MechanicusCloseNotify_proto_goTypes = []interface{}{
	(*MechanicusCloseNotify)(nil), // 0: MechanicusCloseNotify
}
