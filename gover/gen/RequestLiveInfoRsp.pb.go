...
type RequestLiveInfoRsp struct {
	...
	LiveId      uint32 `protobuf:"varint,8,opt,name=live_id,json=liveId,proto3" json:"live_id,omitempty"`
	PAFOMEAMGAE string `protobuf:"bytes,9,opt,name=PAFOMEAMGAE,proto3" json:"PAFOMEAMGAE,omitempty"`
	Retcode     int32  `protobuf:"varint,15,opt,name=retcode,proto3" json:"retcode,omitempty"`
	BNPEFIPPCML string `protobuf:"bytes,5,opt,name=BNPEFIPPCML,proto3" json:"BNPEFIPPCML,omitempty"`
}
...
func (x *RequestLiveInfoRsp) GetPAFOMEAMGAE() string {
	if x != nil {
		return x.PAFOMEAMGAE
	}
	return ""
}
...
func (x *RequestLiveInfoRsp) GetBNPEFIPPCML() string {
	if x != nil {
		return x.BNPEFIPPCML
	}
	return ""
}
...
var file_RequestLiveInfoRsp_proto_rawDesc = []byte{
	...
	,
...
var file_RequestLiveInfoRsp_proto_goTypes = []interface{}{
	(*RequestLiveInfoRsp)(nil), // 0: RequestLiveInfoRsp
}
