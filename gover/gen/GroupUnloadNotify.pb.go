...
type GroupUnloadNotify struct {
	...
	GroupList []uint32 `protobuf:"varint,11,rep,packed,name=group_list,json=groupList,proto3" json:"group_list,omitempty"`
}
...
var file_GroupUnloadNotify_proto_rawDesc = []byte{
	...
	0x0a, 0x0a, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0b, 0x20, 0x03,
...
var file_GroupUnloadNotify_proto_goTypes = []interface{}{
	(*GroupUnloadNotify)(nil), // 0: GroupUnloadNotify
}
