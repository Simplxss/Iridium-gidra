...
type EntityAiSyncNotify struct {
	...
	LocalAvatarAlertedMonsterList []uint32      `protobuf:"varint,4,rep,packed,name=local_avatar_alerted_monster_list,json=localAvatarAlertedMonsterList,proto3" json:"local_avatar_alerted_monster_list,omitempty"`
	InfoList                      []*AiSyncInfo `protobuf:"bytes,5,rep,name=info_list,json=infoList,proto3" json:"info_list,omitempty"`
}
...
var file_EntityAiSyncNotify_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x72, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x1d,
	...
	0x09, 0x69, 0x6e, 0x66, 0x6f, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b,
...
var file_EntityAiSyncNotify_proto_goTypes = []interface{}{
	(*EntityAiSyncNotify)(nil), // 0: EntityAiSyncNotify
	(*AiSyncInfo)(nil),         // 1: AiSyncInfo
}
var file_EntityAiSyncNotify_proto_depIdxs = []int32{
	1, // 0: EntityAiSyncNotify.info_list:type_name -> AiSyncInfo
