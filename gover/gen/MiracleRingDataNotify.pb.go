...
type MiracleRingDataNotify struct {
	...
	KDGLBECOKBF     uint32 `protobuf:"varint,13,opt,name=KDGLBECOKBF,proto3" json:"KDGLBECOKBF,omitempty"`
	BJHONLLCDPC     uint32 `protobuf:"varint,14,opt,name=BJHONLLCDPC,proto3" json:"BJHONLLCDPC,omitempty"`
	OIPCCHGBDJE     uint32 `protobuf:"varint,12,opt,name=OIPCCHGBDJE,proto3" json:"OIPCCHGBDJE,omitempty"`
	IsGadgetCreated bool   `protobuf:"varint,3,opt,name=is_gadget_created,json=isGadgetCreated,proto3" json:"is_gadget_created,omitempty"`
...
func (x *MiracleRingDataNotify) GetKDGLBECOKBF() uint32 {
	if x != nil {
		return x.KDGLBECOKBF
	}
	return 0
}

func (x *MiracleRingDataNotify) GetBJHONLLCDPC() uint32 {
	if x != nil {
		return x.BJHONLLCDPC
	}
	return 0
}

func (x *MiracleRingDataNotify) GetOIPCCHGBDJE() uint32 {
	if x != nil {
		return x.OIPCCHGBDJE
	}
	return 0
}
...
var file_MiracleRingDataNotify_proto_rawDesc = []byte{
	...
	,
