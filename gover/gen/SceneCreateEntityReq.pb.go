...
type SceneCreateEntityReq struct {
	...
	IsDestroyWhenDisconnect bool              `protobuf:"varint,8,opt,name=is_destroy_when_disconnect,json=isDestroyWhenDisconnect,proto3" json:"is_destroy_when_disconnect,omitempty"`
	Reason                  CreateReason      `protobuf:"varint,11,opt,name=reason,proto3,enum=CreateReason" json:"reason,omitempty"`
}
...
var file_SceneCreateEntityReq_proto_rawDesc = []byte{
	...
	0x71, 0x12, 0x29, 0x0a, 0x06, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28,
	...
	0x64, 0x69, 0x73, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x08,
	...
	0x73, 0x6f, 0x6e, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0d, 0x2e, 0x43, 0x72, 0x65, 0x61,
