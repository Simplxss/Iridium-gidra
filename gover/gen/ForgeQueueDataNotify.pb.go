...
type ForgeQueueDataNotify struct {
	...
	ForgeQueueMap         map[uint32]*ForgeQueueData `protobuf:"bytes,11,rep,name=forge_queue_map,json=forgeQueueMap,proto3" json:"forge_queue_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	RemovedForgeQueueList []uint32                   `protobuf:"varint,13,rep,packed,name=removed_forge_queue_list,json=removedForgeQueueList,proto3" json:"removed_forge_queue_list,omitempty"`
}
...
var file_ForgeQueueDataNotify_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x67, 0x65, 0x5f, 0x71, 0x75, 0x65, 0x75, 0x65, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x0b,
	...
	0x75, 0x65, 0x75, 0x65, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x0d, 0x52,
