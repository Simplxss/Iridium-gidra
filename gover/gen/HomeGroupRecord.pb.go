...
type HomeGroupRecord_RacingGalleryInfo struct {
	RacingGalleryInfo *HomeRacingRecord `protobuf:"bytes,1583,opt,name=racing_gallery_info,json=racingGalleryInfo,proto3,oneof"`
}

type HomeGroupRecord_BalloonGalleryInfo struct {
	BalloonGalleryInfo *HomeBalloonRecord `protobuf:"bytes,1466,opt,name=balloon_gallery_info,json=balloonGalleryInfo,proto3,oneof"`
}

type HomeGroupRecord_StakePlayInfo struct {
	StakePlayInfo *HomeStakeRecord `protobuf:"bytes,1887,opt,name=stake_play_info,json=stakePlayInfo,proto3,oneof"`
}

type HomeGroupRecord_SeekFurnitureGalleryInfo struct {
	SeekFurnitureGalleryInfo *HomeSeekFurnitureAllRecord `protobuf:"bytes,696,opt,name=seek_furniture_gallery_info,json=seekFurnitureGalleryInfo,proto3,oneof"`
}
...
var file_HomeGroupRecord_proto_rawDesc = []byte{
	...
	0x72, 0x79, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0xaf, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11,
	...
	0x6e, 0x5f, 0x67, 0x61, 0x6c, 0x6c, 0x65, 0x72, 0x79, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0xba,
	0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x48, 0x6f, 0x6d, 0x65, 0x42, 0x61, 0x6c, 0x6c,
	...
	0x66, 0x6f, 0x18, 0xdf, 0x0e, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x48, 0x6f, 0x6d, 0x65,
	...
	0x61, 0x6c, 0x6c, 0x65, 0x72, 0x79, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0xb8, 0x05, 0x20, 0x01,
