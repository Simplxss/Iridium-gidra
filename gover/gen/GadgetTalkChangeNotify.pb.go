...
type GadgetTalkChangeNotify struct {
	...
	CurGadgetTalkState uint32 `protobuf:"varint,14,opt,name=cur_gadget_talk_state,json=curGadgetTalkState,proto3" json:"cur_gadget_talk_state,omitempty"`
...
var file_GadgetTalkChangeNotify_proto_rawDesc = []byte{
	...
	0x65, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x12, 0x63, 0x75, 0x72, 0x47, 0x61, 0x64, 0x67,
