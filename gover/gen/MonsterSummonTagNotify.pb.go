...
type MonsterSummonTagNotify struct {
	...
	SummonTagMap    map[uint32]uint32 `protobuf:"bytes,11,rep,name=summon_tag_map,json=summonTagMap,proto3" json:"summon_tag_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	MonsterEntityId uint32            `protobuf:"varint,12,opt,name=monster_entity_id,json=monsterEntityId,proto3" json:"monster_entity_id,omitempty"`
}
...
var file_MonsterSummonTagNotify_proto_rawDesc = []byte{
	...
	0x6d, 0x6f, 0x6e, 0x5f, 0x74, 0x61, 0x67, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x0b, 0x20, 0x03, 0x28,
	...
	0x0c, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0f, 0x6d, 0x6f, 0x6e, 0x73, 0x74, 0x65, 0x72, 0x45, 0x6e,
...
var file_MonsterSummonTagNotify_proto_goTypes = []interface{}{
	(*MonsterSummonTagNotify)(nil), // 0: MonsterSummonTagNotify
	nil,                            // 1: MonsterSummonTagNotify.SummonTagMapEntry
}
var file_MonsterSummonTagNotify_proto_depIdxs = []int32{
	1, // 0: MonsterSummonTagNotify.summon_tag_map:type_name -> MonsterSummonTagNotify.SummonTagMapEntry
