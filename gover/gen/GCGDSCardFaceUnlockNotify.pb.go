...
type GCGDSCardFaceUnlockNotify struct {
	...
	FaceType uint32 `protobuf:"varint,11,opt,name=face_type,json=faceType,proto3" json:"face_type,omitempty"`
...
var file_GCGDSCardFaceUnlockNotify_proto_rawDesc = []byte{
	...
	0x0a, 0x09, 0x66, 0x61, 0x63, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x0b, 0x20, 0x01, 0x28,
