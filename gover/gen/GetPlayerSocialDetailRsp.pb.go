...
type GetPlayerSocialDetailRsp struct {
	...
	DetailData *SocialDetail `protobuf:"bytes,5,opt,name=detail_data,json=detailData,proto3" json:"detail_data,omitempty"`
}
...
var file_GetPlayerSocialDetailRsp_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x69, 0x6c, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32,
