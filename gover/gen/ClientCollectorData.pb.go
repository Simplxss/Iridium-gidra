...
type ClientCollectorData struct {
	...
	KIAPBPEHAEB uint32 `protobuf:"varint,1,opt,name=KIAPBPEHAEB,proto3" json:"KIAPBPEHAEB,omitempty"`
	KCPIPGHNCNM uint32 `protobuf:"varint,11,opt,name=KCPIPGHNCNM,proto3" json:"KCPIPGHNCNM,omitempty"`
}
...
func (x *ClientCollectorData) GetKIAPBPEHAEB() uint32 {
	if x != nil {
		return x.KIAPBPEHAEB
	}
	return 0
}

func (x *ClientCollectorData) GetKCPIPGHNCNM() uint32 {
	if x != nil {
		return x.KCPIPGHNCNM
	}
	return 0
}
...
var file_ClientCollectorData_proto_rawDesc = []byte{
	...
	0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x6d, 0x61, 0x74, 0x65, 0x72, 0x69, 0x61,
	0x6c, 0x49, 0x64, 0x12, 0x20, 0x0a, 0x0b, 0x4b, 0x49, 0x41, 0x50, 0x42, 0x50, 0x45, 0x48, 0x41,
	0x45, 0x42, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x4b, 0x49, 0x41, 0x50, 0x42, 0x50,
	0x45, 0x48, 0x41, 0x45, 0x42, 0x12, 0x20, 0x0a, 0x0b, 0x4b, 0x43, 0x50, 0x49, 0x50, 0x47, 0x48,
	0x4e, 0x43, 0x4e, 0x4d, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x4b, 0x43, 0x50, 0x49,
	0x50, 0x47, 0x48, 0x4e, 0x43, 0x4e, 0x4d, 0x42, 0x06, 0x5a, 0x04, 0x2f, 0x67, 0x65, 0x6e, 0x62,
