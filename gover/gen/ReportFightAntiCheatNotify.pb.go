...
type ReportFightAntiCheatNotify struct {
	...
	EPMDIKMDJIK uint32 `protobuf:"varint,11,opt,name=EPMDIKMDJIK,proto3" json:"EPMDIKMDJIK,omitempty"`
	GOMNCHPHBHB uint32 `protobuf:"varint,14,opt,name=GOMNCHPHBHB,proto3" json:"GOMNCHPHBHB,omitempty"`
}
...
func (x *ReportFightAntiCheatNotify) GetEPMDIKMDJIK() uint32 {
	if x != nil {
		return x.EPMDIKMDJIK
	}
	return 0
}

func (x *ReportFightAntiCheatNotify) GetGOMNCHPHBHB() uint32 {
	if x != nil {
		return x.GOMNCHPHBHB
	}
	return 0
}
...
var file_ReportFightAntiCheatNotify_proto_rawDesc = []byte{
	...
	0x12, 0x20, 0x0a, 0x0b, 0x45, 0x50, 0x4d, 0x44, 0x49, 0x4b, 0x4d, 0x44, 0x4a, 0x49, 0x4b, 0x18,
	0x0b, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x45, 0x50, 0x4d, 0x44, 0x49, 0x4b, 0x4d, 0x44, 0x4a,
	0x49, 0x4b, 0x12, 0x20, 0x0a, 0x0b, 0x47, 0x4f, 0x4d, 0x4e, 0x43, 0x48, 0x50, 0x48, 0x42, 0x48,
	0x42, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x47, 0x4f, 0x4d, 0x4e, 0x43, 0x48, 0x50,
	0x48, 0x42, 0x48, 0x42, 0x42, 0x06, 0x5a, 0x04, 0x2f, 0x67, 0x65, 0x6e, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
