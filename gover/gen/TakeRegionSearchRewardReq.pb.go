...
type TakeRegionSearchRewardReq struct {
	...
	SearchId uint32 `protobuf:"varint,10,opt,name=search_id,json=searchId,proto3" json:"search_id,omitempty"`
}
...
var file_TakeRegionSearchRewardReq_proto_rawDesc = []byte{
	...
	0x0a, 0x02, 0x69, 0x64, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1b,
	0x0a, 0x09, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x5f, 0x69, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28,
...
var file_TakeRegionSearchRewardReq_proto_goTypes = []interface{}{
	(*TakeRegionSearchRewardReq)(nil), // 0: TakeRegionSearchRewardReq
}
