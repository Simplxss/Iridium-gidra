...
type TowerTeam struct {
	...
	TowerTeamId    uint32   `protobuf:"varint,5,opt,name=tower_team_id,json=towerTeamId,proto3" json:"tower_team_id,omitempty"`
...
var file_TowerTeam_proto_rawDesc = []byte{
	...
	0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x74, 0x6f, 0x77, 0x65, 0x72, 0x54, 0x65, 0x61, 0x6d,
