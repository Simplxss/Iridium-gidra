...
type AISnapshotEntitySkillCycle struct {
	...
	OHDGIGLHKPL bool   `protobuf:"varint,8,opt,name=OHDGIGLHKPL,proto3" json:"OHDGIGLHKPL,omitempty"`
	SkillId     uint32 `protobuf:"varint,11,opt,name=skill_id,json=skillId,proto3" json:"skill_id,omitempty"`
	HADJNPKLEOG bool   `protobuf:"varint,14,opt,name=HADJNPKLEOG,proto3" json:"HADJNPKLEOG,omitempty"`
	EEMBPJGDNOI bool   `protobuf:"varint,10,opt,name=EEMBPJGDNOI,proto3" json:"EEMBPJGDNOI,omitempty"`
	DGABAHCOHDC bool   `protobuf:"varint,9,opt,name=DGABAHCOHDC,proto3" json:"DGABAHCOHDC,omitempty"`
}
...
func (x *AISnapshotEntitySkillCycle) GetOHDGIGLHKPL() bool {
	if x != nil {
		return x.OHDGIGLHKPL
	}
	return false
}
...
func (x *AISnapshotEntitySkillCycle) GetHADJNPKLEOG() bool {
	if x != nil {
		return x.HADJNPKLEOG
	}
	return false
}

func (x *AISnapshotEntitySkillCycle) GetEEMBPJGDNOI() bool {
	if x != nil {
		return x.EEMBPJGDNOI
	}
	return false
}

func (x *AISnapshotEntitySkillCycle) GetDGABAHCOHDC() bool {
	if x != nil {
		return x.DGABAHCOHDC
	}
	return false
}
...
var file_AISnapshotEntitySkillCycle_proto_rawDesc = []byte{
	...
	,
}
