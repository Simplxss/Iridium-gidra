...
type AISnapshotEntitySkillCycle struct {
	...
	AOPLIONFLEF bool   `protobuf:"varint,6,opt,name=AOPLIONFLEF,proto3" json:"AOPLIONFLEF,omitempty"`
	SkillId     uint32 `protobuf:"varint,8,opt,name=skill_id,json=skillId,proto3" json:"skill_id,omitempty"`
	KCOIOILFEJG bool   `protobuf:"varint,2,opt,name=KCOIOILFEJG,proto3" json:"KCOIOILFEJG,omitempty"`
	OMHCFDIDJPC bool   `protobuf:"varint,3,opt,name=OMHCFDIDJPC,proto3" json:"OMHCFDIDJPC,omitempty"`
	OIOLEBJAMEH bool   `protobuf:"varint,13,opt,name=OIOLEBJAMEH,proto3" json:"OIOLEBJAMEH,omitempty"`
}
...
func (x *AISnapshotEntitySkillCycle) GetAOPLIONFLEF() bool {
	if x != nil {
		return x.AOPLIONFLEF
	}
	return false
}
...
func (x *AISnapshotEntitySkillCycle) GetKCOIOILFEJG() bool {
	if x != nil {
		return x.KCOIOILFEJG
	}
	return false
}

func (x *AISnapshotEntitySkillCycle) GetOMHCFDIDJPC() bool {
	if x != nil {
		return x.OMHCFDIDJPC
	}
	return false
}

func (x *AISnapshotEntitySkillCycle) GetOIOLEBJAMEH() bool {
	if x != nil {
		return x.OIOLEBJAMEH
	}
	return false
}
...
var file_AISnapshotEntitySkillCycle_proto_rawDesc = []byte{
	...
	,
}
