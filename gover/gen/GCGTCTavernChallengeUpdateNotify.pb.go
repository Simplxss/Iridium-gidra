...
type GCGTCTavernChallengeUpdateNotify struct {
	...
	TavernChallenge *GCGTCTavernChallengeData `protobuf:"bytes,6,opt,name=tavern_challenge,json=tavernChallenge,proto3" json:"tavern_challenge,omitempty"`
}
...
var file_GCGTCTavernChallengeUpdateNotify_proto_rawDesc = []byte{
	...
	0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x47, 0x43, 0x47, 0x54, 0x43, 0x54, 0x61,
