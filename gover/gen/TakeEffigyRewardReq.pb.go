...
type TakeEffigyRewardReq struct {
	...
	RewardIndex uint32 `protobuf:"varint,9,opt,name=reward_index,json=rewardIndex,proto3" json:"reward_index,omitempty"`
}
...
var file_TakeEffigyRewardReq_proto_rawDesc = []byte{
	...
	0x65, 0x78, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x72, 0x65, 0x77, 0x61, 0x72, 0x64,
...
var file_TakeEffigyRewardReq_proto_goTypes = []interface{}{
	(*TakeEffigyRewardReq)(nil), // 0: TakeEffigyRewardReq
}
