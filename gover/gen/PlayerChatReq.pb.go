...
type PlayerChatReq struct {
	...
	ChatInfo  *ChatInfo `protobuf:"bytes,13,opt,name=chat_info,json=chatInfo,proto3" json:"chat_info,omitempty"`
...
var file_PlayerChatReq_proto_rawDesc = []byte{
	...
	0x68, 0x61, 0x74, 0x52, 0x65, 0x71, 0x12, 0x26, 0x0a, 0x09, 0x63, 0x68, 0x61, 0x74, 0x5f, 0x69,
	0x6e, 0x66, 0x6f, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x09, 0x2e, 0x43, 0x68, 0x61, 0x74,
	...
	0x28, 0x0d, 0x52, 0x09, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x49, 0x64, 0x42, 0x06, 0x5a,
...
var file_PlayerChatReq_proto_goTypes = []interface{}{
	(*PlayerChatReq)(nil), // 0: PlayerChatReq
	(*ChatInfo)(nil),      // 1: ChatInfo
}
var file_PlayerChatReq_proto_depIdxs = []int32{
	1, // 0: PlayerChatReq.chat_info:type_name -> ChatInfo
