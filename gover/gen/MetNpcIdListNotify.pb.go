...
type MetNpcIdListNotify struct {
	...
	NpcFirstMetIdList []uint32 `protobuf:"varint,5,rep,packed,name=npc_first_met_id_list,json=npcFirstMetIdList,proto3" json:"npc_first_met_id_list,omitempty"`
}
...
var file_MetNpcIdListNotify_proto_rawDesc = []byte{
	...
	0x74, 0x5f, 0x69, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0d, 0x52,
...
var file_MetNpcIdListNotify_proto_goTypes = []interface{}{
	(*MetNpcIdListNotify)(nil), // 0: MetNpcIdListNotify
}
