...
type HomeStakeRecord struct {
	...
	RecordList []*HomeStakePlayRecord `protobuf:"bytes,6,rep,name=record_list,json=recordList,proto3" json:"record_list,omitempty"`
}
...
var file_HomeStakeRecord_proto_rawDesc = []byte{
	...
	0x6c, 0x69, 0x73, 0x74, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x48, 0x6f, 0x6d,
