...
type AdjustWorldLevelReq struct {
	...
	DPHFLHKHLIF uint32 `protobuf:"varint,2,opt,name=DPHFLHKHLIF,proto3" json:"DPHFLHKHLIF,omitempty"`
	LOCDLJCPGPO uint32 `protobuf:"varint,9,opt,name=LOCDLJCPGPO,proto3" json:"LOCDLJCPGPO,omitempty"`
}
...
func (x *AdjustWorldLevelReq) GetDPHFLHKHLIF() uint32 {
	if x != nil {
		return x.DPHFLHKHLIF
	}
	return 0
}

func (x *AdjustWorldLevelReq) GetLOCDLJCPGPO() uint32 {
	if x != nil {
		return x.LOCDLJCPGPO
	}
	return 0
}
...
var file_AdjustWorldLevelReq_proto_rawDesc = []byte{
	...
	0x65, 0x71, 0x12, 0x20, 0x0a, 0x0b, 0x44, 0x50, 0x48, 0x46, 0x4c, 0x48, 0x4b, 0x48, 0x4c, 0x49,
	0x46, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x44, 0x50, 0x48, 0x46, 0x4c, 0x48, 0x4b,
	0x48, 0x4c, 0x49, 0x46, 0x12, 0x20, 0x0a, 0x0b, 0x4c, 0x4f, 0x43, 0x44, 0x4c, 0x4a, 0x43, 0x50,
	0x47, 0x50, 0x4f, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x4c, 0x4f, 0x43, 0x44, 0x4c,
	0x4a, 0x43, 0x50, 0x47, 0x50, 0x4f, 0x42, 0x06, 0x5a, 0x04, 0x2f, 0x67, 0x65, 0x6e, 0x62, 0x06,
