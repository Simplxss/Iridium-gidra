...
type CylinderRegionSize struct {
	...
	Height float32 `protobuf:"fixed32,13,opt,name=height,proto3" json:"height,omitempty"`
}
...
var file_CylinderRegionSize_proto_rawDesc = []byte{
	...
	0x68, 0x74, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x02, 0x52, 0x06, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74,
