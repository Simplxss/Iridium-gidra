...
type SceneGalleryBalloonInfo struct {
	...
	ScenePlayerBalloonInfoMap map[uint32]*BalloonPlayerInfo `protobuf:"bytes,4,rep,name=scene_player_balloon_info_map,json=scenePlayerBalloonInfoMap,proto3" json:"scene_player_balloon_info_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
var file_SceneGalleryBalloonInfo_proto_rawDesc = []byte{
	...
	0x6f, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x37, 0x2e, 0x53, 0x63,
