...
type SceneGalleryFungusFighterCaptureInfo struct {
	...
	IsHideProgress bool `protobuf:"varint,14,opt,name=is_hide_progress,json=isHideProgress,proto3" json:"is_hide_progress,omitempty"`
}
...
var file_SceneGalleryFungusFighterCaptureInfo_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x67, 0x72, 0x65, 0x73, 0x73, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0e,
