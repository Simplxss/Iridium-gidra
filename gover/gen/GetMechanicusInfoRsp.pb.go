...
type GetMechanicusInfoRsp struct {
	...
	MechanicusInfo *MechanicusInfo `protobuf:"bytes,4,opt,name=mechanicus_info,json=mechanicusInfo,proto3" json:"mechanicus_info,omitempty"`
...
var file_GetMechanicusInfoRsp_proto_rawDesc = []byte{
	...
	0x63, 0x68, 0x61, 0x6e, 0x69, 0x63, 0x75, 0x73, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x04, 0x20,
