...
type EffigyChallengeV2LevelData struct {
	...
	AFLGHGHAOMC uint32 `protobuf:"varint,4,opt,name=AFLGHGHAOMC,proto3" json:"AFLGHGHAOMC,omitempty"`
	...
	DBHOBFBBONG uint32 `protobuf:"varint,9,opt,name=DBHOBFBBONG,proto3" json:"DBHOBFBBONG,omitempty"`
	NIIPDHJEGDE uint32 `protobuf:"varint,7,opt,name=NIIPDHJEGDE,proto3" json:"NIIPDHJEGDE,omitempty"`
	PJIHHFHLOGM uint32 `protobuf:"varint,6,opt,name=PJIHHFHLOGM,proto3" json:"PJIHHFHLOGM,omitempty"`
}
...
func (x *EffigyChallengeV2LevelData) GetAFLGHGHAOMC() uint32 {
	if x != nil {
		return x.AFLGHGHAOMC
	}
	return 0
}
...
func (x *EffigyChallengeV2LevelData) GetDBHOBFBBONG() uint32 {
	if x != nil {
		return x.DBHOBFBBONG
	}
	return 0
}

func (x *EffigyChallengeV2LevelData) GetNIIPDHJEGDE() uint32 {
	if x != nil {
		return x.NIIPDHJEGDE
	}
	return 0
}

func (x *EffigyChallengeV2LevelData) GetPJIHHFHLOGM() uint32 {
	if x != nil {
...
var file_EffigyChallengeV2LevelData_proto_rawDesc = []byte{
	...
	,
