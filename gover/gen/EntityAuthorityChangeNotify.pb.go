...
type EntityAuthorityChangeNotify struct {
	...
	AuthorityChangeList []*AuthorityChange `protobuf:"bytes,13,rep,name=authority_change_list,json=authorityChangeList,proto3" json:"authority_change_list,omitempty"`
}
...
var file_EntityAuthorityChangeNotify_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x41, 0x75, 0x74, 0x68, 0x6f,
