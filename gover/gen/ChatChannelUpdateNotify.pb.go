...
type ChatChannelUpdateNotify struct {
	...
	ChannelInfo *ChatChannelInfo `protobuf:"bytes,9,opt,name=channel_info,json=channelInfo,proto3" json:"channel_info,omitempty"`
...
var file_ChatChannelUpdateNotify_proto_rawDesc = []byte{
	...
	0x6f, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x43, 0x68, 0x61, 0x74, 0x43, 0x68,
