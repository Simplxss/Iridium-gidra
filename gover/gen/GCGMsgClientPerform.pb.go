...
type GCGMsgClientPerform struct {
	...
	PerformType GJHEHICILCG `protobuf:"varint,7,opt,name=perform_type,json=performType,proto3,enum=GJHEHICILCG" json:"perform_type,omitempty"`
...
func (x *GCGMsgClientPerform) GetPerformType() GJHEHICILCG {
	if x != nil {
		return x.PerformType
	}
	return GJHEHICILCG_GJHEHICILCG_GcgPerformInvalid
}
...
var file_GCGMsgClientPerform_proto_rawDesc = []byte{
	...
	0x72, 0x66, 0x6f, 0x72, 0x6d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x11, 0x47, 0x4a, 0x48,
	0x45, 0x48, 0x49, 0x43, 0x49, 0x4c, 0x43, 0x47, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x65,
	...
	0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0c, 0x2e, 0x47, 0x4a,
	0x48, 0x45, 0x48, 0x49, 0x43, 0x49, 0x4c, 0x43, 0x47, 0x52, 0x0b, 0x70, 0x65, 0x72, 0x66, 0x6f,
	0x72, 0x6d, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x5f,
	0x6c, 0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x09, 0x70, 0x61, 0x72, 0x61,
...
var file_GCGMsgClientPerform_proto_goTypes = []interface{}{
	...
	(GJHEHICILCG)(0),            // 1: GJHEHICILCG
}
var file_GCGMsgClientPerform_proto_depIdxs = []int32{
	1, // 0: GCGMsgClientPerform.perform_type:type_name -> GJHEHICILCG
