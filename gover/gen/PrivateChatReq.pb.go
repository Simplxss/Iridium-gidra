...
type PrivateChatReq_Text struct {
	Text string `protobuf:"bytes,12,opt,name=text,proto3,oneof"`
}

type PrivateChatReq_Icon struct {
	Icon uint32 `protobuf:"varint,11,opt,name=icon,proto3,oneof"`
}
...
var file_PrivateChatReq_proto_rawDesc = []byte{
	...
	0x0c, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x04, 0x74, 0x65, 0x78, 0x74, 0x12, 0x14, 0x0a,
	0x04, 0x69, 0x63, 0x6f, 0x6e, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0d, 0x48, 0x00, 0x52, 0x04, 0x69,
