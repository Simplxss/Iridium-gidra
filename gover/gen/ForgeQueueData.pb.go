...
type ForgeQueueData struct {
	...
	POMGMIIKMGK uint32 `protobuf:"varint,13,opt,name=POMGMIIKMGK,proto3" json:"POMGMIIKMGK,omitempty"`
	AvatarId    uint32 `protobuf:"varint,8,opt,name=avatar_id,json=avatarId,proto3" json:"avatar_id,omitempty"`
	FEAIEFCFKJK uint32 `protobuf:"varint,3,opt,name=FEAIEFCFKJK,proto3" json:"FEAIEFCFKJK,omitempty"`
	MNHMIPIKBIH uint32 `protobuf:"varint,14,opt,name=MNHMIPIKBIH,proto3" json:"MNHMIPIKBIH,omitempty"`
	JAJEGBOFAEE uint32 `protobuf:"varint,11,opt,name=JAJEGBOFAEE,proto3" json:"JAJEGBOFAEE,omitempty"`
	DLAMPPPDANO uint32 `protobuf:"varint,4,opt,name=DLAMPPPDANO,proto3" json:"DLAMPPPDANO,omitempty"`
...
func (x *ForgeQueueData) GetPOMGMIIKMGK() uint32 {
	if x != nil {
		return x.POMGMIIKMGK
	}
	return 0
}
...
func (x *ForgeQueueData) GetFEAIEFCFKJK() uint32 {
	if x != nil {
		return x.FEAIEFCFKJK
	}
	return 0
}

func (x *ForgeQueueData) GetMNHMIPIKBIH() uint32 {
	if x != nil {
		return x.MNHMIPIKBIH
	}
	return 0
}

func (x *ForgeQueueData) GetJAJEGBOFAEE() uint32 {
	if x != nil {
		return x.JAJEGBOFAEE
	}
	return 0
}

func (x *ForgeQueueData) GetDLAMPPPDANO() uint32 {
	if x != nil {
		return x.DLAMPPPDANO
	}
	return 0
}
...
var file_ForgeQueueData_proto_rawDesc = []byte{
	...
	,
