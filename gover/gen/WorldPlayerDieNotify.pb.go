...
type WorldPlayerDieNotify struct {
	...
	MurdererEntityId uint32        `protobuf:"varint,9,opt,name=murderer_entity_id,json=murdererEntityId,proto3" json:"murderer_entity_id,omitempty"`
	DieType          PlayerDieType `protobuf:"varint,10,opt,name=die_type,json=dieType,proto3,enum=PlayerDieType" json:"die_type,omitempty"`
...
type WorldPlayerDieNotify_GadgetId struct {
	GadgetId uint32 `protobuf:"varint,5,opt,name=gadget_id,json=gadgetId,proto3,oneof"`
}
...
var file_WorldPlayerDieNotify_proto_rawDesc = []byte{
	...
	0x18, 0x09, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x10, 0x6d, 0x75, 0x72, 0x64, 0x65, 0x72, 0x65, 0x72,
	0x45, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x49, 0x64, 0x12, 0x29, 0x0a, 0x08, 0x64, 0x69, 0x65, 0x5f,
	0x74, 0x79, 0x70, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0e, 0x2e, 0x50, 0x6c, 0x61,
	...
	0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x48, 0x00, 0x52, 0x08, 0x67, 0x61, 0x64, 0x67, 0x65,
