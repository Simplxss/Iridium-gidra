...
type WidgetQuickHitTreeReq struct {
	...
	HitTreeInfoList []*HitTreeInfo `protobuf:"bytes,9,rep,name=hit_tree_info_list,json=hitTreeInfoList,proto3" json:"hit_tree_info_list,omitempty"`
}
...
var file_WidgetQuickHitTreeReq_proto_rawDesc = []byte{
	...
	0x09, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x48, 0x69, 0x74, 0x54, 0x72, 0x65, 0x65, 0x49,
