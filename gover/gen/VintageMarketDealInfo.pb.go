...
type VintageMarketDealInfo struct {
	...
	TraderItemInfoMap map[uint32]*VintageMarketTraderInfo `protobuf:"bytes,7,rep,name=trader_item_info_map,json=traderItemInfoMap,proto3" json:"trader_item_info_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_VintageMarketDealInfo_proto_rawDesc = []byte{
	...
	0x5f, 0x69, 0x74, 0x65, 0x6d, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x07,
