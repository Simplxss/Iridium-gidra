...
type RoguelikeRuneRecord struct {
	...
	AMDENNHDBNO uint32 `protobuf:"varint,7,opt,name=AMDENNHDBNO,proto3" json:"AMDENNHDBNO,omitempty"`
	RuneId      uint32 `protobuf:"varint,9,opt,name=rune_id,json=runeId,proto3" json:"rune_id,omitempty"`
	FCDJENECOPL uint32 `protobuf:"varint,4,opt,name=FCDJENECOPL,proto3" json:"FCDJENECOPL,omitempty"`
}
...
func (x *RoguelikeRuneRecord) GetAMDENNHDBNO() uint32 {
	if x != nil {
		return x.AMDENNHDBNO
	}
	return 0
}
...
func (x *RoguelikeRuneRecord) GetFCDJENECOPL() uint32 {
	if x != nil {
		return x.FCDJENECOPL
	}
	return 0
}
...
var file_RoguelikeRuneRecord_proto_rawDesc = []byte{
	...
	0x72, 0x64, 0x12, 0x20, 0x0a, 0x0b, 0x41, 0x4d, 0x44, 0x45, 0x4e, 0x4e, 0x48, 0x44, 0x42, 0x4e,
	0x4f, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x41, 0x4d, 0x44, 0x45, 0x4e, 0x4e, 0x48,
	0x44, 0x42, 0x4e, 0x4f, 0x12, 0x17, 0x0a, 0x07, 0x72, 0x75, 0x6e, 0x65, 0x5f, 0x69, 0x64, 0x18,
	0x09, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x72, 0x75, 0x6e, 0x65, 0x49, 0x64, 0x12, 0x20, 0x0a,
	0x0b, 0x46, 0x43, 0x44, 0x4a, 0x45, 0x4e, 0x45, 0x43, 0x4f, 0x50, 0x4c, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x0b, 0x46, 0x43, 0x44, 0x4a, 0x45, 0x4e, 0x45, 0x43, 0x4f, 0x50, 0x4c, 0x42,
