...
type AvatarChangeAnimHashReq struct {
	...
	AnimHash   uint32 `protobuf:"varint,8,opt,name=anim_hash,json=animHash,proto3" json:"anim_hash,omitempty"`
...
var file_AvatarChangeAnimHashReq_proto_rawDesc = []byte{
	...
	0x69, 0x6d, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x61,
