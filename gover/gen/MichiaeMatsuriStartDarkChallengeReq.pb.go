...
type MichiaeMatsuriStartDarkChallengeReq struct {
	...
	WorktopEntityId uint32 `protobuf:"varint,9,opt,name=worktop_entity_id,json=worktopEntityId,proto3" json:"worktop_entity_id,omitempty"`
}
...
var file_MichiaeMatsuriStartDarkChallengeReq_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x74, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0f, 0x77,
