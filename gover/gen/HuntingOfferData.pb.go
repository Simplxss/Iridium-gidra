...
type HuntingOfferData struct {
	...
	State       HuntingOfferState `protobuf:"varint,11,opt,name=state,proto3,enum=HuntingOfferState" json:"state,omitempty"`
...
var file_HuntingOfferData_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x11, 0x48, 0x75, 0x6e, 0x74, 0x69, 0x6e,
	0x67, 0x50, 0x61, 0x69, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x17, 0x48, 0x75, 0x6e,
	0x74, 0x69, 0x6e, 0x67, 0x4f, 0x66, 0x66, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x65, 0x2e, 0x70,
	...
	0x74, 0x69, 0x6e, 0x67, 0x5f, 0x70, 0x61, 0x69, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x61, 0x74, 0x65, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x12, 0x2e, 0x48, 0x75, 0x6e, 0x74,
	...
	0x0f, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x63, 0x69, 0x74, 0x79, 0x49, 0x64, 0x42, 0x06, 0x5a,
...
var file_HuntingOfferData_proto_goTypes = []interface{}{
	(*HuntingOfferData)(nil), // 0: HuntingOfferData
	(*HuntingPair)(nil),      // 1: HuntingPair
	(HuntingOfferState)(0),   // 2: HuntingOfferState
}
var file_HuntingOfferData_proto_depIdxs = []int32{
	1, // 0: HuntingOfferData.hunting_pair:type_name -> HuntingPair
	2, // 1: HuntingOfferData.state:type_name -> HuntingOfferState
