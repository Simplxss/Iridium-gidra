...
type ReportTrackingIOInfoNotify struct {
	...
	ADHIHLMGAAA string `protobuf:"bytes,1,opt,name=ADHIHLMGAAA,proto3" json:"ADHIHLMGAAA,omitempty"`
	BEBOGAEBAGG string `protobuf:"bytes,15,opt,name=BEBOGAEBAGG,proto3" json:"BEBOGAEBAGG,omitempty"`
	OAKADAODLLM string `protobuf:"bytes,14,opt,name=OAKADAODLLM,proto3" json:"OAKADAODLLM,omitempty"`
	PHKLBMJLABP string `protobuf:"bytes,6,opt,name=PHKLBMJLABP,proto3" json:"PHKLBMJLABP,omitempty"`
	BBMJLHFKKDB string `protobuf:"bytes,9,opt,name=BBMJLHFKKDB,proto3" json:"BBMJLHFKKDB,omitempty"`
}
...
func (x *ReportTrackingIOInfoNotify) GetADHIHLMGAAA() string {
	if x != nil {
...
func (x *ReportTrackingIOInfoNotify) GetBEBOGAEBAGG() string {
	if x != nil {
...
func (x *ReportTrackingIOInfoNotify) GetOAKADAODLLM() string {
	if x != nil {
...
func (x *ReportTrackingIOInfoNotify) GetPHKLBMJLABP() string {
	if x != nil {
...
func (x *ReportTrackingIOInfoNotify) GetBBMJLHFKKDB() string {
	if x != nil {
...
var file_ReportTrackingIOInfoNotify_proto_rawDesc = []byte{
	...
	,
