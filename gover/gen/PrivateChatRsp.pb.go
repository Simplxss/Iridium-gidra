...
type PrivateChatRsp struct {
	...
	ChatForbiddenEndtime uint32 `protobuf:"varint,5,opt,name=chat_forbidden_endtime,json=chatForbiddenEndtime,proto3" json:"chat_forbidden_endtime,omitempty"`
}
...
var file_PrivateChatRsp_proto_rawDesc = []byte{
	...
	0x64, 0x64, 0x65, 0x6e, 0x5f, 0x65, 0x6e, 0x64, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x05, 0x20, 0x01,
...
var file_PrivateChatRsp_proto_goTypes = []interface{}{
	(*PrivateChatRsp)(nil), // 0: PrivateChatRsp
}
