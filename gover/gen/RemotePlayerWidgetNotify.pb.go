...
type RemotePlayerWidgetNotify struct {
	...
	PlayerWidgetInfoList []*PlayerWidgetInfo `protobuf:"bytes,2,rep,name=player_widget_info_list,json=playerWidgetInfoList,proto3" json:"player_widget_info_list,omitempty"`
}
...
var file_RemotePlayerWidgetNotify_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x57, 0x69,
