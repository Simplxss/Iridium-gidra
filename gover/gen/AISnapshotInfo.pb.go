...
type AISnapshotInfo struct {
	...
	AiSnapshots []*AISnapshotEntityData `protobuf:"bytes,15,rep,name=ai_snapshots,json=aiSnapshots,proto3" json:"ai_snapshots,omitempty"`
}
...
var file_AISnapshotInfo_proto_rawDesc = []byte{
	...
	0x68, 0x6f, 0x74, 0x73, 0x18, 0x0f, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x41, 0x49, 0x53,
