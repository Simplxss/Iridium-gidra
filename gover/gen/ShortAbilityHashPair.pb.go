...
type ShortAbilityHashPair struct {
	...
	AbilityNameHash   int32 `protobuf:"fixed32,11,opt,name=ability_name_hash,json=abilityNameHash,proto3" json:"ability_name_hash,omitempty"`
	AbilityConfigHash int32 `protobuf:"fixed32,14,opt,name=ability_config_hash,json=abilityConfigHash,proto3" json:"ability_config_hash,omitempty"`
}
...
var file_ShortAbilityHashPair_proto_rawDesc = []byte{
	...
	0x6e, 0x61, 0x6d, 0x65, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0f, 0x52,
	...
	0x69, 0x67, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0f, 0x52, 0x11, 0x61,
