...
type DelBackupAvatarTeamReq struct {
	...
	BackupAvatarTeamId uint32 `protobuf:"varint,12,opt,name=backup_avatar_team_id,json=backupAvatarTeamId,proto3" json:"backup_avatar_team_id,omitempty"`
}
...
var file_DelBackupAvatarTeamReq_proto_rawDesc = []byte{
	...
	0x64, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x12, 0x62, 0x61, 0x63, 0x6b, 0x75, 0x70, 0x41,
