...
type WindSeedClientNotify_RefreshNotify_ struct {
	RefreshNotify *WindSeedClientNotify_RefreshNotify `protobuf:"bytes,2,opt,name=refresh_notify,json=refreshNotify,proto3,oneof"`
}

type WindSeedClientNotify_AddWindBulletNotify_ struct {
	AddWindBulletNotify *WindSeedClientNotify_AddWindBulletNotify `protobuf:"bytes,11,opt,name=add_wind_bullet_notify,json=addWindBulletNotify,proto3,oneof"`
}

type WindSeedClientNotify_AreaNotify_ struct {
	AreaNotify *WindSeedClientNotify_AreaNotify `protobuf:"bytes,14,opt,name=area_notify,json=areaNotify,proto3,oneof"`
}
...
type WindSeedClientNotify_AddWindBulletNotify struct {
	...
	SeedPos     *Vector `protobuf:"bytes,8,opt,name=seed_pos,json=seedPos,proto3" json:"seed_pos,omitempty"`
	AACKLENGCOO uint32  `protobuf:"varint,5,opt,name=AACKLENGCOO,proto3" json:"AACKLENGCOO,omitempty"`
	AAJBMHIIPBP uint32  `protobuf:"varint,9,opt,name=AAJBMHIIPBP,proto3" json:"AAJBMHIIPBP,omitempty"`
}
...
func (x *WindSeedClientNotify_AddWindBulletNotify) GetAACKLENGCOO() uint32 {
	if x != nil {
		return x.AACKLENGCOO
	}
	return 0
}

func (x *WindSeedClientNotify_AddWindBulletNotify) GetAAJBMHIIPBP() uint32 {
	if x != nil {
		return x.AAJBMHIIPBP
	}
	return 0
}
...
type WindSeedClientNotify_AreaNotify struct {
	...
	AreaType uint32 `protobuf:"varint,6,opt,name=area_type,json=areaType,proto3" json:"area_type,omitempty"`
...
var file_WindSeedClientNotify_proto_rawDesc = []byte{
	...
	0x63, 0x74, 0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa7, 0x04, 0x0a, 0x14, 0x57,
	...
	0x6f, 0x74, 0x69, 0x66, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x57, 0x69,
	...
	0x6c, 0x6c, 0x65, 0x74, 0x5f, 0x6e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x18, 0x0b, 0x20, 0x01, 0x28,
	...
	0x66, 0x79, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x57, 0x69, 0x6e, 0x64, 0x53,
	...
	,
}
