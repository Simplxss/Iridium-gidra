...
type SceneWeatherForcastReq struct {
	...
	WeatherAreaId uint32 `protobuf:"varint,5,opt,name=weather_area_id,json=weatherAreaId,proto3" json:"weather_area_id,omitempty"`
}
...
var file_SceneWeatherForcastReq_proto_rawDesc = []byte{
	...
	0x68, 0x65, 0x72, 0x5f, 0x61, 0x72, 0x65, 0x61, 0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28,
