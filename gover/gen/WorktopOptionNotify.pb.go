...
type WorktopOptionNotify struct {
	...
	OptionList     []uint32 `protobuf:"varint,7,rep,packed,name=option_list,json=optionList,proto3" json:"option_list,omitempty"`
...
var file_WorktopOptionNotify_proto_rawDesc = []byte{
	...
	0x74, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0a, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x4c,
...
var file_WorktopOptionNotify_proto_goTypes = []interface{}{
	(*WorktopOptionNotify)(nil), // 0: WorktopOptionNotify
}
