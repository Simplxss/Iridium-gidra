...
type SetCodexPushtipsReadRsp struct {
	...
	GMMHIHAOJIM uint32 `protobuf:"varint,11,opt,name=GMMHIHAOJIM,proto3" json:"GMMHIHAOJIM,omitempty"`
	Retcode     int32  `protobuf:"varint,3,opt,name=retcode,proto3" json:"retcode,omitempty"`
	HFJNAAGCKFJ uint32 `protobuf:"varint,1,opt,name=HFJNAAGCKFJ,proto3" json:"HFJNAAGCKFJ,omitempty"`
}
...
func (x *SetCodexPushtipsReadRsp) GetGMMHIHAOJIM() uint32 {
	if x != nil {
		return x.GMMHIHAOJIM
	}
	return 0
}
...
func (x *SetCodexPushtipsReadRsp) GetHFJNAAGCKFJ() uint32 {
	if x != nil {
		return x.HFJNAAGCKFJ
	}
	return 0
}
...
var file_SetCodexPushtipsReadRsp_proto_rawDesc = []byte{
	...
	,
