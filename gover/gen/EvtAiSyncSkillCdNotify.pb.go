...
type EvtAiSyncSkillCdNotify struct {
	...
	AiCdMap map[uint32]*AiSkillCdInfo `protobuf:"bytes,6,rep,name=ai_cd_map,json=aiCdMap,proto3" json:"ai_cd_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_EvtAiSyncSkillCdNotify_proto_rawDesc = []byte{
	...
	0x0a, 0x09, 0x61, 0x69, 0x5f, 0x63, 0x64, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x06, 0x20, 0x03, 0x28,
