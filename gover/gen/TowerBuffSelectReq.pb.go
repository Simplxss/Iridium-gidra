...
type TowerBuffSelectReq struct {
	...
	TowerBuffId uint32 `protobuf:"varint,14,opt,name=tower_buff_id,json=towerBuffId,proto3" json:"tower_buff_id,omitempty"`
}
...
var file_TowerBuffSelectReq_proto_rawDesc = []byte{
	...
	0x64, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x74, 0x6f, 0x77, 0x65, 0x72, 0x42, 0x75,
...
var file_TowerBuffSelectReq_proto_goTypes = []interface{}{
	(*TowerBuffSelectReq)(nil), // 0: TowerBuffSelectReq
}
