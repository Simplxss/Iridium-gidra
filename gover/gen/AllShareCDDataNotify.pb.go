...
type AllShareCDDataNotify struct {
	...
	ShareCdInfoMap map[uint32]*ShareCDInfo `protobuf:"bytes,11,rep,name=share_cd_info_map,json=shareCdInfoMap,proto3" json:"share_cd_info_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_AllShareCDDataNotify_proto_rawDesc = []byte{
	...
	0x65, 0x5f, 0x63, 0x64, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x0b, 0x20,
