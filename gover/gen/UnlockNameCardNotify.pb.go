...
type UnlockNameCardNotify struct {
	...
	NameCardId uint32 `protobuf:"varint,2,opt,name=name_card_id,json=nameCardId,proto3" json:"name_card_id,omitempty"`
}
...
var file_UnlockNameCardNotify_proto_rawDesc = []byte{
	...
	0x64, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x6e, 0x61, 0x6d, 0x65,
...
var file_UnlockNameCardNotify_proto_goTypes = []interface{}{
	(*UnlockNameCardNotify)(nil), // 0: UnlockNameCardNotify
}
