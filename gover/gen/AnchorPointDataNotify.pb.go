...
type AnchorPointDataNotify struct {
	...
	AnchorPointList []*AnchorPointData `protobuf:"bytes,2,rep,name=anchor_point_list,json=anchorPointList,proto3" json:"anchor_point_list,omitempty"`
	NextUsableTime  uint32             `protobuf:"varint,7,opt,name=next_usable_time,json=nextUsableTime,proto3" json:"next_usable_time,omitempty"`
}
...
var file_AnchorPointDataNotify_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x41, 0x6e, 0x63, 0x68, 0x6f,
	...
	0x07, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0e, 0x6e, 0x65, 0x78, 0x74, 0x55, 0x73, 0x61, 0x62, 0x6c,
