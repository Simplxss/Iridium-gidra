...
type UpdateReunionWatcherNotify struct {
	...
	WatcherInfo *ReunionWatcherInfo `protobuf:"bytes,9,opt,name=watcher_info,json=watcherInfo,proto3" json:"watcher_info,omitempty"`
...
var file_UpdateReunionWatcherNotify_proto_rawDesc = []byte{
	...
	0x74, 0x63, 0x68, 0x65, 0x72, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b,
