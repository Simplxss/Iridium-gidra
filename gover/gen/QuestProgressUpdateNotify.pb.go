...
type QuestProgressUpdateNotify struct {
	...
	FinishProgressList []uint32 `protobuf:"varint,1,rep,packed,name=finish_progress_list,json=finishProgressList,proto3" json:"finish_progress_list,omitempty"`
	FailProgressList   []uint32 `protobuf:"varint,5,rep,packed,name=fail_progress_list,json=failProgressList,proto3" json:"fail_progress_list,omitempty"`
}
...
var file_QuestProgressUpdateNotify_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x12, 0x66, 0x69, 0x6e, 0x69, 0x73, 0x68,
	...
	0x73, 0x74, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x10, 0x66, 0x61, 0x69, 0x6c, 0x50, 0x72,
...
var file_QuestProgressUpdateNotify_proto_goTypes = []interface{}{
	(*QuestProgressUpdateNotify)(nil), // 0: QuestProgressUpdateNotify
}
