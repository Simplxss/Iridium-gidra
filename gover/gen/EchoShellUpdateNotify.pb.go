...
type EchoShellUpdateNotify struct {
	...
	ShellId uint32 `protobuf:"varint,4,opt,name=shell_id,json=shellId,proto3" json:"shell_id,omitempty"`
}
...
var file_EchoShellUpdateNotify_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x73, 0x68, 0x65, 0x6c, 0x6c, 0x49,
