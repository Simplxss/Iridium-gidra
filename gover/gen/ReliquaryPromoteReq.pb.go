...
type ReliquaryPromoteReq struct {
	...
	ItemGuid   uint64 `protobuf:"varint,12,opt,name=item_guid,json=itemGuid,proto3" json:"item_guid,omitempty"`
	TargetGuid uint64 `protobuf:"varint,5,opt,name=target_guid,json=targetGuid,proto3" json:"target_guid,omitempty"`
}
...
var file_ReliquaryPromoteReq_proto_rawDesc = []byte{
	...
	0x0c, 0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x69, 0x74, 0x65, 0x6d, 0x47, 0x75, 0x69, 0x64, 0x12,
	0x1f, 0x0a, 0x0b, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x5f, 0x67, 0x75, 0x69, 0x64, 0x18, 0x05,
...
var file_ReliquaryPromoteReq_proto_goTypes = []interface{}{
	(*ReliquaryPromoteReq)(nil), // 0: ReliquaryPromoteReq
}
