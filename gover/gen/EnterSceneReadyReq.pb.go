...
type EnterSceneReadyReq struct {
	...
	EnterSceneToken uint32 `protobuf:"varint,14,opt,name=enter_scene_token,json=enterSceneToken,proto3" json:"enter_scene_token,omitempty"`
}
...
var file_EnterSceneReadyReq_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0f, 0x65, 0x6e, 0x74,
...
var file_EnterSceneReadyReq_proto_goTypes = []interface{}{
	(*EnterSceneReadyReq)(nil), // 0: EnterSceneReadyReq
}
