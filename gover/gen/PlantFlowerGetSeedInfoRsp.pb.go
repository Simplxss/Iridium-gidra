...
type PlantFlowerGetSeedInfoRsp struct {
	...
	SeedRewardId uint32 `protobuf:"varint,10,opt,name=seed_reward_id,json=seedRewardId,proto3" json:"seed_reward_id,omitempty"`
...
var file_PlantFlowerGetSeedInfoRsp_proto_rawDesc = []byte{
	...
	0x5f, 0x72, 0x65, 0x77, 0x61, 0x72, 0x64, 0x5f, 0x69, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0d,
