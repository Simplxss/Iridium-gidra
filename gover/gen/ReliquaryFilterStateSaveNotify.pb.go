...
type ReliquaryFilterStateSaveNotify struct {
	...
	ReliquaryFilterStateMap map[uint32]uint32 `protobuf:"bytes,14,rep,name=reliquary_filter_state_map,json=reliquaryFilterStateMap,proto3" json:"reliquary_filter_state_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
var file_ReliquaryFilterStateSaveNotify_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x65, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x0e, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x3c, 0x2e,
