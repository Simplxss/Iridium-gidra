...
type ClearRoguelikeCurseNotify struct {
	...
	ClearCurseMap map[uint32]uint32 `protobuf:"bytes,7,rep,name=clear_curse_map,json=clearCurseMap,proto3" json:"clear_curse_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	JDHDCMALHJM   bool              `protobuf:"varint,14,opt,name=JDHDCMALHJM,proto3" json:"JDHDCMALHJM,omitempty"`
	CardId        uint32            `protobuf:"varint,3,opt,name=card_id,json=cardId,proto3" json:"card_id,omitempty"`
	IsClearAll    bool              `protobuf:"varint,9,opt,name=is_clear_all,json=isClearAll,proto3" json:"is_clear_all,omitempty"`
}
...
func (x *ClearRoguelikeCurseNotify) GetJDHDCMALHJM() bool {
	if x != nil {
		return x.JDHDCMALHJM
	}
	return false
}
...
var file_ClearRoguelikeCurseNotify_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x91, 0x02, 0x0a, 0x19, 0x43, 0x6c, 0x65, 0x61, 0x72, 0x52, 0x6f, 0x67, 0x75, 0x65,
	...
	0x61, 0x70, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2d, 0x2e, 0x43, 0x6c, 0x65, 0x61, 0x72,
	...
	0x72, 0x73, 0x65, 0x4d, 0x61, 0x70, 0x12, 0x20, 0x0a, 0x0b, 0x4a, 0x44, 0x48, 0x44, 0x43, 0x4d,
	0x41, 0x4c, 0x48, 0x4a, 0x4d, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x4a, 0x44, 0x48,
	0x44, 0x43, 0x4d, 0x41, 0x4c, 0x48, 0x4a, 0x4d, 0x12, 0x17, 0x0a, 0x07, 0x63, 0x61, 0x72, 0x64,
	0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x63, 0x61, 0x72, 0x64, 0x49,
	0x64, 0x12, 0x20, 0x0a, 0x0c, 0x69, 0x73, 0x5f, 0x63, 0x6c, 0x65, 0x61, 0x72, 0x5f, 0x61, 0x6c,
	0x6c, 0x18, 0x09, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x69, 0x73, 0x43, 0x6c, 0x65, 0x61, 0x72,
	0x41, 0x6c, 0x6c, 0x1a, 0x40, 0x0a, 0x12, 0x43, 0x6c, 0x65, 0x61, 0x72, 0x43, 0x75, 0x72, 0x73,
