...
type EntityMoveRoomNotify struct {
	...
	DestRoomId uint32 `protobuf:"varint,8,opt,name=dest_room_id,json=destRoomId,proto3" json:"dest_room_id,omitempty"`
...
var file_EntityMoveRoomNotify_proto_rawDesc = []byte{
	...
	0x6d, 0x5f, 0x69, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x64, 0x65, 0x73, 0x74,
