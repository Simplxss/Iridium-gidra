...
type ServerAnnounceRevokeNotify struct {
	...
	ConfigIdList []uint32 `protobuf:"varint,5,rep,packed,name=config_id_list,json=configIdList,proto3" json:"config_id_list,omitempty"`
}
...
var file_ServerAnnounceRevokeNotify_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0c, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67,
