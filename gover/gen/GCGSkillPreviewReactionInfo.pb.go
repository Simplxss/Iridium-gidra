...
type GCGSkillPreviewReactionInfo struct {
	...
	IKBOBKNGGIH uint32 `protobuf:"varint,14,opt,name=IKBOBKNGGIH,proto3" json:"IKBOBKNGGIH,omitempty"`
	AGNBFAGMNIO uint32 `protobuf:"varint,4,opt,name=AGNBFAGMNIO,proto3" json:"AGNBFAGMNIO,omitempty"`
}
...
func (x *GCGSkillPreviewReactionInfo) GetIKBOBKNGGIH() uint32 {
	if x != nil {
		return x.IKBOBKNGGIH
	}
	return 0
}

func (x *GCGSkillPreviewReactionInfo) GetAGNBFAGMNIO() uint32 {
	if x != nil {
		return x.AGNBFAGMNIO
	}
	return 0
}
...
var file_GCGSkillPreviewReactionInfo_proto_rawDesc = []byte{
	...
	0x66, 0x6f, 0x12, 0x20, 0x0a, 0x0b, 0x49, 0x4b, 0x42, 0x4f, 0x42, 0x4b, 0x4e, 0x47, 0x47, 0x49,
	0x48, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x49, 0x4b, 0x42, 0x4f, 0x42, 0x4b, 0x4e,
	0x47, 0x47, 0x49, 0x48, 0x12, 0x20, 0x0a, 0x0b, 0x41, 0x47, 0x4e, 0x42, 0x46, 0x41, 0x47, 0x4d,
	0x4e, 0x49, 0x4f, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x41, 0x47, 0x4e, 0x42, 0x46,
	0x41, 0x47, 0x4d, 0x4e, 0x49, 0x4f, 0x42, 0x06, 0x5a, 0x04, 0x2f, 0x67, 0x65, 0x6e, 0x62, 0x06,
