...
type GadgetGeneralRewardInfoNotify struct {
	...
	GeneralRewardInfo *GadgetGeneralRewardInfo `protobuf:"bytes,1,opt,name=general_reward_info,json=generalRewardInfo,proto3" json:"general_reward_info,omitempty"`
}
