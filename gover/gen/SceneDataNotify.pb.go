...
type SceneDataNotify struct {
	...
	LevelConfigNameList []string `protobuf:"bytes,4,rep,name=level_config_name_list,json=levelConfigNameList,proto3" json:"level_config_name_list,omitempty"`
}
...
var file_SceneDataNotify_proto_rawDesc = []byte{
	...
	0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x13, 0x6c, 0x65, 0x76, 0x65, 0x6c, 0x43, 0x6f, 0x6e, 0x66,
