...
type PullPrivateChatReq struct {
	...
	FromSequence uint32 `protobuf:"varint,8,opt,name=from_sequence,json=fromSequence,proto3" json:"from_sequence,omitempty"`
...
var file_PullPrivateChatReq_proto_rawDesc = []byte{
	...
	0x18, 0x08, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0c, 0x66, 0x72, 0x6f, 0x6d, 0x53, 0x65, 0x71, 0x75,
