...
type MoonfinTrialActivityDetailInfo struct {
	...
	SpecialFishCount uint32                            `protobuf:"varint,6,opt,name=special_fish_count,json=specialFishCount,proto3" json:"special_fish_count,omitempty"`
	LevelInfoMap     map[uint32]*MoonfinTrialLevelInfo `protobuf:"bytes,3,rep,name=level_info_map,json=levelInfoMap,proto3" json:"level_info_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_MoonfinTrialActivityDetailInfo_proto_rawDesc = []byte{
	...
	0x6c, 0x5f, 0x66, 0x69, 0x73, 0x68, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x06, 0x20, 0x01,
	...
	0x66, 0x6f, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x31, 0x2e, 0x4d,
