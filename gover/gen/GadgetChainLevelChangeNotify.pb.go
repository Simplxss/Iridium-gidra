...
type GadgetChainLevelChangeNotify struct {
	...
	GadgetChainLevelMap map[uint32]uint32 `protobuf:"bytes,8,rep,name=gadget_chain_level_map,json=gadgetChainLevelMap,proto3" json:"gadget_chain_level_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
var file_GadgetChainLevelChangeNotify_proto_rawDesc = []byte{
	...
	0x08, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x36, 0x2e, 0x47, 0x61, 0x64, 0x67, 0x65, 0x74, 0x43, 0x68,
