...
type BreakoutSyncSnapShot struct {
	...
	SnapShot *BreakoutSnapShot `protobuf:"bytes,13,opt,name=snap_shot,json=snapShot,proto3" json:"snap_shot,omitempty"`
}
...
var file_BreakoutSyncSnapShot_proto_rawDesc = []byte{
	...
	0x73, 0x6e, 0x61, 0x70, 0x5f, 0x73, 0x68, 0x6f, 0x74, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32,
