...
type SceneInitFinishRsp struct {
	...
	EnterSceneToken uint32 `protobuf:"varint,13,opt,name=enter_scene_token,json=enterSceneToken,proto3" json:"enter_scene_token,omitempty"`
}
...
var file_SceneInitFinishRsp_proto_rawDesc = []byte{
	...
	0x0d, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0f, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x53, 0x63, 0x65, 0x6e,
...
var file_SceneInitFinishRsp_proto_goTypes = []interface{}{
	(*SceneInitFinishRsp)(nil), // 0: SceneInitFinishRsp
}
