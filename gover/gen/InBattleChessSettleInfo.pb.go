...
type InBattleChessSettleInfo struct {
	...
	APEDJKIDLPC uint32                   `protobuf:"varint,12,opt,name=APEDJKIDLPC,proto3" json:"APEDJKIDLPC,omitempty"`
	SceneTimeMs uint64                   `protobuf:"varint,6,opt,name=scene_time_ms,json=sceneTimeMs,proto3" json:"scene_time_ms,omitempty"`
	ScoreList   []*ExhibitionDisplayInfo `protobuf:"bytes,14,rep,name=score_list,json=scoreList,proto3" json:"score_list,omitempty"`
	FGMOMMCFHLH uint32                   `protobuf:"varint,10,opt,name=FGMOMMCFHLH,proto3" json:"FGMOMMCFHLH,omitempty"`
	CKOGGPOAAKH uint32                   `protobuf:"varint,9,opt,name=CKOGGPOAAKH,proto3" json:"CKOGGPOAAKH,omitempty"`
	IsSuccess   bool                     `protobuf:"varint,11,opt,name=is_success,json=isSuccess,proto3" json:"is_success,omitempty"`
	PPKIBJMPFJG uint32                   `protobuf:"varint,15,opt,name=PPKIBJMPFJG,proto3" json:"PPKIBJMPFJG,omitempty"`
}
...
func (x *InBattleChessSettleInfo) GetAPEDJKIDLPC() uint32 {
	if x != nil {
		return x.APEDJKIDLPC
	}
	return 0
}
...
func (x *InBattleChessSettleInfo) GetFGMOMMCFHLH() uint32 {
	if x != nil {
		return x.FGMOMMCFHLH
	}
	return 0
}

func (x *InBattleChessSettleInfo) GetCKOGGPOAAKH() uint32 {
	if x != nil {
		return x.CKOGGPOAAKH
	}
	return 0
}
...
func (x *InBattleChessSettleInfo) GetPPKIBJMPFJG() uint32 {
	if x != nil {
		return x.PPKIBJMPFJG
	}
	return 0
}
...
var file_InBattleChessSettleInfo_proto_rawDesc = []byte{
	...
	0x74, 0x74, 0x6c, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x20, 0x0a, 0x0b, 0x41, 0x50, 0x45, 0x44,
	0x4a, 0x4b, 0x49, 0x44, 0x4c, 0x50, 0x43, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x41,
	0x50, 0x45, 0x44, 0x4a, 0x4b, 0x49, 0x44, 0x4c, 0x50, 0x43, 0x12, 0x22, 0x0a, 0x0d, 0x73, 0x63,
	0x65, 0x6e, 0x65, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x6d, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28,
	0x04, 0x52, 0x0b, 0x73, 0x63, 0x65, 0x6e, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x4d, 0x73, 0x12, 0x35,
	0x0a, 0x0a, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0e, 0x20, 0x03,
	...
	,
