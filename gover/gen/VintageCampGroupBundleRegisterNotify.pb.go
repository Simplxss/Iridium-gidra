...
type VintageCampGroupBundleRegisterNotify struct {
	...
	GroupBundleId uint32 `protobuf:"varint,13,opt,name=group_bundle_id,json=groupBundleId,proto3" json:"group_bundle_id,omitempty"`
}
...
var file_VintageCampGroupBundleRegisterNotify_proto_rawDesc = []byte{
	...
	0x6e, 0x64, 0x6c, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0d, 0x67,
