...
type IrodoriChessEntranceDetailInfo struct {
	...
	InfoList []*IrodoriChessEntranceInfo `protobuf:"bytes,5,rep,name=info_list,json=infoList,proto3" json:"info_list,omitempty"`
}
...
var file_IrodoriChessEntranceDetailInfo_proto_rawDesc = []byte{
	...
	0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x49, 0x72,
