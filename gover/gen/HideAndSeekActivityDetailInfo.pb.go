...
type HideAndSeekActivityDetailInfo struct {
	...
	JPONAAHBGID     []uint32              `protobuf:"varint,2,rep,packed,name=JPONAAHBGID,proto3" json:"JPONAAHBGID,omitempty"`
	NPKOJCAPCIJ     []uint32              `protobuf:"varint,5,rep,packed,name=NPKOJCAPCIJ,proto3" json:"NPKOJCAPCIJ,omitempty"`
	...
	MDEIGNMPCOO     []uint32              `protobuf:"varint,8,rep,packed,name=MDEIGNMPCOO,proto3" json:"MDEIGNMPCOO,omitempty"`
	LLDFJKPBKLM     []uint32              `protobuf:"varint,3,rep,packed,name=LLDFJKPBKLM,proto3" json:"LLDFJKPBKLM,omitempty"`
}
...
func (x *HideAndSeekActivityDetailInfo) GetJPONAAHBGID() []uint32 {
	if x != nil {
		return x.JPONAAHBGID
	}
	return nil
}

func (x *HideAndSeekActivityDetailInfo) GetNPKOJCAPCIJ() []uint32 {
	if x != nil {
		return x.NPKOJCAPCIJ
	}
	return nil
}
...
func (x *HideAndSeekActivityDetailInfo) GetMDEIGNMPCOO() []uint32 {
	if x != nil {
		return x.MDEIGNMPCOO
	}
	return nil
}

func (x *HideAndSeekActivityDetailInfo) GetLLDFJKPBKLM() []uint32 {
	if x != nil {
		return x.LLDFJKPBKLM
	}
	return nil
}
...
var file_HideAndSeekActivityDetailInfo_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x20, 0x0a, 0x0b, 0x4a, 0x50, 0x4f, 0x4e, 0x41, 0x41, 0x48, 0x42, 0x47, 0x49, 0x44,
	0x18, 0x02, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x4a, 0x50, 0x4f, 0x4e, 0x41, 0x41, 0x48, 0x42,
	0x47, 0x49, 0x44, 0x12, 0x20, 0x0a, 0x0b, 0x4e, 0x50, 0x4b, 0x4f, 0x4a, 0x43, 0x41, 0x50, 0x43,
	0x49, 0x4a, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x4e, 0x50, 0x4b, 0x4f, 0x4a, 0x43,
	0x41, 0x50, 0x43, 0x49, 0x4a, 0x12, 0x40, 0x0a, 0x12, 0x6f, 0x70, 0x65, 0x6e, 0x5f, 0x6d, 0x61,
	...
	0x6e, 0x66, 0x6f, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x20, 0x0a, 0x0b, 0x4d, 0x44, 0x45, 0x49, 0x47,
	0x4e, 0x4d, 0x50, 0x43, 0x4f, 0x4f, 0x18, 0x08, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x4d, 0x44,
	0x45, 0x49, 0x47, 0x4e, 0x4d, 0x50, 0x43, 0x4f, 0x4f, 0x12, 0x20, 0x0a, 0x0b, 0x4c, 0x4c, 0x44,
	0x46, 0x4a, 0x4b, 0x50, 0x42, 0x4b, 0x4c, 0x4d, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b,
	0x4c, 0x4c, 0x44, 0x46, 0x4a, 0x4b, 0x50, 0x42, 0x4b, 0x4c, 0x4d, 0x42, 0x06, 0x5a, 0x04, 0x2f,
