...
type TreasureSeelieActivityDetailInfo struct {
	...
	TreasureCloseTime uint32                      `protobuf:"varint,5,opt,name=treasure_close_time,json=treasureCloseTime,proto3" json:"treasure_close_time,omitempty"`
	...
	RegionDataList    []*TreasureSeelieRegionData `protobuf:"bytes,15,rep,name=region_data_list,json=regionDataList,proto3" json:"region_data_list,omitempty"`
}
...
var file_TreasureSeelieActivityDetailInfo_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6d, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x11, 0x74, 0x72, 0x65, 0x61,
	...
	0x69, 0x6f, 0x6e, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0f, 0x20,
