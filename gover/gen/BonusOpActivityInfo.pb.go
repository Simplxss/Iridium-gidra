...
type BonusOpActivityInfo struct {
	...
	LeftBonusCount uint32 `protobuf:"varint,12,opt,name=left_bonus_count,json=leftBonusCount,proto3" json:"left_bonus_count,omitempty"`
}
...
var file_BonusOpActivityInfo_proto_rawDesc = []byte{
	...
	0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0e, 0x6c, 0x65,
...
var file_BonusOpActivityInfo_proto_goTypes = []interface{}{
	(*BonusOpActivityInfo)(nil), // 0: BonusOpActivityInfo
}
