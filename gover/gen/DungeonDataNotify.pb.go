...
type DungeonDataNotify struct {
	...
	DungeonDataMap map[uint32]uint32 `protobuf:"bytes,4,rep,name=dungeon_data_map,json=dungeonDataMap,proto3" json:"dungeon_data_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
var file_DungeonDataNotify_proto_rawDesc = []byte{
	...
	0x6d, 0x61, 0x70, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x44, 0x75, 0x6e, 0x67,
