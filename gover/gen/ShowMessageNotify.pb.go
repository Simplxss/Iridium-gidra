...
type ShowMessageNotify struct {
	...
	Params []*MsgParam `protobuf:"bytes,6,rep,name=params,proto3" json:"params,omitempty"`
	MsgId  SvrMsgId    `protobuf:"varint,8,opt,name=msg_id,json=msgId,proto3,enum=SvrMsgId" json:"msg_id,omitempty"`
}
...
var file_ShowMessageNotify_proto_rawDesc = []byte{
	...
	0x73, 0x12, 0x20, 0x0a, 0x06, 0x6d, 0x73, 0x67, 0x5f, 0x69, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28,
