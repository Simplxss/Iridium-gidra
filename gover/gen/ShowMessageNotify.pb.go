...
type ShowMessageNotify struct {
	...
	Params []*MsgParam `protobuf:"bytes,5,rep,name=params,proto3" json:"params,omitempty"`
	MsgId  SvrMsgId    `protobuf:"varint,3,opt,name=msg_id,json=msgId,proto3,enum=SvrMsgId" json:"msg_id,omitempty"`
}
...
var file_ShowMessageNotify_proto_rawDesc = []byte{
	...
	0x69, 0x66, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x0e, 0x4d, 0x73, 0x67, 0x50, 0x61,
	...
	0x77, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x21,
	0x0a, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x09,
	0x2e, 0x4d, 0x73, 0x67, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x52, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d,
	0x73, 0x12, 0x20, 0x0a, 0x06, 0x6d, 0x73, 0x67, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x09, 0x2e, 0x53, 0x76, 0x72, 0x4d, 0x73, 0x67, 0x49, 0x64, 0x52, 0x05, 0x6d, 0x73,
...
var file_ShowMessageNotify_proto_goTypes = []interface{}{
	(*ShowMessageNotify)(nil), // 0: ShowMessageNotify
	(*MsgParam)(nil),          // 1: MsgParam
	(SvrMsgId)(0),             // 2: SvrMsgId
}
var file_ShowMessageNotify_proto_depIdxs = []int32{
	1, // 0: ShowMessageNotify.params:type_name -> MsgParam
	2, // 1: ShowMessageNotify.msg_id:type_name -> SvrMsgId
