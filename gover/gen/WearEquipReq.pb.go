...
type WearEquipReq struct {
	...
	EquipGuid  uint64 `protobuf:"varint,9,opt,name=equip_guid,json=equipGuid,proto3" json:"equip_guid,omitempty"`
...
var file_WearEquipReq_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09, 0x65, 0x71, 0x75, 0x69, 0x70, 0x47,
