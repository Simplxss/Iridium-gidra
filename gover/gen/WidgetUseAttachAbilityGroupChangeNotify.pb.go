...
type WidgetUseAttachAbilityGroupChangeNotify struct {
	...
	IsAttach   bool   `protobuf:"varint,8,opt,name=is_attach,json=isAttach,proto3" json:"is_attach,omitempty"`
...
var file_WidgetUseAttachAbilityGroupChangeNotify_proto_rawDesc = []byte{
	...
	0x5f, 0x61, 0x74, 0x74, 0x61, 0x63, 0x68, 0x18, 0x08, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x69,
