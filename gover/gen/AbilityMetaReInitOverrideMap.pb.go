...
type AbilityMetaReInitOverrideMap struct {
	...
	OverrideMap []*AbilityScalarValueEntry `protobuf:"bytes,2,rep,name=override_map,json=overrideMap,proto3" json:"override_map,omitempty"`
}
...
var file_AbilityMetaReInitOverrideMap_proto_rawDesc = []byte{
	...
	0x6d, 0x61, 0x70, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x41, 0x62, 0x69, 0x6c,
