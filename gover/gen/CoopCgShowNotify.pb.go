...
type CoopCgShowNotify struct {
	...
	CgList []uint32 `protobuf:"varint,5,rep,packed,name=cg_list,json=cgList,proto3" json:"cg_list,omitempty"`
}
...
var file_CoopCgShowNotify_proto_rawDesc = []byte{
	...
	0x63, 0x67, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x06, 0x63,
