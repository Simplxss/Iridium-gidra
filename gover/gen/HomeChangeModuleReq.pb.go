...
type HomeChangeModuleReq struct {
	...
	TargetModuleId uint32 `protobuf:"varint,13,opt,name=target_module_id,json=targetModuleId,proto3" json:"target_module_id,omitempty"`
}
...
var file_HomeChangeModuleReq_proto_rawDesc = []byte{
	...
	0x75, 0x6c, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0e, 0x74, 0x61,
...
var file_HomeChangeModuleReq_proto_goTypes = []interface{}{
	(*HomeChangeModuleReq)(nil), // 0: HomeChangeModuleReq
}
