...
type VehicleStaminaNotify struct {
	...
	CurStamina float32 `protobuf:"fixed32,13,opt,name=cur_stamina,json=curStamina,proto3" json:"cur_stamina,omitempty"`
}
...
var file_VehicleStaminaNotify_proto_rawDesc = []byte{
	...
	0x18, 0x0d, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0a, 0x63, 0x75, 0x72, 0x53, 0x74, 0x61, 0x6d, 0x69,
...
var file_VehicleStaminaNotify_proto_goTypes = []interface{}{
	(*VehicleStaminaNotify)(nil), // 0: VehicleStaminaNotify
}
