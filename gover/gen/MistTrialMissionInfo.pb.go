...
type MistTrialMissionInfo struct {
	...
	WatcherListId uint32 `protobuf:"varint,11,opt,name=watcher_list_id,json=watcherListId,proto3" json:"watcher_list_id,omitempty"`
}
...
var file_MistTrialMissionInfo_proto_rawDesc = []byte{
	...
	0x74, 0x63, 0x68, 0x65, 0x72, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x0b, 0x20,
