...
type AvatarEnterElementViewNotify struct {
	...
	IsTriggerd     bool   `protobuf:"varint,10,opt,name=is_triggerd,json=isTriggerd,proto3" json:"is_triggerd,omitempty"`
	AvatarEntityId uint32 `protobuf:"varint,6,opt,name=avatar_entity_id,json=avatarEntityId,proto3" json:"avatar_entity_id,omitempty"`
}
...
var file_AvatarEnterElementViewNotify_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x69, 0x73, 0x54, 0x72, 0x69,
