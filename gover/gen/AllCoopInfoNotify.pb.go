...
type AllCoopInfoNotify struct {
	...
	MainCoopList []*MainCoop `protobuf:"bytes,6,rep,name=main_coop_list,json=mainCoopList,proto3" json:"main_coop_list,omitempty"`
}
...
var file_AllCoopInfoNotify_proto_rawDesc = []byte{
	...
	0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x09, 0x2e, 0x4d, 0x61, 0x69, 0x6e, 0x43, 0x6f, 0x6f,
