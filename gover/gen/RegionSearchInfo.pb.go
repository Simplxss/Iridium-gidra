...
type RegionSearchInfo struct {
	...
	RegionSearchList []*RegionSearch `protobuf:"bytes,14,rep,name=region_search_list,json=regionSearchList,proto3" json:"region_search_list,omitempty"`
	IsEntered        bool            `protobuf:"varint,10,opt,name=is_entered,json=isEntered,proto3" json:"is_entered,omitempty"`
}
...
var file_RegionSearchInfo_proto_rawDesc = []byte{
	...
	0x68, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0e, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x52,
	...
	0x0a, 0x69, 0x73, 0x5f, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x65, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28,
...
var file_RegionSearchInfo_proto_goTypes = []interface{}{
	(*RegionSearchInfo)(nil), // 0: RegionSearchInfo
	(*RegionSearch)(nil),     // 1: RegionSearch
}
var file_RegionSearchInfo_proto_depIdxs = []int32{
	1, // 0: RegionSearchInfo.region_search_list:type_name -> RegionSearch
