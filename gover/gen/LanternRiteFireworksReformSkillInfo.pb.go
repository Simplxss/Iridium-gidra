...
type LanternRiteFireworksReformSkillInfo struct {
	...
	IsUnlock    bool   `protobuf:"varint,5,opt,name=is_unlock,json=isUnlock,proto3" json:"is_unlock,omitempty"`
	SkillId     uint32 `protobuf:"varint,2,opt,name=skill_id,json=skillId,proto3" json:"skill_id,omitempty"`
	KIECEBKGLDC uint32 `protobuf:"varint,11,opt,name=KIECEBKGLDC,proto3" json:"KIECEBKGLDC,omitempty"`
	CHDAKJBMLJH uint32 `protobuf:"varint,1,opt,name=CHDAKJBMLJH,proto3" json:"CHDAKJBMLJH,omitempty"`
}
...
func (x *LanternRiteFireworksReformSkillInfo) GetKIECEBKGLDC() uint32 {
	if x != nil {
		return x.KIECEBKGLDC
	}
	return 0
}

func (x *LanternRiteFireworksReformSkillInfo) GetCHDAKJBMLJH() uint32 {
	if x != nil {
		return x.CHDAKJBMLJH
	}
	return 0
}
...
var file_LanternRiteFireworksReformSkillInfo_proto_rawDesc = []byte{
	...
	0x6c, 0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa1, 0x01, 0x0a, 0x23,
	...
	0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x69, 0x73, 0x55, 0x6e, 0x6c, 0x6f, 0x63, 0x6b,
	0x12, 0x19, 0x0a, 0x08, 0x73, 0x6b, 0x69, 0x6c, 0x6c, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x07, 0x73, 0x6b, 0x69, 0x6c, 0x6c, 0x49, 0x64, 0x12, 0x20, 0x0a, 0x0b, 0x4b,
	0x49, 0x45, 0x43, 0x45, 0x42, 0x4b, 0x47, 0x4c, 0x44, 0x43, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0d,
	0x52, 0x0b, 0x4b, 0x49, 0x45, 0x43, 0x45, 0x42, 0x4b, 0x47, 0x4c, 0x44, 0x43, 0x12, 0x20, 0x0a,
	0x0b, 0x43, 0x48, 0x44, 0x41, 0x4b, 0x4a, 0x42, 0x4d, 0x4c, 0x4a, 0x48, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x0b, 0x43, 0x48, 0x44, 0x41, 0x4b, 0x4a, 0x42, 0x4d, 0x4c, 0x4a, 0x48, 0x42,
