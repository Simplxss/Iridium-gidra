...
type WinterCampGiveFriendItemRsp struct {
	...
	LimitItemIdList []uint32 `protobuf:"varint,6,rep,packed,name=limit_item_id_list,json=limitItemIdList,proto3" json:"limit_item_id_list,omitempty"`
}
...
var file_WinterCampGiveFriendItemRsp_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0f, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x49,
