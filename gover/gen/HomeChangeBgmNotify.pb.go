...
type HomeChangeBgmNotify struct {
	...
	BgmId uint32 `protobuf:"varint,2,opt,name=bgm_id,json=bgmId,proto3" json:"bgm_id,omitempty"`
}
...
var file_HomeChangeBgmNotify_proto_rawDesc = []byte{
	...
	0x66, 0x79, 0x12, 0x15, 0x0a, 0x06, 0x62, 0x67, 0x6d, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01,
