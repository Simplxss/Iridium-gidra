...
type ContentAuditInfo struct {
	...
	PPHEKAGMMLG uint32     `protobuf:"varint,3,opt,name=PPHEKAGMMLG,proto3" json:"PPHEKAGMMLG,omitempty"`
	JLICCDMDPJH AuditState `protobuf:"varint,4,opt,name=JLICCDMDPJH,proto3,enum=AuditState" json:"JLICCDMDPJH,omitempty"`
...
func (x *ContentAuditInfo) GetPPHEKAGMMLG() uint32 {
	if x != nil {
		return x.PPHEKAGMMLG
	}
	return 0
}

func (x *ContentAuditInfo) GetJLICCDMDPJH() AuditState {
	if x != nil {
		return x.JLICCDMDPJH
	}
...
var file_ContentAuditInfo_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x12, 0x20, 0x0a, 0x0b, 0x50, 0x50, 0x48, 0x45, 0x4b, 0x41, 0x47, 0x4d, 0x4d, 0x4c,
	0x47, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x50, 0x50, 0x48, 0x45, 0x4b, 0x41, 0x47,
	0x4d, 0x4d, 0x4c, 0x47, 0x12, 0x2d, 0x0a, 0x0b, 0x4a, 0x4c, 0x49, 0x43, 0x43, 0x44, 0x4d, 0x44,
	0x50, 0x4a, 0x48, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0b, 0x2e, 0x41, 0x75, 0x64, 0x69,
	0x74, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x0b, 0x4a, 0x4c, 0x49, 0x43, 0x43, 0x44, 0x4d, 0x44,
	0x50, 0x4a, 0x48, 0x12, 0x21, 0x0a, 0x0c, 0x73, 0x75, 0x62, 0x6d, 0x69, 0x74, 0x5f, 0x6c, 0x69,
...
var file_ContentAuditInfo_proto_depIdxs = []int32{
	1, // 0: ContentAuditInfo.JLICCDMDPJH:type_name -> AuditState
