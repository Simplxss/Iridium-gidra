...
type PushTipsReadFinishRsp struct {
	...
	PushTipsId uint32 `protobuf:"varint,5,opt,name=push_tips_id,json=pushTipsId,proto3" json:"push_tips_id,omitempty"`
...
var file_PushTipsReadFinishRsp_proto_rawDesc = []byte{
	...
	0x69, 0x70, 0x73, 0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x70, 0x75,
