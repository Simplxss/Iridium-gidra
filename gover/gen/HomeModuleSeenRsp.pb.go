...
type HomeModuleSeenRsp struct {
	...
	SeenModuleIdList []uint32 `protobuf:"varint,14,rep,packed,name=seen_module_id_list,json=seenModuleIdList,proto3" json:"seen_module_id_list,omitempty"`
...
var file_HomeModuleSeenRsp_proto_rawDesc = []byte{
	...
	0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0e, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x10, 0x73, 0x65, 0x65,
...
var file_HomeModuleSeenRsp_proto_goTypes = []interface{}{
	(*HomeModuleSeenRsp)(nil), // 0: HomeModuleSeenRsp
}
