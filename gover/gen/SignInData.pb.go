...
type SignInData struct {
	...
	RewardItemList []*ItemParam `protobuf:"bytes,3,rep,name=reward_item_list,json=rewardItemList,proto3" json:"reward_item_list,omitempty"`
	DayCount       uint32       `protobuf:"varint,11,opt,name=day_count,json=dayCount,proto3" json:"day_count,omitempty"`
}
...
var file_SignInData_proto_rawDesc = []byte{
	...
	0x6f, 0x75, 0x6e, 0x74, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x64, 0x61, 0x79, 0x43,
