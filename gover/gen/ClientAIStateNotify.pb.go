...
type ClientAIStateNotify struct {
	...
	CurTactic uint32 `protobuf:"varint,4,opt,name=cur_tactic,json=curTactic,proto3" json:"cur_tactic,omitempty"`
}
...
var file_ClientAIStateNotify_proto_rawDesc = []byte{
	...
	0x1d, 0x0a, 0x0a, 0x63, 0x75, 0x72, 0x5f, 0x74, 0x61, 0x63, 0x74, 0x69, 0x63, 0x18, 0x04, 0x20,
