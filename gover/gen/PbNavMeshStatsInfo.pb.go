...
type PbNavMeshStatsInfo struct {
	...
	HDAAEDFOOOI int32 `protobuf:"varint,5,opt,name=HDAAEDFOOOI,proto3" json:"HDAAEDFOOOI,omitempty"`
	ECNPOEJHPCI int32 `protobuf:"varint,10,opt,name=ECNPOEJHPCI,proto3" json:"ECNPOEJHPCI,omitempty"`
	FJGDCFHBCLI int32 `protobuf:"varint,3,opt,name=FJGDCFHBCLI,proto3" json:"FJGDCFHBCLI,omitempty"`
	GNLELCLHHDK int32 `protobuf:"varint,14,opt,name=GNLELCLHHDK,proto3" json:"GNLELCLHHDK,omitempty"`
}
...
func (x *PbNavMeshStatsInfo) GetHDAAEDFOOOI() int32 {
	if x != nil {
		return x.HDAAEDFOOOI
	}
	return 0
}

func (x *PbNavMeshStatsInfo) GetECNPOEJHPCI() int32 {
	if x != nil {
		return x.ECNPOEJHPCI
	}
	return 0
}

func (x *PbNavMeshStatsInfo) GetFJGDCFHBCLI() int32 {
	if x != nil {
		return x.FJGDCFHBCLI
	}
	return 0
}

func (x *PbNavMeshStatsInfo) GetGNLELCLHHDK() int32 {
	if x != nil {
		return x.GNLELCLHHDK
	}
	return 0
}
...
var file_PbNavMeshStatsInfo_proto_rawDesc = []byte{
	...
	,
