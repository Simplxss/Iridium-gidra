...
type GCGMsgPVEIntentionInfo struct {
	...
	IntentionMap map[uint32]*GCGMsgPVEIntention `protobuf:"bytes,7,rep,name=intention_map,json=intentionMap,proto3" json:"intention_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_GCGMsgPVEIntentionInfo_proto_rawDesc = []byte{
	...
	0x5f, 0x6d, 0x61, 0x70, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x47, 0x43, 0x47,
	0x4d, 0x73, 0x67, 0x50, 0x56, 0x45, 0x49, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x69, 0x6f, 0x6e, 0x49,
