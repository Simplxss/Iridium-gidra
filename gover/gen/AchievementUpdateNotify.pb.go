...
type AchievementUpdateNotify struct {
	...
	AchievementList []*Achievement `protobuf:"bytes,2,rep,name=achievement_list,json=achievementList,proto3" json:"achievement_list,omitempty"`
}
...
var file_AchievementUpdateNotify_proto_rawDesc = []byte{
	...
	0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x41, 0x63, 0x68, 0x69, 0x65, 0x76,
