...
type ChooseCurAvatarTeamRsp struct {
	...
	CurTeamId uint32 `protobuf:"varint,4,opt,name=cur_team_id,json=curTeamId,proto3" json:"cur_team_id,omitempty"`
}
...
var file_ChooseCurAvatarTeamRsp_proto_rawDesc = []byte{
	...
	0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x63, 0x75, 0x72, 0x54, 0x65, 0x61, 0x6d,
