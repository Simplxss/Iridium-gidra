...
type CanUseSkillNotify struct {
	...
	IsCanUseSkill bool `protobuf:"varint,8,opt,name=is_can_use_skill,json=isCanUseSkill,proto3" json:"is_can_use_skill,omitempty"`
}
...
var file_CanUseSkillNotify_proto_rawDesc = []byte{
	...
	0x6c, 0x6c, 0x18, 0x08, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0d, 0x69, 0x73, 0x43, 0x61, 0x6e, 0x55,
