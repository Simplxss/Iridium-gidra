...
type GetDungeonEntryExploreConditionReq struct {
	...
	DungeonEntryConfigId     uint32 `protobuf:"varint,14,opt,name=dungeon_entry_config_id,json=dungeonEntryConfigId,proto3" json:"dungeon_entry_config_id,omitempty"`
	SceneId                  uint32 `protobuf:"varint,6,opt,name=scene_id,json=sceneId,proto3" json:"scene_id,omitempty"`
	DungeonEntryScenePointId uint32 `protobuf:"varint,5,opt,name=dungeon_entry_scene_point_id,json=dungeonEntryScenePointId,proto3" json:"dungeon_entry_scene_point_id,omitempty"`
}
...
var file_GetDungeonEntryExploreConditionReq_proto_rawDesc = []byte{
	...
	0x72, 0x79, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x5f, 0x69, 0x64, 0x18, 0x0e, 0x20, 0x01,
	...
	0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x18, 0x64, 0x75, 0x6e, 0x67, 0x65,
