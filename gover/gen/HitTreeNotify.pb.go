...
type HitTreeNotify struct {
	...
	TreeType uint32  `protobuf:"varint,6,opt,name=tree_type,json=treeType,proto3" json:"tree_type,omitempty"`
	TreePos  *Vector `protobuf:"bytes,14,opt,name=tree_pos,json=treePos,proto3" json:"tree_pos,omitempty"`
	DropPos  *Vector `protobuf:"bytes,10,opt,name=drop_pos,json=dropPos,proto3" json:"drop_pos,omitempty"`
}
...
var file_HitTreeNotify_proto_rawDesc = []byte{
	...
	0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x74, 0x72, 0x65, 0x65, 0x54, 0x79, 0x70,
	0x65, 0x12, 0x22, 0x0a, 0x08, 0x74, 0x72, 0x65, 0x65, 0x5f, 0x70, 0x6f, 0x73, 0x18, 0x0e, 0x20,
	...
	0x73, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x07, 0x2e, 0x56, 0x65, 0x63, 0x74, 0x6f, 0x72,
