...
type MonsterAIConfigHashNotify struct {
	...
	HashValue int32  `protobuf:"varint,13,opt,name=hash_value,json=hashValue,proto3" json:"hash_value,omitempty"`
}
...
var file_MonsterAIConfigHashNotify_proto_rawDesc = []byte{
	...
	0x0a, 0x06, 0x6a, 0x6f, 0x62, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x05,
	...
	0x18, 0x0d, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x68, 0x61, 0x73, 0x68, 0x56, 0x61, 0x6c, 0x75,
...
var file_MonsterAIConfigHashNotify_proto_goTypes = []interface{}{
	(*MonsterAIConfigHashNotify)(nil), // 0: MonsterAIConfigHashNotify
}
