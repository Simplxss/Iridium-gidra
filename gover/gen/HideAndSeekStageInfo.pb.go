...
type HideAndSeekStageInfo struct {
	...
	HiderUidList  []uint32                                `protobuf:"varint,4,rep,packed,name=hider_uid_list,json=hiderUidList,proto3" json:"hider_uid_list,omitempty"`
	MapId         uint32                                  `protobuf:"varint,14,opt,name=map_id,json=mapId,proto3" json:"map_id,omitempty"`
	BattleInfoMap map[uint32]*HideAndSeekPlayerBattleInfo `protobuf:"bytes,9,rep,name=battle_info_map,json=battleInfoMap,proto3" json:"battle_info_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	HunterUid     uint32                                  `protobuf:"varint,3,opt,name=hunter_uid,json=hunterUid,proto3" json:"hunter_uid,omitempty"`
	StageType     HideAndSeekStageType                    `protobuf:"varint,12,opt,name=stage_type,json=stageType,proto3,enum=HideAndSeekStageType" json:"stage_type,omitempty"`
	IsRecordScore bool                                    `protobuf:"varint,1,opt,name=is_record_score,json=isRecordScore,proto3" json:"is_record_score,omitempty"`
}
...
var file_HideAndSeekStageInfo_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x21, 0x48, 0x69,
	0x64, 0x65, 0x41, 0x6e, 0x64, 0x53, 0x65, 0x65, 0x6b, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x42,
	0x61, 0x74, 0x74, 0x6c, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a,
	...
	,
	...
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x48, 0x69, 0x64, 0x65, 0x41, 0x6e,
	0x64, 0x53, 0x65, 0x65, 0x6b, 0x50, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x42, 0x61, 0x74, 0x74, 0x6c,
...
var file_HideAndSeekStageInfo_proto_goTypes = []interface{}{
	(*HideAndSeekStageInfo)(nil),        // 0: HideAndSeekStageInfo
	nil,                                 // 1: HideAndSeekStageInfo.BattleInfoMapEntry
	(HideAndSeekStageType)(0),           // 2: HideAndSeekStageType
