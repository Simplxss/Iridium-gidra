...
type SetNameCardRsp struct {
	...
	NameCardId uint32 `protobuf:"varint,12,opt,name=name_card_id,json=nameCardId,proto3" json:"name_card_id,omitempty"`
}
...
var file_SetNameCardRsp_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x12, 0x20, 0x0a, 0x0c, 0x6e, 0x61, 0x6d, 0x65, 0x5f, 0x63, 0x61, 0x72, 0x64, 0x5f,
	0x69, 0x64, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x6e, 0x61, 0x6d, 0x65, 0x43, 0x61,
...
var file_SetNameCardRsp_proto_goTypes = []interface{}{
	(*SetNameCardRsp)(nil), // 0: SetNameCardRsp
}
