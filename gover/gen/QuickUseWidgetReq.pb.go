...
type QuickUseWidgetReq struct {
	...
	MDCPHIOENOJ bool `protobuf:"varint,782,opt,name=MDCPHIOENOJ,proto3" json:"MDCPHIOENOJ,omitempty"`
...
func (x *QuickUseWidgetReq) GetMDCPHIOENOJ() bool {
	if x != nil {
		return x.MDCPHIOENOJ
	}
	return false
}
...
type QuickUseWidgetReq_LocationInfo struct {
	LocationInfo *WidgetCreateLocationInfo `protobuf:"bytes,1827,opt,name=location_info,json=locationInfo,proto3,oneof"`
}

type QuickUseWidgetReq_CameraInfo struct {
	CameraInfo *WidgetCameraInfo `protobuf:"bytes,1598,opt,name=camera_info,json=cameraInfo,proto3,oneof"`
}

type QuickUseWidgetReq_CreatorInfo struct {
	CreatorInfo *WidgetCreatorInfo `protobuf:"bytes,1489,opt,name=creator_info,json=creatorInfo,proto3,oneof"`
}

type QuickUseWidgetReq_ThunderBirdFeatherInfo struct {
	ThunderBirdFeatherInfo *WidgetThunderBirdFeatherInfo `protobuf:"bytes,767,opt,name=thunder_bird_feather_info,json=thunderBirdFeatherInfo,proto3,oneof"`
}

type QuickUseWidgetReq_SorushInfo struct {
	SorushInfo *WidgetSorushInfo `protobuf:"bytes,75,opt,name=sorush_info,json=sorushInfo,proto3,oneof"`
}
...
var file_QuickUseWidgetReq_proto_rawDesc = []byte{
	...
	,
	...
	0x12, 0x34, 0x0a, 0x0b, 0x73, 0x6f, 0x72, 0x75, 0x73, 0x68, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18,
	0x4b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x57, 0x69, 0x64, 0x67, 0x65, 0x74, 0x53, 0x6f,
	0x72, 0x75, 0x73, 0x68, 0x49, 0x6e, 0x66, 0x6f, 0x48, 0x00, 0x52, 0x0a, 0x73, 0x6f, 0x72, 0x75,
	0x73, 0x68, 0x49, 0x6e, 0x66, 0x6f, 0x42, 0x07, 0x0a, 0x05, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x42,
