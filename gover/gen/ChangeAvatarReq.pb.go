...
type ChangeAvatarReq struct {
	...
	MovePos *Vector `protobuf:"bytes,3,opt,name=move_pos,json=movePos,proto3" json:"move_pos,omitempty"`
	IsMove  bool    `protobuf:"varint,9,opt,name=is_move,json=isMove,proto3" json:"is_move,omitempty"`
...
var file_ChangeAvatarReq_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x72, 0x52, 0x07, 0x6d, 0x6f, 0x76, 0x65, 0x50, 0x6f, 0x73, 0x12, 0x17, 0x0a, 0x07,
	0x69, 0x73, 0x5f, 0x6d, 0x6f, 0x76, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x69,
	0x73, 0x4d, 0x6f, 0x76, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x73, 0x6b, 0x69, 0x6c, 0x6c, 0x5f, 0x69,
	0x64, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x73, 0x6b, 0x69, 0x6c, 0x6c, 0x49, 0x64,
	0x12, 0x12, 0x0a, 0x04, 0x67, 0x75, 0x69, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x04, 0x52, 0x04,
...
var file_ChangeAvatarReq_proto_goTypes = []interface{}{
	(*ChangeAvatarReq)(nil), // 0: ChangeAvatarReq
	(*Vector)(nil),          // 1: Vector
}
var file_ChangeAvatarReq_proto_depIdxs = []int32{
	1, // 0: ChangeAvatarReq.move_pos:type_name -> Vector
