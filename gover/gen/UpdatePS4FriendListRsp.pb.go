...
type UpdatePS4FriendListRsp struct {
	...
	PsnIdList []string `protobuf:"bytes,6,rep,name=psn_id_list,json=psnIdList,proto3" json:"psn_id_list,omitempty"`
...
var file_UpdatePS4FriendListRsp_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x06, 0x20, 0x03, 0x28, 0x09, 0x52, 0x09, 0x70,
