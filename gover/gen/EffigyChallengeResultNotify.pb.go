...
type EffigyChallengeResultNotify struct {
	...
	ChallengeMaxScore uint32 `protobuf:"varint,9,opt,name=challenge_max_score,json=challengeMaxScore,proto3" json:"challenge_max_score,omitempty"`
}
...
var file_EffigyChallengeResultNotify_proto_rawDesc = []byte{
	...
	0x73, 0x63, 0x6f, 0x72, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x11, 0x63, 0x68, 0x61,
