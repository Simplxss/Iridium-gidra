...
type EvtAvatarUpdateFocusNotify struct {
	...
	FocusForward *Vector     `protobuf:"bytes,14,opt,name=focus_forward,json=focusForward,proto3" json:"focus_forward,omitempty"`
...
var file_EvtAvatarUpdateFocusNotify_proto_rawDesc = []byte{
	...
	0x2c, 0x0a, 0x0d, 0x66, 0x6f, 0x63, 0x75, 0x73, 0x5f, 0x66, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64,
	0x18, 0x0e, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x07, 0x2e, 0x56, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x52,
	0x0c, 0x66, 0x6f, 0x63, 0x75, 0x73, 0x46, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x12, 0x2f, 0x0a,
	0x0c, 0x66, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x09, 0x20,
	0x01, 0x28, 0x0e, 0x32, 0x0c, 0x2e, 0x46, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x54, 0x79, 0x70,
	0x65, 0x52, 0x0b, 0x66, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x54, 0x79, 0x70, 0x65, 0x42, 0x06,
...
var file_EvtAvatarUpdateFocusNotify_proto_goTypes = []interface{}{
	(*EvtAvatarUpdateFocusNotify)(nil), // 0: EvtAvatarUpdateFocusNotify
	(*Vector)(nil),                     // 1: Vector
	(ForwardType)(0),                   // 2: ForwardType
}
var file_EvtAvatarUpdateFocusNotify_proto_depIdxs = []int32{
	1, // 0: EvtAvatarUpdateFocusNotify.focus_forward:type_name -> Vector
	2, // 1: EvtAvatarUpdateFocusNotify.forward_type:type_name -> ForwardType
