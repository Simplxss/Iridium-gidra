...
type GCGOperationPlayCard struct {
	...
	ReplaceCardGuid    uint32   `protobuf:"varint,3,opt,name=replace_card_guid,json=replaceCardGuid,proto3" json:"replace_card_guid,omitempty"`
	CostDiceIndexList  []uint32 `protobuf:"varint,6,rep,packed,name=cost_dice_index_list,json=costDiceIndexList,proto3" json:"cost_dice_index_list,omitempty"`
	CardGuid           uint32   `protobuf:"varint,4,opt,name=card_guid,json=cardGuid,proto3" json:"card_guid,omitempty"`
	TargetCardGuidList []uint32 `protobuf:"varint,15,rep,packed,name=target_card_guid_list,json=targetCardGuidList,proto3" json:"target_card_guid_list,omitempty"`
}
...
var file_GCGOperationPlayCard_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x61, 0x72, 0x64, 0x5f, 0x67, 0x75, 0x69, 0x64, 0x18,
	...
	0x75, 0x69, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0f, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x12,
