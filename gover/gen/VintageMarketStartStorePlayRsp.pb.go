...
type VintageMarketStartStorePlayRsp struct {
	...
	StoreRound  uint32 `protobuf:"varint,4,opt,name=store_round,json=storeRound,proto3" json:"store_round,omitempty"`
	NDKCCHHJMCG uint32 `protobuf:"varint,14,opt,name=NDKCCHHJMCG,proto3" json:"NDKCCHHJMCG,omitempty"`
	ACGCAGDFOCM uint32 `protobuf:"varint,1,opt,name=ACGCAGDFOCM,proto3" json:"ACGCAGDFOCM,omitempty"`
...
func (x *VintageMarketStartStorePlayRsp) GetNDKCCHHJMCG() uint32 {
	if x != nil {
		return x.NDKCCHHJMCG
	}
	return 0
}

func (x *VintageMarketStartStorePlayRsp) GetACGCAGDFOCM() uint32 {
	if x != nil {
		return x.ACGCAGDFOCM
	}
	return 0
}
...
var file_VintageMarketStartStorePlayRsp_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x5f, 0x72, 0x6f, 0x75, 0x6e, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a,
	0x73, 0x74, 0x6f, 0x72, 0x65, 0x52, 0x6f, 0x75, 0x6e, 0x64, 0x12, 0x20, 0x0a, 0x0b, 0x4e, 0x44,
	0x4b, 0x43, 0x43, 0x48, 0x48, 0x4a, 0x4d, 0x43, 0x47, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x0b, 0x4e, 0x44, 0x4b, 0x43, 0x43, 0x48, 0x48, 0x4a, 0x4d, 0x43, 0x47, 0x12, 0x20, 0x0a, 0x0b,
	0x41, 0x43, 0x47, 0x43, 0x41, 0x47, 0x44, 0x46, 0x4f, 0x43, 0x4d, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0d, 0x52, 0x0b, 0x41, 0x43, 0x47, 0x43, 0x41, 0x47, 0x44, 0x46, 0x4f, 0x43, 0x4d, 0x12, 0x18,
