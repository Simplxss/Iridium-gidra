...
type BrickBreakerSelectAvatarRsp struct {
	...
	AvatarId []uint32 `protobuf:"varint,14,rep,packed,name=avatar_id,json=avatarId,proto3" json:"avatar_id,omitempty"`
...
var file_BrickBreakerSelectAvatarRsp_proto_rawDesc = []byte{
	...
	0x0e, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x08, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x49, 0x64, 0x12,
