...
type GetAuthSalesmanInfoRsp struct {
	...
	DayRewardId uint32 `protobuf:"varint,3,opt,name=day_reward_id,json=dayRewardId,proto3" json:"day_reward_id,omitempty"`
}
...
var file_GetAuthSalesmanInfoRsp_proto_rawDesc = []byte{
	...
	0x65, 0x49, 0x64, 0x12, 0x22, 0x0a, 0x0d, 0x64, 0x61, 0x79, 0x5f, 0x72, 0x65, 0x77, 0x61, 0x72,
	0x64, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x64, 0x61, 0x79, 0x52,
...
var file_GetAuthSalesmanInfoRsp_proto_goTypes = []interface{}{
	(*GetAuthSalesmanInfoRsp)(nil), // 0: GetAuthSalesmanInfoRsp
}
