...
type HachiActivityDetailInfo struct {
	...
	StageMap map[uint32]*HachiStageInfo `protobuf:"bytes,8,rep,name=stage_map,json=stageMap,proto3" json:"stage_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_HachiActivityDetailInfo_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x43, 0x0a, 0x09, 0x73, 0x74, 0x61, 0x67, 0x65, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x08,
