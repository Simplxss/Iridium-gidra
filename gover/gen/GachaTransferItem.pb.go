...
type GachaTransferItem struct {
	...
	Item              *ItemParam `protobuf:"bytes,9,opt,name=item,proto3" json:"item,omitempty"`
	IsTransferItemNew bool       `protobuf:"varint,6,opt,name=is_transfer_item_new,json=isTransferItemNew,proto3" json:"is_transfer_item_new,omitempty"`
}
...
var file_GachaTransferItem_proto_rawDesc = []byte{
	...
	0x1e, 0x0a, 0x04, 0x69, 0x74, 0x65, 0x6d, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0a, 0x2e,
	...
	0x74, 0x65, 0x6d, 0x5f, 0x6e, 0x65, 0x77, 0x18, 0x06, 0x20, 0x01, 0x28, 0x08, 0x52, 0x11, 0x69,
...
var file_GachaTransferItem_proto_goTypes = []interface{}{
	(*GachaTransferItem)(nil), // 0: GachaTransferItem
	(*ItemParam)(nil),         // 1: ItemParam
}
var file_GachaTransferItem_proto_depIdxs = []int32{
	1, // 0: GachaTransferItem.item:type_name -> ItemParam
