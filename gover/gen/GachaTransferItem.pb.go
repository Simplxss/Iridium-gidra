...
type GachaTransferItem struct {
	...
	IsTransferItemNew bool       `protobuf:"varint,12,opt,name=is_transfer_item_new,json=isTransferItemNew,proto3" json:"is_transfer_item_new,omitempty"`
}
...
var file_GachaTransferItem_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x6d, 0x5f, 0x6e, 0x65, 0x77, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x08, 0x52, 0x11, 0x69,
