...
type EvtSetAttackTargetNotify struct {
	...
	EvtSetAttackTargetInfo *EvtSetAttackTargetInfo `protobuf:"bytes,2,opt,name=evt_set_attack_target_info,json=evtSetAttackTargetInfo,proto3" json:"evt_set_attack_target_info,omitempty"`
