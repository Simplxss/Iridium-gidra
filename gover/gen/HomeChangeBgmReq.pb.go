...
type HomeChangeBgmReq struct {
	...
	BgmId uint32 `protobuf:"varint,1,opt,name=bgm_id,json=bgmId,proto3" json:"bgm_id,omitempty"`
}
...
var file_HomeChangeBgmReq_proto_rawDesc = []byte{
	...
	0x62, 0x67, 0x6d, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x05, 0x62, 0x67,
