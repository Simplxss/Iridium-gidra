...
type AddSeenMonsterNotify struct {
	...
	MonsterIdList []uint32 `protobuf:"varint,15,rep,packed,name=monster_id_list,json=monsterIdList,proto3" json:"monster_id_list,omitempty"`
}
...
var file_AddSeenMonsterNotify_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0f, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0d, 0x6d,
...
var file_AddSeenMonsterNotify_proto_goTypes = []interface{}{
	(*AddSeenMonsterNotify)(nil), // 0: AddSeenMonsterNotify
}
