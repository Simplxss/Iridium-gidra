...
type ClientAbilityChangeNotify struct {
	...
	IsInitHash bool                  `protobuf:"varint,11,opt,name=is_init_hash,json=isInitHash,proto3" json:"is_init_hash,omitempty"`
	Invokes    []*AbilityInvokeEntry `protobuf:"bytes,13,rep,name=invokes,proto3" json:"invokes,omitempty"`
...
var file_ClientAbilityChangeNotify_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x69, 0x74, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x0a, 0x69, 0x73, 0x49, 0x6e, 0x69, 0x74, 0x48, 0x61, 0x73, 0x68, 0x12, 0x2d, 0x0a, 0x07, 0x69,
	0x6e, 0x76, 0x6f, 0x6b, 0x65, 0x73, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x41,
...
var file_ClientAbilityChangeNotify_proto_goTypes = []interface{}{
	(*ClientAbilityChangeNotify)(nil), // 0: ClientAbilityChangeNotify
	(*AbilityInvokeEntry)(nil),        // 1: AbilityInvokeEntry
}
var file_ClientAbilityChangeNotify_proto_depIdxs = []int32{
	1, // 0: ClientAbilityChangeNotify.invokes:type_name -> AbilityInvokeEntry
