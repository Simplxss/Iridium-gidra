...
type GCGSkillPreviewHpInfo struct {
	...
	HpChangeValue uint32               `protobuf:"varint,11,opt,name=hp_change_value,json=hpChangeValue,proto3" json:"hp_change_value,omitempty"`
	DACHPDNJOHH   bool                 `protobuf:"varint,12,opt,name=DACHPDNJOHH,proto3" json:"DACHPDNJOHH,omitempty"`
	ChangeType    GCGSkillHpChangeType `protobuf:"varint,2,opt,name=change_type,json=changeType,proto3,enum=GCGSkillHpChangeType" json:"change_type,omitempty"`
}
...
func (x *GCGSkillPreviewHpInfo) GetDACHPDNJOHH() bool {
	if x != nil {
		return x.DACHPDNJOHH
	}
	return false
}
...
var file_GCGSkillPreviewHpInfo_proto_rawDesc = []byte{
	...
	0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0d, 0x68, 0x70,
	0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x44,
	0x41, 0x43, 0x48, 0x50, 0x44, 0x4e, 0x4a, 0x4f, 0x48, 0x48, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x0b, 0x44, 0x41, 0x43, 0x48, 0x50, 0x44, 0x4e, 0x4a, 0x4f, 0x48, 0x48, 0x12, 0x36, 0x0a,
	0x0b, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x15, 0x2e, 0x47, 0x43, 0x47, 0x53, 0x6b, 0x69, 0x6c, 0x6c, 0x48, 0x70, 0x43,
