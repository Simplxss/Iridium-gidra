...
type GCGPlayerGCGState struct {
	...
	LAKOPLONGKL bool   `protobuf:"varint,13,opt,name=LAKOPLONGKL,proto3" json:"LAKOPLONGKL,omitempty"`
	Uid         uint32 `protobuf:"varint,14,opt,name=uid,proto3" json:"uid,omitempty"`
	MLIOBMAMIAI bool   `protobuf:"varint,1,opt,name=MLIOBMAMIAI,proto3" json:"MLIOBMAMIAI,omitempty"`
}
...
func (x *GCGPlayerGCGState) GetLAKOPLONGKL() bool {
	if x != nil {
		return x.LAKOPLONGKL
	}
	return false
}
...
func (x *GCGPlayerGCGState) GetMLIOBMAMIAI() bool {
	if x != nil {
		return x.MLIOBMAMIAI
	}
	return false
}
...
var file_GCGPlayerGCGState_proto_rawDesc = []byte{
	...
	0x0a, 0x0b, 0x4c, 0x41, 0x4b, 0x4f, 0x50, 0x4c, 0x4f, 0x4e, 0x47, 0x4b, 0x4c, 0x18, 0x0d, 0x20,
	0x01, 0x28, 0x08, 0x52, 0x0b, 0x4c, 0x41, 0x4b, 0x4f, 0x50, 0x4c, 0x4f, 0x4e, 0x47, 0x4b, 0x4c,
	0x12, 0x10, 0x0a, 0x03, 0x75, 0x69, 0x64, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x75,
	0x69, 0x64, 0x12, 0x20, 0x0a, 0x0b, 0x4d, 0x4c, 0x49, 0x4f, 0x42, 0x4d, 0x41, 0x4d, 0x49, 0x41,
	0x49, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x4d, 0x4c, 0x49, 0x4f, 0x42, 0x4d, 0x41,
	0x4d, 0x49, 0x41, 0x49, 0x42, 0x06, 0x5a, 0x04, 0x2f, 0x67, 0x65, 0x6e, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
