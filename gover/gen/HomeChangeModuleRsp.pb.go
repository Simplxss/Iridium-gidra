...
type HomeChangeModuleRsp struct {
	...
	TargetModuleId uint32 `protobuf:"varint,10,opt,name=target_module_id,json=targetModuleId,proto3" json:"target_module_id,omitempty"`
}
...
var file_HomeChangeModuleRsp_proto_rawDesc = []byte{
	...
	0x18, 0x0a, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0e, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x4d, 0x6f,
...
var file_HomeChangeModuleRsp_proto_goTypes = []interface{}{
	(*HomeChangeModuleRsp)(nil), // 0: HomeChangeModuleRsp
}
