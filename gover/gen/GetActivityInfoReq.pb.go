...
type GetActivityInfoReq struct {
	...
	ActivityIdList []uint32 `protobuf:"varint,7,rep,packed,name=activity_id_list,json=activityIdList,proto3" json:"activity_id_list,omitempty"`
}
...
var file_GetActivityInfoReq_proto_rawDesc = []byte{
	...
	0x6c, 0x69, 0x73, 0x74, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0e, 0x61, 0x63, 0x74, 0x69,
...
var file_GetActivityInfoReq_proto_goTypes = []interface{}{
	(*GetActivityInfoReq)(nil), // 0: GetActivityInfoReq
}
