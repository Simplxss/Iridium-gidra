...
type BrickBreakerDetailInfo struct {
	...
	GAAAMLJLIKD   []*BrickBreakerLevelInfo         `protobuf:"bytes,11,rep,name=GAAAMLJLIKD,proto3" json:"GAAAMLJLIKD,omitempty"`
	StageInfoList []*BrickBreakerActivityStageInfo `protobuf:"bytes,3,rep,name=stage_info_list,json=stageInfoList,proto3" json:"stage_info_list,omitempty"`
	SkillInfoMap  map[uint32]uint32                `protobuf:"bytes,10,rep,name=skill_info_map,json=skillInfoMap,proto3" json:"skill_info_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	BIBOJMLPCHL   []*BrickBreakerLevelInfo         `protobuf:"bytes,13,rep,name=BIBOJMLPCHL,proto3" json:"BIBOJMLPCHL,omitempty"`
}
...
func (x *BrickBreakerDetailInfo) GetGAAAMLJLIKD() []*BrickBreakerLevelInfo {
	if x != nil {
		return x.GAAAMLJLIKD
	}
	return nil
}
...
func (x *BrickBreakerDetailInfo) GetBIBOJMLPCHL() []*BrickBreakerLevelInfo {
	if x != nil {
		return x.BIBOJMLPCHL
	}
	return nil
}
...
var file_BrickBreakerDetailInfo_proto_rawDesc = []byte{
	...
	0x42, 0x72, 0x69, 0x63, 0x6b, 0x42, 0x72, 0x65, 0x61, 0x6b, 0x65, 0x72, 0x4c, 0x65, 0x76, 0x65,
	0x6c, 0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x23, 0x42, 0x72, 0x69,
	0x63, 0x6b, 0x42, 0x72, 0x65, 0x61, 0x6b, 0x65, 0x72, 0x41, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74,
	...
	,
	...
	0x0a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x42, 0x72, 0x69, 0x63, 0x6b, 0x42, 0x72, 0x65,
	...
	0x52, 0x0c, 0x73, 0x6b, 0x69, 0x6c, 0x6c, 0x49, 0x6e, 0x66, 0x6f, 0x4d, 0x61, 0x70, 0x12, 0x38,
	0x0a, 0x0b, 0x42, 0x49, 0x42, 0x4f, 0x4a, 0x4d, 0x4c, 0x50, 0x43, 0x48, 0x4c, 0x18, 0x0d, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x42, 0x72, 0x69, 0x63, 0x6b, 0x42, 0x72, 0x65, 0x61, 0x6b,
	0x65, 0x72, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x0b, 0x42, 0x49, 0x42,
	0x4f, 0x4a, 0x4d, 0x4c, 0x50, 0x43, 0x48, 0x4c, 0x1a, 0x3f, 0x0a, 0x11, 0x53, 0x6b, 0x69, 0x6c,
...
var file_BrickBreakerDetailInfo_proto_depIdxs = []int32{
	2, // 0: BrickBreakerDetailInfo.GAAAMLJLIKD:type_name -> BrickBreakerLevelInfo
	3, // 1: BrickBreakerDetailInfo.stage_info_list:type_name -> BrickBreakerActivityStageInfo
	1, // 2: BrickBreakerDetailInfo.skill_info_map:type_name -> BrickBreakerDetailInfo.SkillInfoMapEntry
	2, // 3: BrickBreakerDetailInfo.BIBOJMLPCHL:type_name -> BrickBreakerLevelInfo
