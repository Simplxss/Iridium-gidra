...
type EnterTrialAvatarActivityDungeonReq struct {
	...
	EnterPointId       uint32 `protobuf:"varint,2,opt,name=enter_point_id,json=enterPointId,proto3" json:"enter_point_id,omitempty"`
	ActivityId         uint32 `protobuf:"varint,10,opt,name=activity_id,json=activityId,proto3" json:"activity_id,omitempty"`
	TrialAvatarIndexId uint32 `protobuf:"varint,6,opt,name=trial_avatar_index_id,json=trialAvatarIndexId,proto3" json:"trial_avatar_index_id,omitempty"`
}
...
var file_EnterTrialAvatarActivityDungeonReq_proto_rawDesc = []byte{
	...
	0x69, 0x74, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x61, 0x63,
	...
	0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x12, 0x74, 0x72, 0x69, 0x61, 0x6c, 0x41, 0x76,
