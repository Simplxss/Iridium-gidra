...
type ScenePlayerInfoNotify struct {
	...
	PlayerInfoList []*ScenePlayerInfo `protobuf:"bytes,9,rep,name=player_info_list,json=playerInfoList,proto3" json:"player_info_list,omitempty"`
}
...
var file_ScenePlayerInfoNotify_proto_rawDesc = []byte{
	...
	0x74, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x53, 0x63, 0x65, 0x6e, 0x65, 0x50,
