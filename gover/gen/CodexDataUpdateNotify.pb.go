...
type CodexDataUpdateNotify struct {
	...
	Type                  CodexType `protobuf:"varint,7,opt,name=type,proto3,enum=CodexType" json:"type,omitempty"`
	Id                    uint32    `protobuf:"varint,4,opt,name=id,proto3" json:"id,omitempty"`
	WeaponMaxPromoteLevel uint32    `protobuf:"varint,1,opt,name=weapon_max_promote_level,json=weaponMaxPromoteLevel,proto3" json:"weapon_max_promote_level,omitempty"`
}
...
var file_CodexDataUpdateNotify_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x1e, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65,
	0x18, 0x07, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0a, 0x2e, 0x43, 0x6f, 0x64, 0x65, 0x78, 0x54, 0x79,
	0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x04,
	...
	0x65, 0x76, 0x65, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x15, 0x77, 0x65, 0x61, 0x70,
...
var file_CodexDataUpdateNotify_proto_goTypes = []interface{}{
	(*CodexDataUpdateNotify)(nil), // 0: CodexDataUpdateNotify
	(CodexType)(0),                // 1: CodexType
}
var file_CodexDataUpdateNotify_proto_depIdxs = []int32{
	1, // 0: CodexDataUpdateNotify.type:type_name -> CodexType
