...
type AiSkillCdInfo struct {
	...
	SkillCdMap      map[uint32]uint32 `protobuf:"bytes,6,rep,name=skill_cd_map,json=skillCdMap,proto3" json:"skill_cd_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	SkillGroupCdMap map[uint32]uint32 `protobuf:"bytes,11,rep,name=skill_group_cd_map,json=skillGroupCdMap,proto3" json:"skill_group_cd_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
var file_AiSkillCdInfo_proto_rawDesc = []byte{
	...
	0x5f, 0x63, 0x64, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e,
	...
	0x0b, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x41, 0x69, 0x53, 0x6b, 0x69, 0x6c, 0x6c, 0x43,
