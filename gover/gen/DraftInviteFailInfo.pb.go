...
type DraftInviteFailInfo struct {
	...
	Reason DraftInviteFailReason `protobuf:"varint,7,opt,name=reason,proto3,enum=DraftInviteFailReason" json:"reason,omitempty"`
}
...
var file_DraftInviteFailInfo_proto_rawDesc = []byte{
	...
	0x64, 0x12, 0x2e, 0x0a, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x18, 0x07, 0x20, 0x01, 0x28,
