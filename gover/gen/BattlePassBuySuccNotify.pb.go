...
type BattlePassBuySuccNotify struct {
	...
	KIAHMPEBJDL uint32       `protobuf:"varint,3,opt,name=KIAHMPEBJDL,proto3" json:"KIAHMPEBJDL,omitempty"`
	ItemList    []*ItemParam `protobuf:"bytes,2,rep,name=item_list,json=itemList,proto3" json:"item_list,omitempty"`
	IEGIKGOKEID uint32       `protobuf:"varint,11,opt,name=IEGIKGOKEID,proto3" json:"IEGIKGOKEID,omitempty"`
}
...
func (x *BattlePassBuySuccNotify) GetKIAHMPEBJDL() uint32 {
	if x != nil {
		return x.KIAHMPEBJDL
	}
	return 0
}
...
func (x *BattlePassBuySuccNotify) GetIEGIKGOKEID() uint32 {
	if x != nil {
		return x.IEGIKGOKEID
	}
	return 0
}
...
var file_BattlePassBuySuccNotify_proto_rawDesc = []byte{
	...
	,
