...
type StartCoopPointReq struct {
	...
	CoopPoint uint32 `protobuf:"varint,12,opt,name=coop_point,json=coopPoint,proto3" json:"coop_point,omitempty"`
}
...
var file_StartCoopPointReq_proto_rawDesc = []byte{
	...
	0x0a, 0x0a, 0x63, 0x6f, 0x6f, 0x70, 0x5f, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x18, 0x0c, 0x20, 0x01,
...
var file_StartCoopPointReq_proto_goTypes = []interface{}{
	(*StartCoopPointReq)(nil), // 0: StartCoopPointReq
}
