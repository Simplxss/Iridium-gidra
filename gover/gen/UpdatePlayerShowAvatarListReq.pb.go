...
type UpdatePlayerShowAvatarListReq struct {
	...
	ShowAvatarIdList []uint32 `protobuf:"varint,12,rep,packed,name=show_avatar_id_list,json=showAvatarIdList,proto3" json:"show_avatar_id_list,omitempty"`
}
...
var file_UpdatePlayerShowAvatarListReq_proto_rawDesc = []byte{
	...
	0x69, 0x73, 0x74, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x10, 0x73, 0x68, 0x6f, 0x77, 0x41,
