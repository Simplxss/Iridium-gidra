...
type TreasureMapRegionInfo struct {
	...
	HHEFCPDDMAH     uint32  `protobuf:"varint,6,opt,name=HHEFCPDDMAH,proto3" json:"HHEFCPDDMAH,omitempty"`
	...
	RegionId        uint32  `protobuf:"varint,14,opt,name=region_id,json=regionId,proto3" json:"region_id,omitempty"`
	MFILLAMOAHJ     uint32  `protobuf:"varint,15,opt,name=MFILLAMOAHJ,proto3" json:"MFILLAMOAHJ,omitempty"`
	ALKEKFFIMPL     bool    `protobuf:"varint,12,opt,name=ALKEKFFIMPL,proto3" json:"ALKEKFFIMPL,omitempty"`
	StartTime       uint32  `protobuf:"varint,5,opt,name=start_time,json=startTime,proto3" json:"start_time,omitempty"`
	IACKAEJAPLO     bool    `protobuf:"varint,3,opt,name=IACKAEJAPLO,proto3" json:"IACKAEJAPLO,omitempty"`
	SceneId         uint32  `protobuf:"varint,8,opt,name=scene_id,json=sceneId,proto3" json:"scene_id,omitempty"`
	RegionRadius    uint32  `protobuf:"varint,4,opt,name=region_radius,json=regionRadius,proto3" json:"region_radius,omitempty"`
}
...
func (x *TreasureMapRegionInfo) GetHHEFCPDDMAH() uint32 {
	if x != nil {
		return x.HHEFCPDDMAH
	}
	return 0
}
...
func (x *TreasureMapRegionInfo) GetMFILLAMOAHJ() uint32 {
	if x != nil {
		return x.MFILLAMOAHJ
	}
	return 0
}

func (x *TreasureMapRegionInfo) GetALKEKFFIMPL() bool {
	if x != nil {
		return x.ALKEKFFIMPL
	}
	return false
}
...
func (x *TreasureMapRegionInfo) GetIACKAEJAPLO() bool {
	if x != nil {
		return x.IACKAEJAPLO
	}
	return false
}
...
var file_TreasureMapRegionInfo_proto_rawDesc = []byte{
	...
	,
