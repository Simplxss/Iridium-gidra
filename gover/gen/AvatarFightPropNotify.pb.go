...
type AvatarFightPropNotify struct {
	...
	FightPropMap map[uint32]float32 `protobuf:"bytes,2,rep,name=fight_prop_map,json=fightPropMap,proto3" json:"fight_prop_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"fixed32,2,opt,name=value,proto3"`
...
var file_AvatarFightPropNotify_proto_rawDesc = []byte{
	...
	0x5f, 0x70, 0x72, 0x6f, 0x70, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32,
