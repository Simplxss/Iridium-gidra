...
type ExclusiveRuleInfo struct {
	...
	RuleType     uint32   `protobuf:"varint,9,opt,name=rule_type,json=ruleType,proto3" json:"rule_type,omitempty"`
	ObjectIdList []uint32 `protobuf:"varint,4,rep,packed,name=object_id_list,json=objectIdList,proto3" json:"object_id_list,omitempty"`
}
...
var file_ExclusiveRuleInfo_proto_rawDesc = []byte{
	...
	0x62, 0x6a, 0x65, 0x63, 0x74, 0x5f, 0x69, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x04, 0x20,
