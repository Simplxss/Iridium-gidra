...
type FireworksReformDataNotify struct {
	...
	FireworksReformDataList []*FireworksReformData `protobuf:"bytes,15,rep,name=fireworks_reform_data_list,json=fireworksReformDataList,proto3" json:"fireworks_reform_data_list,omitempty"`
}
