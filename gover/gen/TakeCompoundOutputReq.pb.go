...
type TakeCompoundOutputReq struct {
	...
	CompoundGroupId uint32 `protobuf:"varint,1,opt,name=compound_group_id,json=compoundGroupId,proto3" json:"compound_group_id,omitempty"`
...
var file_TakeCompoundOutputReq_proto_rawDesc = []byte{
	...
	0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x75, 0x6e,
...
var file_TakeCompoundOutputReq_proto_goTypes = []interface{}{
	(*TakeCompoundOutputReq)(nil), // 0: TakeCompoundOutputReq
}
