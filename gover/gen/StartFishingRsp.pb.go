...
type StartFishingRsp struct {
	...
	FishPoolId uint32 `protobuf:"varint,4,opt,name=fish_pool_id,json=fishPoolId,proto3" json:"fish_pool_id,omitempty"`
...
var file_StartFishingRsp_proto_rawDesc = []byte{
	...
	0x73, 0x68, 0x5f, 0x70, 0x6f, 0x6f, 0x6c, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d,
...
var file_StartFishingRsp_proto_goTypes = []interface{}{
	(*StartFishingRsp)(nil), // 0: StartFishingRsp
}
