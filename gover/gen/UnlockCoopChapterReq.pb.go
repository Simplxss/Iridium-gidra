...
type UnlockCoopChapterReq struct {
	...
	ChapterId uint32 `protobuf:"varint,8,opt,name=chapter_id,json=chapterId,proto3" json:"chapter_id,omitempty"`
}
...
var file_UnlockCoopChapterReq_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x63, 0x68, 0x61, 0x70, 0x74, 0x65,
...
var file_UnlockCoopChapterReq_proto_goTypes = []interface{}{
	(*UnlockCoopChapterReq)(nil), // 0: UnlockCoopChapterReq
}
