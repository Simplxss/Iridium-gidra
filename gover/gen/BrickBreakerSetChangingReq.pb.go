...
type BrickBreakerSetChangingReq struct {
	...
	IsChanging bool `protobuf:"varint,13,opt,name=is_changing,json=isChanging,proto3" json:"is_changing,omitempty"`
}
...
var file_BrickBreakerSetChangingReq_proto_rawDesc = []byte{
	...
	0x0d, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x69, 0x73, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x69, 0x6e,
