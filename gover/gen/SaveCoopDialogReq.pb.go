...
type SaveCoopDialogReq struct {
	...
	OHGJGOFMHNP uint32 `protobuf:"varint,9,opt,name=OHGJGOFMHNP,proto3" json:"OHGJGOFMHNP,omitempty"`
	IMOEGKJCNNL uint32 `protobuf:"varint,3,opt,name=IMOEGKJCNNL,proto3" json:"IMOEGKJCNNL,omitempty"`
}
...
func (x *SaveCoopDialogReq) GetOHGJGOFMHNP() uint32 {
	if x != nil {
...
func (x *SaveCoopDialogReq) GetIMOEGKJCNNL() uint32 {
	if x != nil {
...
var file_SaveCoopDialogReq_proto_rawDesc = []byte{
	...
	0x0a, 0x0b, 0x4f, 0x48, 0x47, 0x4a, 0x47, 0x4f, 0x46, 0x4d, 0x48, 0x4e, 0x50, 0x18, 0x09, 0x20,
	...
	0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x49, 0x4d, 0x4f, 0x45, 0x47, 0x4b, 0x4a, 0x43, 0x4e,
