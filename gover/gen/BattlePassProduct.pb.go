...
type BattlePassProduct struct {
	...
	HOJKADLEFBP string `protobuf:"bytes,7,opt,name=HOJKADLEFBP,proto3" json:"HOJKADLEFBP,omitempty"`
	CHOKHINHNGH string `protobuf:"bytes,14,opt,name=CHOKHINHNGH,proto3" json:"CHOKHINHNGH,omitempty"`
	NJCCJEMGKDJ string `protobuf:"bytes,5,opt,name=NJCCJEMGKDJ,proto3" json:"NJCCJEMGKDJ,omitempty"`
}
...
func (x *BattlePassProduct) GetHOJKADLEFBP() string {
	if x != nil {
		return x.HOJKADLEFBP
	}
	return ""
}

func (x *BattlePassProduct) GetCHOKHINHNGH() string {
	if x != nil {
		return x.CHOKHINHNGH
	}
	return ""
}

func (x *BattlePassProduct) GetNJCCJEMGKDJ() string {
	if x != nil {
		return x.NJCCJEMGKDJ
	}
	return ""
}
...
var file_BattlePassProduct_proto_rawDesc = []byte{
	...
	,
}
...
var file_BattlePassProduct_proto_goTypes = []interface{}{
	(*BattlePassProduct)(nil), // 0: BattlePassProduct
}
