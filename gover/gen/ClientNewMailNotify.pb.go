...
type ClientNewMailNotify struct {
	...
	CDIKCAIGHAE uint32 `protobuf:"varint,2,opt,name=CDIKCAIGHAE,proto3" json:"CDIKCAIGHAE,omitempty"`
	KJEEEDPFMFE uint32 `protobuf:"varint,6,opt,name=KJEEEDPFMFE,proto3" json:"KJEEEDPFMFE,omitempty"`
	IGMALOKLIPP bool   `protobuf:"varint,14,opt,name=IGMALOKLIPP,proto3" json:"IGMALOKLIPP,omitempty"`
}
...
func (x *ClientNewMailNotify) GetCDIKCAIGHAE() uint32 {
	if x != nil {
		return x.CDIKCAIGHAE
	}
	return 0
}

func (x *ClientNewMailNotify) GetKJEEEDPFMFE() uint32 {
	if x != nil {
		return x.KJEEEDPFMFE
	}
	return 0
}

func (x *ClientNewMailNotify) GetIGMALOKLIPP() bool {
	if x != nil {
		return x.IGMALOKLIPP
	}
	return false
}
...
var file_ClientNewMailNotify_proto_rawDesc = []byte{
	...
	0x66, 0x79, 0x12, 0x20, 0x0a, 0x0b, 0x43, 0x44, 0x49, 0x4b, 0x43, 0x41, 0x49, 0x47, 0x48, 0x41,
	0x45, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x43, 0x44, 0x49, 0x4b, 0x43, 0x41, 0x49,
	0x47, 0x48, 0x41, 0x45, 0x12, 0x20, 0x0a, 0x0b, 0x4b, 0x4a, 0x45, 0x45, 0x45, 0x44, 0x50, 0x46,
	0x4d, 0x46, 0x45, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x4b, 0x4a, 0x45, 0x45, 0x45,
	0x44, 0x50, 0x46, 0x4d, 0x46, 0x45, 0x12, 0x20, 0x0a, 0x0b, 0x49, 0x47, 0x4d, 0x41, 0x4c, 0x4f,
	0x4b, 0x4c, 0x49, 0x50, 0x50, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x49, 0x47, 0x4d,
	0x41, 0x4c, 0x4f, 0x4b, 0x4c, 0x49, 0x50, 0x50, 0x42, 0x06, 0x5a, 0x04, 0x2f, 0x67, 0x65, 0x6e,
