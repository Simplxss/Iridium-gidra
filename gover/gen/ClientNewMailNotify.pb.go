...
type ClientNewMailNotify struct {
	...
	BEGBPFBABMD uint32 `protobuf:"varint,3,opt,name=BEGBPFBABMD,proto3" json:"BEGBPFBABMD,omitempty"`
	CLHPNHOHONM bool   `protobuf:"varint,2,opt,name=CLHPNHOHONM,proto3" json:"CLHPNHOHONM,omitempty"`
	OEGCAHNJAMF uint32 `protobuf:"varint,14,opt,name=OEGCAHNJAMF,proto3" json:"OEGCAHNJAMF,omitempty"`
}
...
func (x *ClientNewMailNotify) GetBEGBPFBABMD() uint32 {
	if x != nil {
		return x.BEGBPFBABMD
	}
	return 0
}

func (x *ClientNewMailNotify) GetCLHPNHOHONM() bool {
	if x != nil {
		return x.CLHPNHOHONM
	}
	return false
}

func (x *ClientNewMailNotify) GetOEGCAHNJAMF() uint32 {
	if x != nil {
		return x.OEGCAHNJAMF
	}
	return 0
}
...
var file_ClientNewMailNotify_proto_rawDesc = []byte{
	...
	0x66, 0x79, 0x12, 0x20, 0x0a, 0x0b, 0x42, 0x45, 0x47, 0x42, 0x50, 0x46, 0x42, 0x41, 0x42, 0x4d,
	0x44, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x42, 0x45, 0x47, 0x42, 0x50, 0x46, 0x42,
	0x41, 0x42, 0x4d, 0x44, 0x12, 0x20, 0x0a, 0x0b, 0x43, 0x4c, 0x48, 0x50, 0x4e, 0x48, 0x4f, 0x48,
	0x4f, 0x4e, 0x4d, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x43, 0x4c, 0x48, 0x50, 0x4e,
	0x48, 0x4f, 0x48, 0x4f, 0x4e, 0x4d, 0x12, 0x20, 0x0a, 0x0b, 0x4f, 0x45, 0x47, 0x43, 0x41, 0x48,
	0x4e, 0x4a, 0x41, 0x4d, 0x46, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x4f, 0x45, 0x47,
	0x43, 0x41, 0x48, 0x4e, 0x4a, 0x41, 0x4d, 0x46, 0x42, 0x06, 0x5a, 0x04, 0x2f, 0x67, 0x65, 0x6e,
