...
type SceneGallerySandwormInfo struct {
	...
	EOFIKOMIALM bool        `protobuf:"varint,9,opt,name=EOFIKOMIALM,proto3" json:"EOFIKOMIALM,omitempty"`
	Energy      uint32      `protobuf:"varint,15,opt,name=energy,proto3" json:"energy,omitempty"`
	AOHLJOMAPLN DNKNPOGNOFP `protobuf:"varint,13,opt,name=AOHLJOMAPLN,proto3,enum=DNKNPOGNOFP" json:"AOHLJOMAPLN,omitempty"`
	ACAODPCJIOP uint32      `protobuf:"varint,7,opt,name=ACAODPCJIOP,proto3" json:"ACAODPCJIOP,omitempty"`
}
...
func (x *SceneGallerySandwormInfo) GetEOFIKOMIALM() bool {
	if x != nil {
		return x.EOFIKOMIALM
	}
	return false
}
...
func (x *SceneGallerySandwormInfo) GetAOHLJOMAPLN() DNKNPOGNOFP {
	if x != nil {
		return x.AOHLJOMAPLN
	}
	return DNKNPOGNOFP_DNKNPOGNOFP_SandwormCannonNoneEffect
}

func (x *SceneGallerySandwormInfo) GetACAODPCJIOP() uint32 {
	if x != nil {
		return x.ACAODPCJIOP
	}
	return 0
}
...
var file_SceneGallerySandwormInfo_proto_rawDesc = []byte{
	...
	0x1a, 0x11, 0x44, 0x4e, 0x4b, 0x4e, 0x50, 0x4f, 0x47, 0x4e, 0x4f, 0x46, 0x50, 0x2e, 0x70, 0x72,
	...
	,
...
var file_SceneGallerySandwormInfo_proto_goTypes = []interface{}{
	...
	(DNKNPOGNOFP)(0),                 // 1: DNKNPOGNOFP
}
var file_SceneGallerySandwormInfo_proto_depIdxs = []int32{
	1, // 0: SceneGallerySandwormInfo.AOHLJOMAPLN:type_name -> DNKNPOGNOFP
