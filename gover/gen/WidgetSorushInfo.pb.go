...
type WidgetSorushInfo struct {
	...
	MHMHPPJKAHM bool    `protobuf:"varint,14,opt,name=MHMHPPJKAHM,proto3" json:"MHMHPPJKAHM,omitempty"`
	JMOJHHHKHEL bool    `protobuf:"varint,7,opt,name=JMOJHHHKHEL,proto3" json:"JMOJHHHKHEL,omitempty"`
	Rot         *Vector `protobuf:"bytes,3,opt,name=rot,proto3" json:"rot,omitempty"`
	EOFNCKAMIKB bool    `protobuf:"varint,10,opt,name=EOFNCKAMIKB,proto3" json:"EOFNCKAMIKB,omitempty"`
...
func (x *WidgetSorushInfo) GetMHMHPPJKAHM() bool {
	if x != nil {
		return x.MHMHPPJKAHM
	}
	return false
}

func (x *WidgetSorushInfo) GetJMOJHHHKHEL() bool {
	if x != nil {
		return x.JMOJHHHKHEL
	}
	return false
}
...
func (x *WidgetSorushInfo) GetEOFNCKAMIKB() bool {
	if x != nil {
		return x.EOFNCKAMIKB
	}
	return false
}
...
var file_WidgetSorushInfo_proto_rawDesc = []byte{
	...
	,
...
var file_WidgetSorushInfo_proto_depIdxs = []int32{
	1, // 0: WidgetSorushInfo.rot:type_name -> Vector
	1, // 1: WidgetSorushInfo.pos:type_name -> Vector
