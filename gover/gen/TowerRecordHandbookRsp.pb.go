...
type TowerRecordHandbookRsp struct {
	...
	MonthlyDetailList []*TowerMonthlyDetail `protobuf:"bytes,9,rep,name=monthly_detail_list,json=monthlyDetailList,proto3" json:"monthly_detail_list,omitempty"`
}
...
var file_TowerRecordHandbookRsp_proto_rawDesc = []byte{
	...
	0x69, 0x73, 0x74, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x54, 0x6f, 0x77, 0x65,
