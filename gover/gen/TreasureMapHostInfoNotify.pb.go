...
type TreasureMapHostInfoNotify struct {
	...
	MpChallengeRegionList []uint32 `protobuf:"varint,15,rep,packed,name=mp_challenge_region_list,json=mpChallengeRegionList,proto3" json:"mp_challenge_region_list,omitempty"`
}
...
var file_TreasureMapHostInfoNotify_proto_rawDesc = []byte{
	...
	0x65, 0x67, 0x69, 0x6f, 0x6e, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0f, 0x20, 0x03, 0x28, 0x0d,
...
var file_TreasureMapHostInfoNotify_proto_goTypes = []interface{}{
	(*TreasureMapHostInfoNotify)(nil), // 0: TreasureMapHostInfoNotify
}
