...
type HomeGetArrangementInfoReq struct {
	...
	SceneIdList []uint32 `protobuf:"varint,7,rep,packed,name=scene_id_list,json=sceneIdList,proto3" json:"scene_id_list,omitempty"`
}
...
var file_HomeGetArrangementInfoReq_proto_rawDesc = []byte{
	...
	0x07, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x73, 0x63, 0x65, 0x6e, 0x65, 0x49, 0x64, 0x4c, 0x69,
