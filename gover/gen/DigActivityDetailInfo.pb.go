...
type DigActivityDetailInfo struct {
	...
	StageIdList      []uint32        `protobuf:"varint,1,rep,packed,name=stage_id_list,json=stageIdList,proto3" json:"stage_id_list,omitempty"`
	DigMarkPointList []*DigMarkPoint `protobuf:"bytes,13,rep,name=dig_mark_point_list,json=digMarkPointList,proto3" json:"dig_mark_point_list,omitempty"`
}
...
var file_DigActivityDetailInfo_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x73,
	...
	0x74, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x44, 0x69, 0x67, 0x4d, 0x61, 0x72,
