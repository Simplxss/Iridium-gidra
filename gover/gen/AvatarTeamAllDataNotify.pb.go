...
type AvatarTeamAllDataNotify struct {
	...
	AvatarTeamMap             map[uint32]*AvatarTeam `protobuf:"bytes,4,rep,name=avatar_team_map,json=avatarTeamMap,proto3" json:"avatar_team_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
var file_AvatarTeamAllDataNotify_proto_rawDesc = []byte{
	...
	0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x41, 0x76, 0x61, 0x74, 0x61, 0x72, 0x54,
