...
type CombineDataNotify struct {
	...
	CombineIdList []uint32 `protobuf:"varint,15,rep,packed,name=combine_id_list,json=combineIdList,proto3" json:"combine_id_list,omitempty"`
}
...
var file_CombineDataNotify_proto_rawDesc = []byte{
	...
	0x74, 0x18, 0x0f, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0d, 0x63, 0x6f, 0x6d, 0x62, 0x69, 0x6e, 0x65,
...
var file_CombineDataNotify_proto_goTypes = []interface{}{
	(*CombineDataNotify)(nil), // 0: CombineDataNotify
}
