...
type ForceDragAvatarNotify struct {
	...
	IsFirstValid bool        `protobuf:"varint,5,opt,name=is_first_valid,json=isFirstValid,proto3" json:"is_first_valid,omitempty"`
	EntityId     uint32      `protobuf:"varint,9,opt,name=entity_id,json=entityId,proto3" json:"entity_id,omitempty"`
	LFMPHLPNICH  uint64      `protobuf:"varint,6,opt,name=LFMPHLPNICH,proto3" json:"LFMPHLPNICH,omitempty"`
	GCPALFFBPPJ  uint64      `protobuf:"varint,10,opt,name=GCPALFFBPPJ,proto3" json:"GCPALFFBPPJ,omitempty"`
	MotionInfo   *MotionInfo `protobuf:"bytes,1,opt,name=motion_info,json=motionInfo,proto3" json:"motion_info,omitempty"`
...
func (x *ForceDragAvatarNotify) GetLFMPHLPNICH() uint64 {
	if x != nil {
		return x.LFMPHLPNICH
	}
	return 0
}

func (x *ForceDragAvatarNotify) GetGCPALFFBPPJ() uint64 {
	if x != nil {
		return x.GCPALFFBPPJ
	}
	return 0
}
...
var file_ForceDragAvatarNotify_proto_rawDesc = []byte{
	...
	,
	...
	0x28, 0x0d, 0x52, 0x09, 0x73, 0x63, 0x65, 0x6e, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x42, 0x06, 0x5a,
