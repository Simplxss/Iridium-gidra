...
type CutSceneFinishNotify struct {
	...
	CutsceneId uint32 `protobuf:"varint,2,opt,name=cutscene_id,json=cutsceneId,proto3" json:"cutscene_id,omitempty"`
}
...
var file_CutSceneFinishNotify_proto_rawDesc = []byte{
	...
	0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x63, 0x75, 0x74, 0x73, 0x63,
...
var file_CutSceneFinishNotify_proto_goTypes = []interface{}{
	(*CutSceneFinishNotify)(nil), // 0: CutSceneFinishNotify
}
