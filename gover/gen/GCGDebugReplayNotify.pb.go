...
type GCGDebugReplayNotify struct {
	...
	JsonStr string `protobuf:"bytes,8,opt,name=json_str,json=jsonStr,proto3" json:"json_str,omitempty"`
}
...
var file_GCGDebugReplayNotify_proto_rawDesc = []byte{
	...
	0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6a, 0x73, 0x6f, 0x6e, 0x53, 0x74, 0x72, 0x42,
