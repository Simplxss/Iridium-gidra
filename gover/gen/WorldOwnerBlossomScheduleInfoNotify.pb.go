...
type WorldOwnerBlossomScheduleInfoNotify struct {
	...
	ScheduleInfo *BlossomScheduleInfo `protobuf:"bytes,1,opt,name=schedule_info,json=scheduleInfo,proto3" json:"schedule_info,omitempty"`
}
...
var file_WorldOwnerBlossomScheduleInfoNotify_proto_rawDesc = []byte{
	...
	0x0d, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x01,
