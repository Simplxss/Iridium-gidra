...
type AranaraCollectionSuite struct {
	...
	CollectionIdStateMap map[uint32]AranaraCollectionState `protobuf:"bytes,11,rep,name=collection_id_state_map,json=collectionIdStateMap,proto3" json:"collection_id_state_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3,enum=AranaraCollectionState"`
}
...
var file_AranaraCollectionSuite_proto_rawDesc = []byte{
	...
	0x64, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x0b, 0x20, 0x03, 0x28,
