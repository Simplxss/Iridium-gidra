...
type HomeLimitedShopInfo struct {
	...
	PCECKPDEEBD uint32  `protobuf:"fixed32,13,opt,name=PCECKPDEEBD,proto3" json:"PCECKPDEEBD,omitempty"`
	IMBFLHNJAPD uint32  `protobuf:"fixed32,6,opt,name=IMBFLHNJAPD,proto3" json:"IMBFLHNJAPD,omitempty"`
	LMJPHDCDAJK uint32  `protobuf:"fixed32,15,opt,name=LMJPHDCDAJK,proto3" json:"LMJPHDCDAJK,omitempty"`
	DjinnRot    *Vector `protobuf:"bytes,7,opt,name=djinn_rot,json=djinnRot,proto3" json:"djinn_rot,omitempty"`
	DjinnPos    *Vector `protobuf:"bytes,8,opt,name=djinn_pos,json=djinnPos,proto3" json:"djinn_pos,omitempty"`
...
func (x *HomeLimitedShopInfo) GetPCECKPDEEBD() uint32 {
	if x != nil {
		return x.PCECKPDEEBD
	}
	return 0
}

func (x *HomeLimitedShopInfo) GetIMBFLHNJAPD() uint32 {
	if x != nil {
		return x.IMBFLHNJAPD
	}
	return 0
}

func (x *HomeLimitedShopInfo) GetLMJPHDCDAJK() uint32 {
	if x != nil {
		return x.LMJPHDCDAJK
	}
	return 0
}
...
var file_HomeLimitedShopInfo_proto_rawDesc = []byte{
	...
	,
...
var file_HomeLimitedShopInfo_proto_goTypes = []interface{}{
	(*HomeLimitedShopInfo)(nil), // 0: HomeLimitedShopInfo
	(*Vector)(nil),              // 1: Vector
}
var file_HomeLimitedShopInfo_proto_depIdxs = []int32{
	1, // 0: HomeLimitedShopInfo.djinn_rot:type_name -> Vector
	1, // 1: HomeLimitedShopInfo.djinn_pos:type_name -> Vector
