...
type AbilityMixinShootFromCamera struct {
	...
	InitPos *Vector `protobuf:"bytes,4,opt,name=InitPos,proto3" json:"InitPos,omitempty"`
	Forward *Vector `protobuf:"bytes,11,opt,name=forward,proto3" json:"forward,omitempty"`
}
...
var file_AbilityMixinShootFromCamera_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x63, 0x0a, 0x1b, 0x41, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x4d, 0x69, 0x78, 0x69,
	0x6e, 0x53, 0x68, 0x6f, 0x6f, 0x74, 0x46, 0x72, 0x6f, 0x6d, 0x43, 0x61, 0x6d, 0x65, 0x72, 0x61,
	0x12, 0x21, 0x0a, 0x07, 0x49, 0x6e, 0x69, 0x74, 0x50, 0x6f, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x07, 0x2e, 0x56, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x52, 0x07, 0x49, 0x6e, 0x69, 0x74,
	0x50, 0x6f, 0x73, 0x12, 0x21, 0x0a, 0x07, 0x66, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x18, 0x0b,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x07, 0x2e, 0x56, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x52, 0x07, 0x66,
	0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x42, 0x06, 0x5a, 0x04, 0x2f, 0x67, 0x65, 0x6e, 0x62, 0x06,
...
var file_AbilityMixinShootFromCamera_proto_depIdxs = []int32{
	1, // 0: AbilityMixinShootFromCamera.InitPos:type_name -> Vector
	1, // 1: AbilityMixinShootFromCamera.forward:type_name -> Vector
