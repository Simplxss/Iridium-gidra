...
type MuqadasPotionActivityDetailInfo struct {
	...
	MuqadasPotionLevelDataList []*MuqadasPotionLevelData `protobuf:"bytes,13,rep,name=muqadas_potion_level_data_list,json=muqadasPotionLevelDataList,proto3" json:"muqadas_potion_level_data_list,omitempty"`
}
