...
type SceneGalleryBrokenFloorInfo struct {
	...
	FallCountMap map[uint32]uint32 `protobuf:"bytes,14,rep,name=fall_count_map,json=fallCountMap,proto3" json:"fall_count_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
var file_SceneGalleryBrokenFloorInfo_proto_rawDesc = []byte{
	...
	0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x54,
	0x0a, 0x0e, 0x66, 0x61, 0x6c, 0x6c, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x6d, 0x61, 0x70,
	0x18, 0x0e, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x53, 0x63, 0x65, 0x6e, 0x65, 0x47, 0x61,
...
var file_SceneGalleryBrokenFloorInfo_proto_goTypes = []interface{}{
	(*SceneGalleryBrokenFloorInfo)(nil), // 0: SceneGalleryBrokenFloorInfo
	nil,                                 // 1: SceneGalleryBrokenFloorInfo.FallCountMapEntry
}
var file_SceneGalleryBrokenFloorInfo_proto_depIdxs = []int32{
	1, // 0: SceneGalleryBrokenFloorInfo.fall_count_map:type_name -> SceneGalleryBrokenFloorInfo.FallCountMapEntry
