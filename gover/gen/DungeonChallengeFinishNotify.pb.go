...
type DungeonChallengeFinishNotify struct {
	...
	ChallengeRecordType    uint32                          `protobuf:"varint,6,opt,name=challengeRecordType,proto3" json:"challengeRecordType,omitempty"`
	...
	CurrentValue           uint32                          `protobuf:"varint,11,opt,name=currentValue,proto3" json:"currentValue,omitempty"`
	StrengthenPointDataMap map[uint32]*StrengthenPointData `protobuf:"bytes,9,rep,name=strengthen_point_data_map,json=strengthenPointDataMap,proto3" json:"strengthen_point_data_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	IsSuccess              bool                            `protobuf:"varint,4,opt,name=is_success,json=isSuccess,proto3" json:"is_success,omitempty"`
	FinishType             ChallengeFinishType             `protobuf:"varint,15,opt,name=finish_type,json=finishType,proto3,enum=ChallengeFinishType" json:"finish_type,omitempty"`
...
type DungeonChallengeFinishNotify_ChannellerSlabLoopDungeonResultInfo struct {
	ChannellerSlabLoopDungeonResultInfo *ChannellerSlabLoopDungeonResultInfo `protobuf:"bytes,1334,opt,name=channeller_slab_loop_dungeon_result_info,json=channellerSlabLoopDungeonResultInfo,proto3,oneof"`
}

type DungeonChallengeFinishNotify_EffigyChallengeDungeonResultInfo struct {
	EffigyChallengeDungeonResultInfo *EffigyChallengeDungeonResultInfo `protobuf:"bytes,72,opt,name=effigy_challenge_dungeon_result_info,json=effigyChallengeDungeonResultInfo,proto3,oneof"`
}

type DungeonChallengeFinishNotify_PotionDungeonResultInfo struct {
	PotionDungeonResultInfo *PotionDungeonResultInfo `protobuf:"bytes,1530,opt,name=potion_dungeon_result_info,json=potionDungeonResultInfo,proto3,oneof"`
}

type DungeonChallengeFinishNotify_CustomDungeonResultInfo struct {
	CustomDungeonResultInfo *CustomDungeonResultInfo `protobuf:"bytes,1095,opt,name=custom_dungeon_result_info,json=customDungeonResultInfo,proto3,oneof"`
}
...
var file_DungeonChallengeFinishNotify_proto_rawDesc = []byte{
	...
	0x19, 0x43, 0x68, 0x61, 0x6c, 0x6c, 0x65, 0x6e, 0x67, 0x65, 0x46, 0x69, 0x6e, 0x69, 0x73, 0x68,
	0x54, 0x79, 0x70, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x29, 0x43, 0x68, 0x61, 0x6e,
	...
	,
	...
	0x61, 0x70, 0x12, 0x1d, 0x0a, 0x0a, 0x69, 0x73, 0x5f, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09, 0x69, 0x73, 0x53, 0x75, 0x63, 0x63, 0x65, 0x73,
	0x73, 0x12, 0x35, 0x0a, 0x0b, 0x66, 0x69, 0x6e, 0x69, 0x73, 0x68, 0x5f, 0x74, 0x79, 0x70, 0x65,
	0x18, 0x0f, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x43, 0x68, 0x61, 0x6c, 0x6c, 0x65, 0x6e,
	0x67, 0x65, 0x46, 0x69, 0x6e, 0x69, 0x73, 0x68, 0x54, 0x79, 0x70, 0x65, 0x52, 0x0a, 0x66, 0x69,
	0x6e, 0x69, 0x73, 0x68, 0x54, 0x79, 0x70, 0x65, 0x12, 0x7e, 0x0a, 0x28, 0x63, 0x68, 0x61, 0x6e,
	...
	0x69, 0x6e, 0x66, 0x6f, 0x18, 0xb6, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x43, 0x68,
	...
	0x73, 0x75, 0x6c, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x73, 0x0a, 0x24, 0x65, 0x66, 0x66, 0x69,
	...
	0x18, 0x48, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x45, 0x66, 0x66, 0x69, 0x67, 0x79, 0x43,
	...
	,
...
var file_DungeonChallengeFinishNotify_proto_depIdxs = []int32{
	...
	2, // 1: DungeonChallengeFinishNotify.finish_type:type_name -> ChallengeFinishType
