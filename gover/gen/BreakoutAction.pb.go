...
type BreakoutAction struct {
	...
	HPPJKHIDMIF         uint64                            `protobuf:"varint,18,opt,name=HPPJKHIDMIF,proto3" json:"HPPJKHIDMIF,omitempty"`
}
...
func (x *BreakoutAction) GetHPPJKHIDMIF() uint64 {
	if x != nil {
		return x.HPPJKHIDMIF
	}
	return 0
}
...
var file_BreakoutAction_proto_rawDesc = []byte{
	...
	0x05, 0x52, 0x06, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x12, 0x20, 0x0a, 0x0b, 0x48, 0x50, 0x50,
	0x4a, 0x4b, 0x48, 0x49, 0x44, 0x4d, 0x49, 0x46, 0x18, 0x12, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0b,
	0x48, 0x50, 0x50, 0x4a, 0x4b, 0x48, 0x49, 0x44, 0x4d, 0x49, 0x46, 0x22, 0x9e, 0x01, 0x0a, 0x12,
