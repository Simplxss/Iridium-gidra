...
type EvtFaceToEntityNotify struct {
	...
	FaceEntityId uint32      `protobuf:"varint,7,opt,name=face_entity_id,json=faceEntityId,proto3" json:"face_entity_id,omitempty"`
...
var file_EvtFaceToEntityNotify_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x5f, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01,
