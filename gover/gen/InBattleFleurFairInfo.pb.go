...
type InBattleFleurFairInfo struct {
	...
	FLKGLKPOEDP []uint32 `protobuf:"varint,10,rep,packed,name=FLKGLKPOEDP,proto3" json:"FLKGLKPOEDP,omitempty"`
	IAMBDCLBBNB uint32   `protobuf:"varint,11,opt,name=IAMBDCLBBNB,proto3" json:"IAMBDCLBBNB,omitempty"`
	GBFDDCJFLGO []uint32 `protobuf:"varint,8,rep,packed,name=GBFDDCJFLGO,proto3" json:"GBFDDCJFLGO,omitempty"`
	MLBGMECACGJ uint32   `protobuf:"varint,12,opt,name=MLBGMECACGJ,proto3" json:"MLBGMECACGJ,omitempty"`
	NEGAECFDEBD uint32   `protobuf:"varint,6,opt,name=NEGAECFDEBD,proto3" json:"NEGAECFDEBD,omitempty"`
}
...
func (x *InBattleFleurFairInfo) GetFLKGLKPOEDP() []uint32 {
	if x != nil {
		return x.FLKGLKPOEDP
	}
	return nil
}

func (x *InBattleFleurFairInfo) GetIAMBDCLBBNB() uint32 {
	if x != nil {
		return x.IAMBDCLBBNB
	}
	return 0
}

func (x *InBattleFleurFairInfo) GetGBFDDCJFLGO() []uint32 {
	if x != nil {
		return x.GBFDDCJFLGO
	}
	return nil
}

func (x *InBattleFleurFairInfo) GetMLBGMECACGJ() uint32 {
	if x != nil {
		return x.MLBGMECACGJ
	}
	return 0
}

func (x *InBattleFleurFairInfo) GetNEGAECFDEBD() uint32 {
	if x != nil {
		return x.NEGAECFDEBD
	}
	return 0
}
...
var file_InBattleFleurFairInfo_proto_rawDesc = []byte{
	...
	,
}
