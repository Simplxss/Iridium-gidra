...
type InBattleFleurFairInfo struct {
	...
	CHEAJDKKPDB uint32   `protobuf:"varint,4,opt,name=CHEAJDKKPDB,proto3" json:"CHEAJDKKPDB,omitempty"`
	DCFOAPKHMAK []uint32 `protobuf:"varint,9,rep,packed,name=DCFOAPKHMAK,proto3" json:"DCFOAPKHMAK,omitempty"`
	KMGIKOOKPOB uint32   `protobuf:"varint,8,opt,name=KMGIKOOKPOB,proto3" json:"KMGIKOOKPOB,omitempty"`
	LPOCDLNJLBH uint32   `protobuf:"varint,1,opt,name=LPOCDLNJLBH,proto3" json:"LPOCDLNJLBH,omitempty"`
	DNCLCJMNNLK []uint32 `protobuf:"varint,5,rep,packed,name=DNCLCJMNNLK,proto3" json:"DNCLCJMNNLK,omitempty"`
}
...
func (x *InBattleFleurFairInfo) GetCHEAJDKKPDB() uint32 {
	if x != nil {
...
func (x *InBattleFleurFairInfo) GetDCFOAPKHMAK() []uint32 {
	if x != nil {
		return x.DCFOAPKHMAK
	}
	return nil
}

func (x *InBattleFleurFairInfo) GetKMGIKOOKPOB() uint32 {
	if x != nil {
		return x.KMGIKOOKPOB
	}
	return 0
}

func (x *InBattleFleurFairInfo) GetLPOCDLNJLBH() uint32 {
	if x != nil {
		return x.LPOCDLNJLBH
	}
	return 0
}

func (x *InBattleFleurFairInfo) GetDNCLCJMNNLK() []uint32 {
	if x != nil {
		return x.DNCLCJMNNLK
	}
	return nil
}
...
var file_InBattleFleurFairInfo_proto_rawDesc = []byte{
	...
	,
