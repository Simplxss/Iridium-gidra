...
type GravenInnocenceCampInfo struct {
	...
	StageInfoList []*GravenInnocenceCampStageInfo `protobuf:"bytes,6,rep,name=stage_info_list,json=stageInfoList,proto3" json:"stage_info_list,omitempty"`
}
...
var file_GravenInnocenceCampInfo_proto_rawDesc = []byte{
	...
	0x74, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x47, 0x72, 0x61, 0x76, 0x65, 0x6e,
