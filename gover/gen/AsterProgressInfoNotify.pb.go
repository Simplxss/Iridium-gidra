...
type AsterProgressInfoNotify struct {
	...
	Info *AsterProgressDetailInfo `protobuf:"bytes,4,opt,name=info,proto3" json:"info,omitempty"`
}
...
var file_AsterProgressInfoNotify_proto_rawDesc = []byte{
	...
	0x6f, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x41, 0x73, 0x74, 0x65, 0x72, 0x50,
