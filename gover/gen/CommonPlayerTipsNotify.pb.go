...
type CommonPlayerTipsNotify struct {
	...
	NotifyType    uint32   `protobuf:"varint,14,opt,name=notify_type,json=notifyType,proto3" json:"notify_type,omitempty"`
	TextMapIdList []string `protobuf:"bytes,15,rep,name=text_map_id_list,json=textMapIdList,proto3" json:"text_map_id_list,omitempty"`
}
...
var file_CommonPlayerTipsNotify_proto_rawDesc = []byte{
	...
	0x66, 0x79, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x6e,
	0x6f, 0x74, 0x69, 0x66, 0x79, 0x54, 0x79, 0x70, 0x65, 0x12, 0x27, 0x0a, 0x10, 0x74, 0x65, 0x78,
	0x74, 0x5f, 0x6d, 0x61, 0x70, 0x5f, 0x69, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0f, 0x20,
...
var file_CommonPlayerTipsNotify_proto_goTypes = []interface{}{
	(*CommonPlayerTipsNotify)(nil), // 0: CommonPlayerTipsNotify
}
