...
type GCGSkillPreviewOnstageChangeInfo struct {
	...
	DDICNPEPEMI uint32 `protobuf:"varint,2,opt,name=DDICNPEPEMI,proto3" json:"DDICNPEPEMI,omitempty"`
	JMADKMJOCFO uint32 `protobuf:"varint,8,opt,name=JMADKMJOCFO,proto3" json:"JMADKMJOCFO,omitempty"`
}
...
func (x *GCGSkillPreviewOnstageChangeInfo) GetDDICNPEPEMI() uint32 {
	if x != nil {
		return x.DDICNPEPEMI
	}
	return 0
}

func (x *GCGSkillPreviewOnstageChangeInfo) GetJMADKMJOCFO() uint32 {
	if x != nil {
		return x.JMADKMJOCFO
	}
	return 0
}
...
var file_GCGSkillPreviewOnstageChangeInfo_proto_rawDesc = []byte{
	...
	0x44, 0x44, 0x49, 0x43, 0x4e, 0x50, 0x45, 0x50, 0x45, 0x4d, 0x49, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0d, 0x52, 0x0b, 0x44, 0x44, 0x49, 0x43, 0x4e, 0x50, 0x45, 0x50, 0x45, 0x4d, 0x49, 0x12, 0x20,
	0x0a, 0x0b, 0x4a, 0x4d, 0x41, 0x44, 0x4b, 0x4d, 0x4a, 0x4f, 0x43, 0x46, 0x4f, 0x18, 0x08, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x0b, 0x4a, 0x4d, 0x41, 0x44, 0x4b, 0x4d, 0x4a, 0x4f, 0x43, 0x46, 0x4f,
