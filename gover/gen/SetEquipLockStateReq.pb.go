...
type SetEquipLockStateReq struct {
	...
	TargetEquipGuid uint64 `protobuf:"varint,12,opt,name=target_equip_guid,json=targetEquipGuid,proto3" json:"target_equip_guid,omitempty"`
}
...
var file_SetEquipLockStateReq_proto_rawDesc = []byte{
	...
	0x70, 0x5f, 0x67, 0x75, 0x69, 0x64, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0f, 0x74, 0x61,
