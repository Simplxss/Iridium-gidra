...
type LunchBoxData struct {
	...
	SlotMaterialMap map[uint32]uint32 `protobuf:"bytes,8,rep,name=slot_material_map,json=slotMaterialMap,proto3" json:"slot_material_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
var file_LunchBoxData_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x08, 0x20, 0x03, 0x28, 0x0b,
