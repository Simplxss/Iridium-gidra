...
type GetInvestigationMonsterReq struct {
	...
	IsForMark  bool     `protobuf:"varint,12,opt,name=is_for_mark,json=isForMark,proto3" json:"is_for_mark,omitempty"`
	CityIdList []uint32 `protobuf:"varint,6,rep,packed,name=city_id_list,json=cityIdList,proto3" json:"city_id_list,omitempty"`
}
...
var file_GetInvestigationMonsterReq_proto_rawDesc = []byte{
	...
	0x0c, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09, 0x69, 0x73, 0x46, 0x6f, 0x72, 0x4d, 0x61, 0x72, 0x6b,
	0x12, 0x20, 0x0a, 0x0c, 0x63, 0x69, 0x74, 0x79, 0x5f, 0x69, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74,
	0x18, 0x06, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0a, 0x63, 0x69, 0x74, 0x79, 0x49, 0x64, 0x4c, 0x69,
...
var file_GetInvestigationMonsterReq_proto_goTypes = []interface{}{
	(*GetInvestigationMonsterReq)(nil), // 0: GetInvestigationMonsterReq
}
