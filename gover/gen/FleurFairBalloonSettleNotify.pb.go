...
type FleurFairBalloonSettleNotify struct {
	...
	SettleInfoMap map[uint32]*FleurFairBalloonSettleInfo `protobuf:"bytes,1,rep,name=settle_info_map,json=settleInfoMap,proto3" json:"settle_info_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_FleurFairBalloonSettleNotify_proto_rawDesc = []byte{
	...
	0x6c, 0x65, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x01, 0x20, 0x03, 0x28,
