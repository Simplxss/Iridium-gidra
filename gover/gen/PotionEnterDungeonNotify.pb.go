...
type PotionEnterDungeonNotify struct {
	...
	ModeId            uint32                 `protobuf:"varint,9,opt,name=mode_id,json=modeId,proto3" json:"mode_id,omitempty"`
	DifficultyLevel   uint32                 `protobuf:"varint,6,opt,name=difficulty_level,json=difficultyLevel,proto3" json:"difficulty_level,omitempty"`
	StageId           uint32                 `protobuf:"varint,7,opt,name=stage_id,json=stageId,proto3" json:"stage_id,omitempty"`
	DungeonAvatarList []*PotionDungeonAvatar `protobuf:"bytes,2,rep,name=dungeon_avatar_list,json=dungeonAvatarList,proto3" json:"dungeon_avatar_list,omitempty"`
}
...
var file_PotionEnterDungeonNotify_proto_rawDesc = []byte{
	...
	0x6c, 0x49, 0x64, 0x12, 0x17, 0x0a, 0x07, 0x6d, 0x6f, 0x64, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x09,
	...
	0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0f, 0x64, 0x69, 0x66, 0x66, 0x69, 0x63, 0x75, 0x6c,
	0x74, 0x79, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x12, 0x19, 0x0a, 0x08, 0x73, 0x74, 0x61, 0x67, 0x65,
	...
	0x61, 0x74, 0x61, 0x72, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32,
