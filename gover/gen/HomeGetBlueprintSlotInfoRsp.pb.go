...
type HomeGetBlueprintSlotInfoRsp struct {
	...
	DeleteSlotIdList []uint32                 `protobuf:"varint,4,rep,packed,name=delete_slot_id_list,json=deleteSlotIdList,proto3" json:"delete_slot_id_list,omitempty"`
	SlotInfoList     []*HomeBlueprintSlotInfo `protobuf:"bytes,2,rep,name=slot_info_list,json=slotInfoList,proto3" json:"slot_info_list,omitempty"`
...
var file_HomeGetBlueprintSlotInfoRsp_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x10, 0x64,
	...
	0x74, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x48, 0x6f, 0x6d, 0x65, 0x42, 0x6c,
