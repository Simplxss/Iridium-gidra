...
type UpdateAbilityCreatedMovingPlatformNotify struct {
	...
	OpType   UpdateAbilityCreatedMovingPlatformNotify_OpType `protobuf:"varint,12,opt,name=op_type,json=opType,proto3,enum=UpdateAbilityCreatedMovingPlatformNotify_OpType" json:"op_type,omitempty"`
