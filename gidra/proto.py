...
class AvatarRenameAuditSourceType(betterproto.Enum):
...
class ResetAvatarRenameReason(betterproto.Enum):
...
class AbilityIdentifier(betterproto.Message):
    instanced_ability_id: int = betterproto.uint32_field(4)
    modifier_owner_id: int = betterproto.uint32_field(10)
    is_serverbuff_modifier: bool = betterproto.bool_field(14)
    local_id: int = betterproto.int32_field(7)
    ability_caster_id: int = betterproto.uint32_field(1)
...
class AbilityMetaElementReactionVisual(betterproto.Message):
    element_source_type: int = betterproto.uint32_field(6)
    element_reactor_type: int = betterproto.uint32_field(1)
    hit_index: int = betterproto.int32_field(14)
    element_reaction_type: int = betterproto.uint32_field(2)
...
class AbilityMetaModifierChange(betterproto.Message):
    ...
    is_mute_remote: bool = betterproto.bool_field(12)
    modifier_local_id: int = betterproto.int32_field(2)
    is_durability_zero: bool = betterproto.bool_field(8)
...
class AbilityMetaModifierDurabilityChange(betterproto.Message):
    remain_durability: float = betterproto.float_field(13)
...
class AbilityMetaTriggerElementReaction(betterproto.Message):
    ...
    element_source_type: int = betterproto.uint32_field(13)
    element_reaction_type: int = betterproto.uint32_field(12)
    element_reactor_type: int = betterproto.uint32_field(2)


@dataclass(eq=False, repr=False)
class AbilityMetaUpdateBaseReactionDamage(betterproto.Message):
    reaction_type: int = betterproto.uint32_field(2)
    source_caster_id: int = betterproto.uint32_field(13)
...
class ActivityCondStateChangeNotify(betterproto.Message):
    ...
    expire_cond_list: List[int] = betterproto.uint32_field(1)
    meet_cond_list: List[int] = betterproto.uint32_field(4)
...
class ActivityInfo(betterproto.Message):
    ...
    schedule_id: int = betterproto.uint32_field(7)
    score_limit: int = betterproto.uint32_field(1870)
    unk3300_icnjjkdhpch: bool = betterproto.bool_field(14)
    meet_cond_list: List[int] = betterproto.uint32_field(11)
    ...
    selected_avatar_reward_id: int = betterproto.uint32_field(697)
    activity_coin_map: Dict[int, int] = betterproto.map_field(
    ...
    activity_type: int = betterproto.uint32_field(3)
    ...
    expire_cond_list: List[int] = betterproto.uint32_field(5)
...
class AttackHitEffectResult(betterproto.Message):
    air_strength: float = betterproto.float_field(13)
    hit_halt_time_scale: float = betterproto.float_field(10)
    hit_halt_time: float = betterproto.float_field(9)
    unk3300_lckecjckkjk: int = betterproto.uint32_field(8)
    unk3300_klngdammfif: int = betterproto.uint32_field(1)
    retreat_strength: float = betterproto.float_field(3)
...
class AttackResult(betterproto.Message):
    ...
    target_type: int = betterproto.uint32_field(1870)
    endure_delta: float = betterproto.float_field(803)
    ...
    hashed_anim_event_id: int = betterproto.uint32_field(1115)
    critical_rand: int = betterproto.uint32_field(645)
    ...
    endure_break: int = betterproto.uint32_field(14)
    ability_identifier: "AbilityIdentifier" = betterproto.message_field(7)
    hit_pos_type: int = betterproto.uint32_field(3)
    attack_timestamp_ms: int = betterproto.uint32_field(1782)
    damage_shield: float = betterproto.float_field(1932)
    attack_count: int = betterproto.uint32_field(1484)
    is_resist_text: bool = betterproto.bool_field(633)
    ...
    is_crit: bool = betterproto.bool_field(6)
    resolved_dir: "Vector" = betterproto.message_field(11)
    element_amplify_rate: float = betterproto.float_field(28)
    ...
    element_durability_attenuation: float = betterproto.float_field(775)
...
class AvatarTeamResonanceInfo(betterproto.Message):
    avatar_guid: int = betterproto.uint64_field(9)
    entity_id: int = betterproto.uint32_field(8)
    add_team_resonance_id_list: List[int] = betterproto.uint32_field(15)
    del_team_resonance_id_list: List[int] = betterproto.uint32_field(13)
...
class BartenderActivityDetailInfo(betterproto.Message):
    ...
    unlock_formula_list: List[int] = betterproto.uint32_field(6)
...
class BattlePassProduct(betterproto.Message):
    extra_product_id: str = betterproto.string_field(12)
    normal_product_id: str = betterproto.string_field(9)
...
class BattlePassSchedule(betterproto.Message):
    ...
    is_extra_paid_reward_taken: bool = betterproto.bool_field(8)
    cur_cycle_points: int = betterproto.uint32_field(14)
    is_viewed: bool = betterproto.bool_field(12)
    paid_platform_flags: int = betterproto.uint32_field(4)
...
class BrickBreakerDetailInfo(betterproto.Message):
    ...
    world_level_info_list: List["BrickBreakerLevelInfo"] = betterproto.message_field(11)
...
class CheckAddItemExceedLimitNotify(betterproto.Message):
    exceeded_item_list: List[int] = betterproto.uint32_field(4)
    exceeded_item_type_list: List[int] = betterproto.uint32_field(11)
    reason: int = betterproto.uint32_field(9)
...
class ClientNewMailNotify(betterproto.Message):
    not_got_attachment_num: int = betterproto.uint32_field(13)
    not_read_num: int = betterproto.uint32_field(2)
...
class ClientReportNotify(betterproto.Message):
    report_type: str = betterproto.string_field(15)
    report_value: str = betterproto.string_field(10)
...
class CodexDataFullNotify(betterproto.Message):
    ...
    last_read_pushtips_type_id: int = betterproto.uint32_field(13)
...
class CombineRsp(betterproto.Message):
    total_return_item_list: List["ItemParam"] = betterproto.message_field(11)
    total_extra_item_list: List["ItemParam"] = betterproto.message_field(13)
    total_random_item_list: List["ItemParam"] = betterproto.message_field(6)
    avatar_guid: int = betterproto.uint64_field(7)
    ...
    retcode: int = betterproto.int32_field(1)
    result_item_list: List["ItemParam"] = betterproto.message_field(4)
...
class CompoundQueueData(betterproto.Message):
    wait_count: int = betterproto.uint32_field(5)
    output_time: int = betterproto.uint32_field(14)
    output_count: int = betterproto.uint32_field(10)
...
class CoopChapter(betterproto.Message):
    ...
    finish_dialog_list: List[int] = betterproto.uint32_field(6)
    state: "CoopChapterState" = betterproto.enum_field(7)
    total_end_count: int = betterproto.uint32_field(11)
...
class DoGachaRsp(betterproto.Message):
    ...
    wish_progress: int = betterproto.uint32_field(1)
    wish_max_progress: int = betterproto.uint32_field(5)
    gacha_times: int = betterproto.uint32_field(4)
    gacha_times_limit: int = betterproto.uint32_field(15)
    wish_item_id: int = betterproto.uint32_field(12)
    ten_cost_item_id: int = betterproto.uint32_field(13)
    cost_item_num: int = betterproto.uint32_field(8)
    ten_cost_item_num: int = betterproto.uint32_field(2)
    cur_schedule_daily_gacha_times: int = betterproto.uint32_field(1550)
...
class DungeonEntryInfo(betterproto.Message):
    ...
    dungeon_id: int = betterproto.uint32_field(8)
    left_times: int = betterproto.uint32_field(5)
    next_refresh_time: int = betterproto.uint32_field(10)
    next_boss_chest_refresh_time: int = betterproto.uint32_field(3)
...
class DungeonReviseLevelNotify(betterproto.Message):
    ...
    scene_level: int = betterproto.uint32_field(15)
...
class EntityConfigHashNotify(betterproto.Message):
    avatar_entry_list: List["EntityConfigHashEntry"] = betterproto.message_field(1)
    combat_entry_list: List["EntityConfigHashEntry"] = betterproto.message_field(2)
    ability_entry_list: List["EntityConfigHashEntry"] = betterproto.message_field(9)
...
class EvtAnimatorStateChangedInfo(betterproto.Message):
    ...
    to_state_hash: int = betterproto.uint32_field(11)
    layer: int = betterproto.uint32_field(1)
...
class EvtAvatarStandUpNotify(betterproto.Message):
    direction: int = betterproto.int32_field(13)
    chair_id: int = betterproto.uint64_field(3)
    entity_id: int = betterproto.uint32_field(5)
    perform_id: int = betterproto.int32_field(11)
...
class EvtBeingHealedNotify(betterproto.Message):
    real_heal_amount: float = betterproto.float_field(2)
    heal_amount: float = betterproto.float_field(3)
...
class EvtBulletHitNotify(betterproto.Message):
    ...
    single_bullet_id: int = betterproto.uint32_field(4)
    hit_normal: "Vector" = betterproto.message_field(9)
    hit_entity_id: int = betterproto.uint32_field(6)
...
class ForgeQueueData(betterproto.Message):
    next_finish_timestamp: int = betterproto.uint32_field(1)
    forge_id: int = betterproto.uint32_field(5)
    finish_count: int = betterproto.uint32_field(7)
    queue_id: int = betterproto.uint32_field(4)
    total_finish_timestamp: int = betterproto.uint32_field(15)
    avatar_id: int = betterproto.uint32_field(12)
    unfinish_count: int = betterproto.uint32_field(3)
...
class FurnitureMakeData(betterproto.Message):
    ...
    dur_time: int = betterproto.uint32_field(8)
    accelerate_time: int = betterproto.fixed32_field(7)
...
class GachaInfo(betterproto.Message):
    ...
    wish_progress: int = betterproto.uint32_field(954)
    gacha_prob_url_oversea: str = betterproto.string_field(1532)
    gacha_record_url: str = betterproto.string_field(15)
    gacha_prob_url: str = betterproto.string_field(1)
    begin_time: int = betterproto.uint32_field(14)
    schedule_id: int = betterproto.uint32_field(8)
    display_up5_item_list: List[int] = betterproto.uint32_field(476)
    gacha_times_limit: int = betterproto.uint32_field(10)
    gacha_preview_prefab_path: str = betterproto.string_field(4)
    title_textmap: str = betterproto.string_field(114)
    cur_schedule_daily_gacha_times: int = betterproto.uint32_field(245)
    end_time: int = betterproto.uint32_field(2)
    display_up4_item_list: List[int] = betterproto.uint32_field(540)
    ten_cost_item_num: int = betterproto.uint32_field(13)
    wish_max_progress: int = betterproto.uint32_field(1275)
    ...
    cost_item_num: int = betterproto.uint32_field(12)
    wish_item_id: int = betterproto.uint32_field(1580)
    gacha_record_url_oversea: str = betterproto.string_field(1259)
    gacha_up_info_list: List["GachaUpInfo"] = betterproto.message_field(1585)
    cost_item_id: int = betterproto.uint32_field(3)
    gacha_prefab_path: str = betterproto.string_field(11)
...
class GachaItem(betterproto.Message):
    ...
    is_gacha_item_new: bool = betterproto.bool_field(13)
...
class GachaWishRsp(betterproto.Message):
    wish_progress: int = betterproto.uint32_field(6)
    wish_item_id: int = betterproto.uint32_field(15)
    gacha_schedule_id: int = betterproto.uint32_field(11)
    retcode: int = betterproto.int32_field(13)
    wish_max_progress: int = betterproto.uint32_field(10)
...
class GcgdsCardData(betterproto.Message):
    ...
    proficiency_reward_taken_idx_list: List[int] = betterproto.uint32_field(14)
    unlock_face_type_list: List[int] = betterproto.uint32_field(6)
...
class GcgdsDataNotify(betterproto.Message):
    ...
    unlock_card_back_id_list: List[int] = betterproto.uint32_field(10)
    card_list: List["GcgdsCardData"] = betterproto.message_field(9)
    unlock_field_id_list: List[int] = betterproto.uint32_field(5)
...
class GcgMsgMoveCard(betterproto.Message):
    to: "GcgZoneType" = betterproto.enum_field(9)
    fail_guid_list: List[int] = betterproto.uint32_field(2)
    from_: "GcgZoneType" = betterproto.enum_field(14)
...
class GcgMsgPhaseChange(betterproto.Message):
    before_phase: "GcgPhaseType" = betterproto.enum_field(15)
    after_phase: "GcgPhaseType" = betterproto.enum_field(3)
...
class GcgPlayerField(betterproto.Message):
    ...
    deck_card_num: int = betterproto.uint32_field(3)
...
class GetAllMailResultNotify(betterproto.Message):
    page_index: int = betterproto.uint32_field(13)
    ...
    total_page_count: int = betterproto.uint32_field(6)
...
class GetAuthkeyReq(betterproto.Message):
    sign_type: int = betterproto.uint32_field(6)
    auth_appid: str = betterproto.string_field(13)
    authkey_ver: int = betterproto.uint32_field(15)
...
class GetCityReputationMapInfoRsp(betterproto.Message):
    retcode: int = betterproto.int32_field(13)
    unlock_hunting_city_list: List[int] = betterproto.uint32_field(4)
    unk3300_gjfnopnmfng: bool = betterproto.bool_field(12)
    unk3300_ncmhmodiikm: bool = betterproto.bool_field(5)
    reward_city_list: List[int] = betterproto.uint32_field(15)
...
class GetPlayerTokenReq(betterproto.Message):
    uid: int = betterproto.uint32_field(10)
    cloud_client_ip: int = betterproto.uint32_field(1735)
...
class GetPlayerTokenRsp(betterproto.Message):
    ...
    gm_uid: int = betterproto.uint32_field(7)
    ...
    cloud_client_ip: int = betterproto.uint32_field(1670)
    ...
    sub_channel_id: int = betterproto.uint32_field(1038)
    retcode: int = betterproto.int32_field(2)
    ...
    black_uid_end_time: int = betterproto.uint32_field(12)
...
class HideAndSeekActivityDetailInfo(betterproto.Message):
    chosen_hunter_skill_list: List[int] = betterproto.uint32_field(6)
    ...
    chosen_map_list: List[int] = betterproto.uint32_field(15)
    unlock_map_list: List[int] = betterproto.uint32_field(4)
...
class HitCollision(betterproto.Message):
    ...
    attackee_hit_entity_angle: float = betterproto.float_field(7)
    hit_dir: "Vector" = betterproto.message_field(3)
    hit_point: "Vector" = betterproto.message_field(14)
    attackee_hit_force_angle: float = betterproto.float_field(10)
...
class HomeBlockArrangementInfo(betterproto.Message):
    deploy_furniure_list: List["HomeFurnitureData"] = betterproto.message_field(10)
    ...
    persistent_furniture_list: List["HomeFurnitureData"] = betterproto.message_field(12)
...
class HomeLimitedShopGoods(betterproto.Message):
    ...
    disable_type: int = betterproto.uint32_field(10)
...
class HomeMarkPointSceneData(betterproto.Message):
    teapot_spirit_pos: "Vector" = betterproto.message_field(9)
    scene_id: int = betterproto.uint32_field(6)
...
class InferenceWordInfo(betterproto.Message):
    is_submit: bool = betterproto.bool_field(12)
    unlock_by_word_id: int = betterproto.uint32_field(11)
    is_associate: bool = betterproto.bool_field(10)
    word_id: int = betterproto.uint32_field(2)
    is_interpret: bool = betterproto.bool_field(3)
...
class InvestigationMonster(betterproto.Message):
    ...
    next_boss_chest_refresh_time: int = betterproto.uint32_field(1)
    weekly_boss_resin_discount_info: "WeeklyBossResinDiscountInfo" = (
        betterproto.message_field(3)
    )
    boss_chest_num: int = betterproto.uint32_field(6)
    id: int = betterproto.uint32_field(9)
    monster_id: int = betterproto.uint32_field(562)
    lock_state: "InvestigationMonsterLockState" = betterproto.enum_field(4)
    refresh_interval: int = betterproto.uint32_field(10)
...
class MiracleRingDataNotify(betterproto.Message):
    ...
    gadget_entity_id: int = betterproto.uint32_field(7)
    miracle_ring_cd: int = betterproto.uint32_field(9)
    last_deliver_item_time: int = betterproto.uint32_field(8)
...
class ParentQuest(betterproto.Message):
    ...
    quest_var_seq: int = betterproto.uint32_field(14)
...
class PersonalLineAllDataRsp(betterproto.Message):
    ...
    retcode: int = betterproto.int32_field(2)
    can_be_unlocked_personal_line_list: List[int] = betterproto.uint32_field(1)
    ongoing_personal_line_list: List[int] = betterproto.uint32_field(6)
...
class PlayerCookReq(betterproto.Message):
    ...
    cook_count: int = betterproto.uint32_field(7)
...
class PlayerCookRsp(betterproto.Message):
    ...
    qte_quality: int = betterproto.uint32_field(1)
    extra_item_list: List["ItemParam"] = betterproto.message_field(3)
    cook_count: int = betterproto.uint32_field(11)
...
class PlayerEnterSceneNotify(betterproto.Message):
    world_type: int = betterproto.uint32_field(1224)
    is_skip_ui: bool = betterproto.bool_field(32)
    world_level: int = betterproto.uint32_field(4)
    pos: "Vector" = betterproto.message_field(1)
    is_first_login_enter_scene: bool = betterproto.bool_field(3)
    prev_scene_id: int = betterproto.uint32_field(13)
...
class PlayerHomeCompInfo(betterproto.Message):
    ...
    levelup_reward_got_level_list: List[int] = betterproto.uint32_field(11)
...
class PlayerLoginReq(betterproto.Message):
    ...
    sub_channel_id: int = betterproto.uint32_field(1458)
...
class PlayerMatchInfoNotify(betterproto.Message):
    dungeon_id: int = betterproto.uint32_field(4)
    match_begin_time: int = betterproto.uint32_field(5)
    estimate_match_cost_time: int = betterproto.uint32_field(10)
...
class ProudSkillExtraLevelNotify(betterproto.Message):
    ...
    talent_type: int = betterproto.uint32_field(8)
    talent_index: int = betterproto.uint32_field(2)
...
class RegionalPlayInfoNotify(betterproto.Message):
    ...
    is_in_region: bool = betterproto.bool_field(14)
...
class ReliquaryPromoteRsp(betterproto.Message):
    ...
    old_promote_level: int = betterproto.uint32_field(9)
...
class ReliquaryUpgradeRsp(betterproto.Message):
    ...
    old_append_prop_list: List[int] = betterproto.uint32_field(10)
...
class ReportTrackingIoInfoNotify(betterproto.Message):
    ...
    rydevicetype: str = betterproto.string_field(3)
...
class ResinChangeNotify(betterproto.Message):
    cur_buy_count: int = betterproto.uint32_field(11)
    next_add_timestamp: int = betterproto.uint32_field(13)
...
class RogueStageInfo(betterproto.Message):
    ...
    is_in_combat: bool = betterproto.bool_field(6)
...
class SceneGalleryHideAndSeekInfo(betterproto.Message):
    visible_uid_list: List[int] = betterproto.uint32_field(10)
...
class SceneTeamAvatar(betterproto.Message):
    ...
    avatar_ability_info: "AbilitySyncStateInfo" = betterproto.message_field(4)
    weapon_guid: int = betterproto.uint64_field(12)
    player_uid: int = betterproto.uint32_field(1)
    scene_entity_info: "SceneEntityInfo" = betterproto.message_field(11)
    weapon_entity_id: int = betterproto.uint32_field(5)
    scene_id: int = betterproto.uint32_field(9)
    is_on_scene: bool = betterproto.bool_field(625)
    avatar_guid: int = betterproto.uint64_field(3)
...
class SeaLampActivityDetailInfo(betterproto.Message):
    ...
    factor: int = betterproto.uint32_field(8)
    progress: int = betterproto.uint32_field(5)
    unk3300_fghdjjclnfn: List[int] = betterproto.uint32_field(14)
    contribution: int = betterproto.uint32_field(11)
...
class ServerCondMeetQuestListUpdateNotify(betterproto.Message):
    add_quest_id_list: List[int] = betterproto.uint32_field(10)
    del_quest_id_list: List[int] = betterproto.uint32_field(4)
...
class ShopGoods(betterproto.Message):
    secondary_sheet_id: int = betterproto.uint32_field(1003)
    ...
    max_level: int = betterproto.uint32_field(1)
    single_limit: int = betterproto.uint32_field(1770)
    unk3300_njcpajbceph: int = betterproto.uint32_field(505)
    begin_time: int = betterproto.uint32_field(12)
    disable_type: int = betterproto.uint32_field(4)
...
class StoreWeightLimitNotify(betterproto.Message):
    ...
    furniture_count_limit: int = betterproto.uint32_field(10)
    material_count_limit: int = betterproto.uint32_field(5)
    weapon_count_limit: int = betterproto.uint32_field(1)
...
class TakeFurnitureMakeRsp(betterproto.Message):
    ...
    furniture_make_slot: "FurnitureMakeSlot" = betterproto.message_field(14)
    output_item_list: List["ItemParam"] = betterproto.message_field(10)
...
class TowerAllDataRsp(betterproto.Message):
    ...
    valid_tower_record_num: int = betterproto.uint32_field(2)
...
class TowerCurLevelRecord(betterproto.Message):
    ...
    cur_level_index: int = betterproto.uint32_field(6)
...
class TowerLevelStarCondData(betterproto.Message):
    ...
    cond_value: int = betterproto.uint32_field(12)
...
class TowerMonthlyBrief(betterproto.Message):
    best_floor_index: int = betterproto.uint32_field(3)
    total_star_count: int = betterproto.uint32_field(6)
    best_level_index: int = betterproto.uint32_field(9)
...
class TrialAvatarActivityRewardDetailInfo(betterproto.Message):
    ...
    received_reward: bool = betterproto.bool_field(14)
    passed_dungeon: bool = betterproto.bool_field(5)
...
class VehicleLocationInfo(betterproto.Message):
    ...
    cur_hp: float = betterproto.float_field(2)
    pos: "Vector" = betterproto.message_field(9)
    gadget_id: int = betterproto.uint32_field(1)
    entity_id: int = betterproto.uint32_field(14)
    max_hp: float = betterproto.float_field(15)
...
class WatcherChangeNotify(betterproto.Message):
    removed_watcher_list: List[int] = betterproto.uint32_field(10)
    new_watcher_list: List[int] = betterproto.uint32_field(5)
...
class WeaponPromoteRsp(betterproto.Message):
    old_promote_level: int = betterproto.uint32_field(4)
    target_weapon_guid: int = betterproto.uint64_field(11)
    cur_promote_level: int = betterproto.uint32_field(5)
    retcode: int = betterproto.int32_field(8)
...
class WidgetReportReq(betterproto.Message):
    ...
    material_id: int = betterproto.uint32_field(2)
    is_clear_sky_crystal_hint: bool = betterproto.bool_field(14)
...
class WorldOwnerDailyTaskNotify(betterproto.Message):
    filter_city_id: int = betterproto.uint32_field(4)
    task_list: List["DailyTaskInfo"] = betterproto.message_field(2)
    finished_daily_task_num: int = betterproto.uint32_field(9)
